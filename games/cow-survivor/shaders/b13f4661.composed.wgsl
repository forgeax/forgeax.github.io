...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let f0_1 = mix(vec3(0.04f), albedo, metallic_6);
    let _e74 = material.clearcoatRoughness;
    let coatRoughness = max(_e74, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e83 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e62, v), 0f), vec3(0.04f));
    let _e86 = material.clearcoat;
    let coatF = (_e83 * _e86);
    let _e93 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e62, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e93) * (1f - metallic_6));
    let _e100 = material.roughness;
    let iblRoughness = (max(_e100, 0.04f) * _e40);
    let _e106 = skylight.rotation;
    let _e109 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, _e106, irradianceMap_1, irradianceSampler_1);
    let _e112 = skylight.rotation;
    let _e117 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, v, iblRoughness, f0_1, _e112, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e122 = skylight.rotation;
    let _e127 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, v, coatRoughness, vec3(0.04f), _e122, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e130 = material.occlusionUvScale;
    let _e133 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e2, _e130);
    let _e137 = material.occlusionStrength;
    let ao = mix(1f, _e133.x, _e137);
    let _e142 = skylight.colorR;
    let _e145 = skylight.colorG;
    let _e148 = skylight.colorB;
    let skyColor = vec3<f32>(_e142, _e145, _e148);
    let _e159 = material.clearcoat;
    let _e165 = skylight.intensity;
    ambient = ((((((((kD * _e109) * albedo) + _e117) * (vec3(1f) - coatF)) + (_e127 * _e159)) * skyColor) * _e165) * ao);
    let _e169 = ambient;
    color = _e169;
    let _e171 = color;
    let _e172 = a;
    let _e175 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e62, v, albedo, metallic_6, _e172, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e171 + _e175);
    let _e177 = color;
    let _e180 = material.clearcoat;
    let _e188 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e177 + (_e180 * _e188));
    ...
    loop {
        ...
        {
            let _e199 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e199];
            let _e202 = color;
            let _e207 = a;
            let _e208 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e207, f0_1);
            color = (_e202 + _e208);
            let _e210 = color;
            let _e213 = material.clearcoat;
            let _e223 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e210 + (_e213 * _e223));
        }
        continuing {
            let _e226 = i;
            i = (_e226 + 1u);
    ...
    loop {
        ...
        {
            let _e237 = i_1;
            let s = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e237];
            if (s.shadowAtlasTile >= 0i) {
                let _e243 = color;
                let _e251 = a;
                let _e256 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s.shadowAtlasTile];
                let _e260 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e251, f0_1, _e256, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e243 + _e260);
                let _e262 = color;
                let _e265 = material.clearcoat;
                let _e281 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s.shadowAtlasTile];
                let _e286 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), _e281, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e262 + (_e265 * _e286));
            } else {
                let _e289 = color;
                let _e297 = a;
                let _e298 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e297, f0_1);
                color = (_e289 + _e298);
                let _e300 = color;
                let _e303 = material.clearcoat;
                let _e316 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                color = (_e300 + (_e303 * _e316));
            }
        }
        continuing {
            let _e319 = i_1;
    ...
    let _e324 = material.emissiveUvScale;
    let _e327 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e2, _e324);
    let emissiveSample = _e327.xyz;
    let _e329 = color;
    let _e332 = material.emissive;
    let _e335 = material.emissiveIntensity;
    color = (_e329 + ((_e332 * _e335) * emissiveSample));
    let _e339 = color;
    let _e343 = material.baseColor.w;
    return vec4<f32>(_e339, (_e343 * _e8.w));
}
