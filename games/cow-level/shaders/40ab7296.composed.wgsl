...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e12 = material.baseColor.w;
    alphaTest((_e12 * _e8.w));
    let _e17 = material.baseColor;
    let albedo = (_e17.xyz * _e8.xyz);
    let _e23 = material.metallicRoughnessUvScale;
    let _e26 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(metallicRoughnessTexture, metallicRoughnessSampler, _e2, _e23);
    let _e29 = material.metallic;
    let _e32 = material.metallicChannel;
    let _e34 = pick_channel(_e26, u32(_e32));
    let metallic_6 = (_e29 * _e34);
    let _e38 = material.roughnessChannel;
    let _e40 = pick_channel(_e26, u32(_e38));
    let _e43 = material.roughness;
    a = max(_e43, 0.04f);
    let _e47 = a;
    a = (_e47 * _e40);
    let _e49 = a;
    let _e50 = a;
    a = (_e49 * _e50);
    let _e54 = material.normalUvScale;
    let _e57 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e2, _e54);
    let normSampleRg = _e57.xy;
    let _e59 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg);
    let _e62 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e59);
    let _e65 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e65 - in_1.worldPos));
    let _e71 = material.specularTint;
    let _e74 = material.specularTintUvScale;
    let _e77 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e2, _e74);
    let specularTint = (_e71 * _e77.xyz);
    let f0_1 = mix((vec3(0.04f) * specularTint), albedo, metallic_6);
    let _e86 = material.clearcoatRoughness;
    let coatRoughness = max(_e86, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e95 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e62, v), 0f), vec3(0.04f));
    let _e98 = material.clearcoat;
    let coatF = (_e95 * _e98);
    let _e105 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e62, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e105) * (1f - metallic_6));
    let _e112 = material.roughness;
    let iblRoughness = (max(_e112, 0.04f) * _e40);
    let _e118 = skylight.rotation;
    let _e121 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, _e118, irradianceMap_1, irradianceSampler_1);
    let _e124 = skylight.rotation;
    let _e129 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, v, iblRoughness, f0_1, _e124, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e134 = skylight.rotation;
    let _e139 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e62, v, coatRoughness, vec3(0.04f), _e134, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e142 = material.occlusionUvScale;
    let _e145 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e2, _e142);
    let _e149 = material.occlusionStrength;
    let ao = mix(1f, _e145.x, _e149);
    let _e154 = skylight.colorR;
    let _e157 = skylight.colorG;
    let _e160 = skylight.colorB;
    let skyColor = vec3<f32>(_e154, _e157, _e160);
    let _e171 = material.clearcoat;
    let _e177 = skylight.intensity;
    ambient = ((((((((kD * _e121) * albedo) + _e129) * (vec3(1f) - coatF)) + (_e139 * _e171)) * skyColor) * _e177) * ao);
    let _e181 = ambient;
    color = _e181;
    let _e183 = color;
    let _e184 = a;
    let _e187 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e62, v, albedo, metallic_6, _e184, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e183 + _e187);
    let _e189 = color;
    let _e192 = material.clearcoat;
    let _e200 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e189 + (_e192 * _e200));
    ...
    loop {
        ...
        {
            let _e211 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e211];
            let _e214 = color;
            let _e219 = a;
            let _e220 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e219, f0_1);
            color = (_e214 + _e220);
            let _e222 = color;
            let _e225 = material.clearcoat;
            let _e235 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e222 + (_e225 * _e235));
        }
        continuing {
            let _e238 = i;
            i = (_e238 + 1u);
    ...
    loop {
        ...
        {
            let _e249 = i_1;
            let s = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e249];
            if (s.shadowAtlasTile >= 0i) {
                let _e255 = color;
                let _e263 = a;
                let _e268 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s.shadowAtlasTile];
                let _e272 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e263, f0_1, _e268, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e255 + _e272);
                let _e274 = color;
                let _e277 = material.clearcoat;
                let _e293 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s.shadowAtlasTile];
                let _e298 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), _e293, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e274 + (_e277 * _e298));
            } else {
                let _e301 = color;
                let _e309 = a;
                let _e310 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, albedo, metallic_6, _e309, f0_1);
                color = (_e301 + _e310);
                let _e312 = color;
                let _e315 = material.clearcoat;
                let _e328 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e62, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                color = (_e312 + (_e315 * _e328));
            }
        }
        continuing {
            let _e331 = i_1;
    ...
    let _e336 = material.emissiveUvScale;
    let _e339 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e2, _e336);
    let emissiveSample = _e339.xyz;
    let _e341 = color;
    let _e344 = material.emissive;
    let _e347 = material.emissiveIntensity;
    color = (_e341 + ((_e344 * _e347) * emissiveSample));
    let _e351 = color;
    let _e355 = material.baseColor.w;
    return vec4<f32>(_e351, (_e355 * _e8.w));
}
