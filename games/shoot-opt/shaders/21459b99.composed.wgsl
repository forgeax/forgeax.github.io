...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e73 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e70);
    let _e76 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e76 - in_1.worldPos));
    let _e82 = material.specularTint;
    let _e85 = material.specularTintCoordinates;
    let _e86 = transformedMaterialUv(_e85, in_1);
    let _e90 = material.specularTintCoordinates.metadata;
    let _e94 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e86, _e90.zw);
    let specularTint = (_e82 * _e94.xyz);
    let f0_1 = mix((vec3(0.04f) * specularTint), albedo, metallic_5);
    let _e103 = material.clearcoatRoughness;
    let coatRoughness = max(_e103, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e112 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e73, v), 0f), vec3(0.04f));
    let _e115 = material.clearcoat;
    let coatF = (_e112 * _e115);
    let _e122 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e73, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e122) * (1f - metallic_5));
    let _e129 = material.roughness;
    let iblRoughness = (max(_e129, 0.04f) * _e45);
    let _e135 = skylight.rotation;
    let _e138 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e73, _e135, irradianceMap_1, irradianceSampler_1);
    let _e141 = skylight.rotation;
    let _e146 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e73, v, iblRoughness, f0_1, _e141, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e151 = skylight.rotation;
    let _e156 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e73, v, coatRoughness, vec3(0.04f), _e151, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e159 = skylight.colorR;
    let _e162 = skylight.colorG;
    let _e165 = skylight.colorB;
    let skyColor = vec3<f32>(_e159, _e162, _e165);
    let _e176 = material.clearcoat;
    let _e182 = skylight.intensity;
    let ambient = (((((((kD * _e138) * albedo) + _e146) * (vec3(1f) - coatF)) + (_e156 * _e176)) * skyColor) * _e182);
    color = ambient;
    let _e185 = color;
    let _e186 = a;
    let _e189 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e73, v, albedo, metallic_5, _e186, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e185 + _e189);
    let _e191 = color;
    let _e194 = material.clearcoat;
    let _e202 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e73, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e191 + (_e194 * _e202));
    ...
    loop {
        ...
        {
            let _e213 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e213];
            let _e216 = color;
            let _e221 = a;
            let _e222 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e73, v, albedo, metallic_5, _e221, f0_1);
            color = (_e216 + _e222);
            let _e224 = color;
            let _e227 = material.clearcoat;
            let _e237 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e73, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e224 + (_e227 * _e237));
        }
        continuing {
            let _e240 = i;
            i = (_e240 + 1u);
    ...
    loop {
        ...
        {
            let _e251 = i_1;
            let s_1 = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e251];
            let _e254 = color;
            let _e262 = a;
            let _e263 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e73, v, albedo, metallic_5, _e262, f0_1);
            color = (_e254 + _e263);
            let _e265 = color;
            let _e268 = material.clearcoat;
            let _e281 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e73, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e265 + (_e268 * _e281));
        }
        continuing {
            let _e284 = i_1;
            i_1 = (_e284 + 1u);
    ...
    let _e287 = color;
    let _e291 = material.baseColor.w;
    return vec4<f32>(_e287, (_e291 * _e13.w));
}
