...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e68 = material.clearcoatRoughness;
    let coatRoughness = max(_e68, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e77 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e56, v), 0f), vec3(0.04f));
    let _e80 = material.clearcoat;
    let coatF = (_e77 * _e80);
    let _e87 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e56, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e87) * (1f - metallic_5));
    let _e94 = material.roughness;
    let iblRoughness = (max(_e94, 0.04f) * _e34);
    let _e100 = skylight.rotation;
    let _e103 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, _e100, irradianceMap_1, irradianceSampler_1);
    let _e106 = skylight.rotation;
    let _e111 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, v, iblRoughness, f0_1, _e106, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e116 = skylight.rotation;
    let _e121 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, v, coatRoughness, vec3(0.04f), _e116, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e124 = skylight.colorR;
    let _e127 = skylight.colorG;
    let _e130 = skylight.colorB;
    let skyColor = vec3<f32>(_e124, _e127, _e130);
    let _e141 = material.clearcoat;
    let _e147 = skylight.intensity;
    let ambient = (((((((kD * _e103) * albedo) + _e111) * (vec3(1f) - coatF)) + (_e121 * _e141)) * skyColor) * _e147);
    color = ambient;
    let _e150 = color;
    let _e151 = a;
    let _e154 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e56, v, albedo, metallic_5, _e151, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e150 + _e154);
    let _e156 = color;
    let _e159 = material.clearcoat;
    let _e167 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e156 + (_e159 * _e167));
    ...
    loop {
        ...
        {
            let _e178 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e178];
            let _e181 = color;
            let _e186 = a;
            let _e187 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_5, _e186, f0_1);
            color = (_e181 + _e187);
            let _e189 = color;
            let _e192 = material.clearcoat;
            let _e202 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e189 + (_e192 * _e202));
        }
        continuing {
            let _e205 = i;
            i = (_e205 + 1u);
    ...
    loop {
        ...
        {
            let _e216 = i_1;
            let s = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e216];
            let _e219 = color;
            let _e227 = a;
            let _e228 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_5, _e227, f0_1);
            color = (_e219 + _e228);
            let _e230 = color;
            let _e233 = material.clearcoat;
            let _e246 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e230 + (_e233 * _e246));
        }
        continuing {
            let _e249 = i_1;
            i_1 = (_e249 + 1u);
    ...
    let _e252 = color;
    let _e256 = material.baseColor.w;
    return vec4<f32>(_e252, (_e256 * _e8.w));
}
