...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_11: vec3<f32>, viewDir_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_10: f32, alphaSq_7: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_7, nDotV_4, nDotL_5, F0_11);
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_3: u32, count_4: u32, normal_12: vec3<f32>, l: vec3<f32>, useNormalBias: bool) -> f32 {
    var local_15: bool;
    var local_16: bool;
    var local_17: bool;
    var local_18: bool;
    ...
    if (kernel == 3u) {
        if all((uv_4 >= (tileLo + texel_2))) {
            local_19 = all((uv_4 <= (tileHi - texel_2)));
        } else {
            local_19 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_13: vec3<f32>, worldPos_15: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_20: bool;
    ...
    let _e32 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, _e28, count_5, normal_13, l_5, true);
    shadow_1 = _e32;
    ...
    if _e45 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e69 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, (_e28 + 1u), count_5, normal_13, l_5, true);
