...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_9: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_7: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e107 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_7, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, 1f);
            let _e113 = tile;
        ...
        let _e133 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return (_e133 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e151 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_7, alpha_sq, f0_2);
        return _e151;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_10: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_8: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e69 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_10, view_dir_1, base_color_1, metallic_8, alpha_sq_1, f0_3, flat_2d_1);
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_11: vec3<f32>, viewDir_4: vec3<f32>, baseColor_8: vec3<f32>, metallic_9: f32, alphaSq_6: f32, F0_10: vec3<f32>) -> vec3<f32> {
    ...
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_6, nDotV_3, nDotL_6, F0_10);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_11: vec3<f32>, layer_4: u32, count_4: u32, normal_12: vec3<f32>, l: vec3<f32>, profile: u32) -> f32 {
    var local_10: bool;
    var local_11: bool;
    var local_12: bool;
    var local_13: bool;
    ...
    let _e60 = local_13;
    if _e60 {
        local_14 = (projCoords.z >= 0f);
    } else {
        local_14 = false;
    }
    let _e67 = local_14;
    if _e67 {
        local_15 = (projCoords.z <= 1f);
    } else {
        local_15 = false;
    }
    let _e74 = local_15;
    ...
    if (lightDepthWorldSpan > 0f) {
        local_19 = (worldUnitsPerTexel > 0f);
    } else {
        local_19 = false;
    }
    let _e216 = local_19;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12: vec3<f32>, layer_5: u32, count_5: u32, normal_13: vec3<f32>, l_1: vec3<f32>, useNormalBias: bool) -> f32 {
    var local_22: bool;
    var local_23: bool;
    var local_24: bool;
    var local_25: bool;
    ...
    if (tileUv_1.x >= 0f) {
        local_22 = (tileUv_1.x <= 1f);
    } else {
        local_22 = false;
    }
    let _e59 = local_22;
    if _e59 {
        local_23 = (tileUv_1.y >= 0f);
    } else {
        local_23 = false;
    }
    let _e66 = local_23;
    if _e66 {
        local_24 = (tileUv_1.y <= 1f);
    } else {
        local_24 = false;
    }
    let _e73 = local_24;
    ...
    if (filterProfile >= 4u) {
        let _e107 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12, layer_5, count_5, normal_13, l_1, filterProfile);
        return _e107;
    }
    ...
    if (kernel == 3u) {
        if all((uv_5 >= (tileLo + texel_5))) {
            local_26 = all((uv_5 <= (tileHi - texel_5)));
        } else {
            local_26 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_14: vec3<f32>, worldPos_13: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_27: bool;
    ...
    let _e32 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_13, _e28, count_6, normal_14, l_6, true);
    shadow_1 = _e32;
    let _e36 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cascadeBlend;
    if (_e36 > 0f) {
        local_27 = ((_e28 + 1u) < count_6);
    } else {
        local_27 = false;
    }
    let _e45 = local_27;
    if _e45 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e69 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_13, (_e28 + 1u), count_6, normal_14, l_6, true);
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e212 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e208, (_e209 * skyFactor), probeDiffuseK, _e211, metallic_12);
    ...
    let _e256 = f0_;
    let _e257 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e254, v_2, _e255, metallic_12, a_3, _e256);
    let _e258 = color;
    ...
    let _e268 = f0_;
    let _e270 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e264, in_2.worldPos, _e266, v_2, _e267, metallic_12, a_3, _e268, false);
    color = (_e261 + _e270);
    let _e272 = color;
