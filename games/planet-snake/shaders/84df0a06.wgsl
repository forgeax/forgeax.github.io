...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e241 = standardViewZ(in_2);
    let _e242 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e239, in_2.worldPos, _e241);
    ...
    let _e250 = color;
    let _e253 = standardViewZ(in_2);
    let _e255 = physicalNormal;
    let _e256 = diffuseAlbedo;
    let _e257 = f0_;
    let _e260 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e253, in_2.worldPos, _e255, v_2, _e256, metallic_13, a_3, _e257, false, true);
    color = (_e250 + _e260);
    let _e262 = color;
    color = (_e262 + _e8.emissive);
    let _e267 = color;
