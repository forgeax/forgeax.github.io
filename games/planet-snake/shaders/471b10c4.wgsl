...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_3: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic: f32, alphaSq: f32, F0_4: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_4 = max(dot(normal_3, l_2), 0f);
    let nDotV_2 = max(dot(normal_3, viewDir), 0.00001f);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos: vec3<f32>, layer_4: u32, count_4: u32, normal_4: vec3<f32>, l: vec3<f32>, profile: u32) -> f32 {
    var local_3: bool;
    var local_4: bool;
    var local_5: bool;
    var local_6: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_1: vec3<f32>, layer_5: u32, count_5: u32, normal_5: vec3<f32>, l_1: vec3<f32>, useNormalBias: bool) -> f32 {
    var local_15: bool;
    var local_16: bool;
    var local_17: bool;
    var local_18: bool;
    ...
    let bias = select(_e33, max((_e36 * (1f - dot(normal_5, l_1))), _e46), useNormalBias);
    ...
    if (filterProfile >= 4u) {
        let _e107 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_1, layer_5, count_5, normal_5, l_1, filterProfile);
        return _e107;
    }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_6: vec3<f32>, worldPos_2: vec3<f32>, viewZ: f32) -> f32 {
    var shadow: f32;
    var local_20: bool;
    ...
    let _e32 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_2, _e28, count_6, normal_6, l_3, true);
    shadow = _e32;
    ...
    if _e45 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e69 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_2, (_e28 + 1u), count_6, normal_6, l_3, true);
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_5: vec3<f32>, normal_7: vec3<f32>, viewDir_1: vec3<f32>, baseColor_1: vec3<f32>, metallic_1: f32, alphaSq_1: f32, F0_5: vec3<f32>) -> vec3<f32> {
...
fn evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2: vec3<f32>, colorTimesIntensity_1: vec3<f32>, invRangeSquared_3: f32, worldPos_6: vec3<f32>, normal_8: vec3<f32>, viewDir_2: vec3<f32>, baseColor_2: vec3<f32>, metallic_2: f32, alphaSq_2: f32, F0_6: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2, colorTimesIntensity_1, invRangeSquared_3, worldPos_6, normal_8, viewDir_2, baseColor_2, metallic_2, alphaSq_2, F0_6);
    return _e10;
}
...
fn evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, lightDir_2: vec3<f32>, colorTimesIntensity_4: vec3<f32>, cosInner_2: f32, cosOuter_2: f32, invRangeSquared_7: f32, worldPos_9: vec3<f32>, normal_9: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_3: f32, alphaSq_3: f32, F0_7: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5, colorTimesIntensity_4, invRangeSquared_7, worldPos_9, normal_9, viewDir_3, baseColor_5, metallic_3, alphaSq_3, F0_7);
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_8: f32, worldPos_10: vec3<f32>, normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_6: vec3<f32>, metallic_4: f32, alphaSq_4: f32, F0_8: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_2: f32, normalBias_2: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    var local_22: bool;
    var local_23: bool;
    var local_24: bool;
    var local_25: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6, lightDir_3, colorTimesIntensity_5, cosInner_3, cosOuter_3, invRangeSquared_8, worldPos_10, normal_10, viewDir_4, baseColor_6, metallic_4, alphaSq_4, F0_8);
    ...
    let nDotL_7 = max(dot(normal_10, normalize((lightPos_6 - worldPos_10))), 0f);
...
fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_11: f32, worldPos_15: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_8: vec3<f32>, metallic_6: f32, alphaSq_6: f32, F0_10: vec3<f32>) -> vec3<f32> {
    ...
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_11, worldPos_15, n_3, v_3, baseColor_8, metallic_6, alphaSq_6, F0_10);
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e107 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, 1f);
            return (_e107 * modifier);
        }
        let _e121 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return (_e121 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e139 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e139;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_1: vec3<f32>, normal_12: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_9: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e69 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_1, normal_12, view_dir_1, base_color_1, metallic_9, alpha_sq_1, f0_3, flat_2d_1);
...
fn evaluate_surface(input_2: SurfaceInput) -> SurfaceData {
    ...
    let metallic_10 = clamp((_e87 * _e92), 0f, 1f);
    ...
    return SurfaceData(baseColor_10, _e133, metallic_10, roughness_8, emissive, occlusion, clamp(((_e137 * baseSample.w) * vertexColor.w), 0f, 1f), clamp(_e147, 0f, 1f));
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_11 = clamp(_e11, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e58) * _e60), albedo, metallic_11);
    physicalNormal = n_5;
    ...
    let kD = ((vec3(1f) - _e150) * (1f - metallic_11));
    ...
    let _e235 = coatF;
    ambient = ((((kD * _e226) * _e228) + _e230) * (vec3(1f) - _e235));
    let _e241 = skylight.intensity;
    if (_e241 < 0f) {
        let _e246 = skylight.intensity;
        let environmentScale = (max((-(_e246) - 1f), 0f) * ao);
        let _e253 = ambient;
        ambient = (_e253 * environmentScale);
    } else {
        let _e257 = skylight.intensity;
        let environmentScale_1 = ((skyColor * _e257) * ao);
        let _e260 = ambient;
        ambient = (_e260 * environmentScale_1);
    }
    let _e262 = ambient;
    color = _e262;
    ...
    let _e335 = material.thickness;
    let _e337 = finiteScalar(_e335, 0f);
    let _e341 = finiteScalar(thicknessSample, 1f);
    let worldThickness = max(((_e337 * length(worldRefractedDirection)) * _e341), 0f);
    ...
    let _e383 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e383.xyz;
    ...
    let _e391 = local_1;
    if _e391 {
        let _e399 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e399.xyz;
    }
    let _e403 = material.attenuationColor;
    let _e406 = finiteColor(_e403, vec3(1f));
    let safeAttenuationColor = clamp(_e406, vec3(0f), vec3(1f));
    let _e414 = material.attenuationDistance;
    let _e416 = finiteScalar(_e414, 0f);
    let safeAttenuationDistance = max(_e416, 0f);
    ...
    let _e433 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e433);
    let _e435 = color;
    let _e436 = transmittedBackdrop;
    let _e439 = finiteColor(_e436, vec3(0f));
    color = (_e435 + ((_e439 * transmittedEnergy) * beerAttenuation));
    let _e443 = color;
    color = (_e443 + _e6.emissive);
    let _e446 = physicalNormal;
    let _e448 = standardViewZ(in_2);
    let _e449 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e446, in_2.worldPos, _e448);
    let _e450 = physicalNormal;
    let _e451 = diffuseAlbedo;
    let _e452 = f0_;
    let _e453 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e450, v_5, _e451, metallic_11, a_3, _e452);
    let _e454 = color;
    color = (_e454 + (_e449 * _e453));
    let _e457 = color;
    let _e460 = standardViewZ(in_2);
    let _e462 = physicalNormal;
    let _e463 = diffuseAlbedo;
    let _e464 = f0_;
    let _e466 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e460, in_2.worldPos, _e462, v_5, _e463, metallic_11, a_3, _e464, false);
    color = (_e457 + _e466);
    let _e468 = color;
    return vec4<f32>(_e468, alpha);
}
