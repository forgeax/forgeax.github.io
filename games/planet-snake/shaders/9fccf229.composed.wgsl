...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e289 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e285, (_e286 * skyFactor), probeDiffuseK, _e288, metallic_13);
    ...
    let _e512 = f0_;
    let _e513 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e510, v_5, _e511, metallic_13, a_4, _e512);
    let _e514 = color;
    ...
    let _e524 = f0_;
    let _e526 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e520, in_2.worldPos, _e522, v_5, _e523, metallic_13, a_4, _e524, false);
    color = (_e517 + _e526);
    let _e528 = color;
    color = (_e528 + _e6.emissive);
    let _e533 = color;
    output.color = vec4<f32>(_e533, alpha_1);
    let _e536 = reflectionFallback;
    output.reflectionFallback = vec4<f32>(_e536, 1f);
    let _e539 = output;
    return _e539;
}
