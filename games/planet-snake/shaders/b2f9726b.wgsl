...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e17 = material.baseColorTextureCoordinatesMetadata;
    let _e20 = reactive;
    let _e31 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e4 * _e6), _e10, baseColorTexture_1, baseColorSampler_1, _e13, _e17, in_4.currentClip, in_4.previousClip, _e20, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return _e31;
}
