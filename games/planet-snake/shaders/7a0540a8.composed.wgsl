...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12: vec3<f32>, layer_5: u32, count_5: u32, normal_13: vec3<f32>, l_1: vec3<f32>, useNormalBias: bool) -> f32 {
    ...
    if (kernel == 3u) {
        if all((uv_5 >= (tileLo + texel_5))) {
            local_29 = all((uv_5 <= (tileHi - texel_5)));
        } else {
            local_29 = false;
        }
...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha_1: f32, alphaCutoff: f32, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_3: vec4<f32>, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, temporalProjection_3: vec4<f32>, reactive_3: f32, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    if (alphaCutoff > 0f) {
        local_31 = ((baseColorAlpha_1 * _e14.w) <= alphaCutoff);
    } else {
        local_31 = false;
    }
    let _e25 = local_31;
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e485 = f0_;
    let _e486 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e483, v_2, _e484, metallic_12, a_3, _e485);
    let _e487 = color;
    ...
    let _e497 = f0_;
    let _e499 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e493, in_2.worldPos, _e495, v_2, _e496, metallic_12, a_3, _e497, false);
    color = (_e490 + _e499);
    let _e501 = color;
