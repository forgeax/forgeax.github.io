...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e196 = ambient;
    color = _e196;
    let _e198 = physicalNormal;
    let _e200 = standardViewZ(in_2);
    let _e201 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e198, in_2.worldPos, _e200);
    let _e202 = physicalNormal;
    let _e203 = diffuseAlbedo;
    let _e204 = f0_;
    let _e205 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e202, v, _e203, metallic_4, a_3, _e204);
    let _e206 = color;
    color = (_e206 + (_e201 * _e205));
    let _e209 = color;
    color = (_e209 + _e6.emissive);
    let _e214 = color;
    output.color = vec4<f32>(_e214, alpha_1);
    let _e217 = reflectionFallback;
    output.reflectionFallback = vec4<f32>(_e217, 1f);
    let _e220 = output;
    return _e220;
}
...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e6 = temporalVertexAlpha(in_5);
    ...
    let _e23 = reactive;
    let _e34 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e4 * _e6), _e10, baseColorTexture_1, baseColorTexture_sampler, _e13, _e16, in_5.currentClip, in_5.previousClip, _e22, _e23, in_5.uv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6_, in_5.uv7_);
    return _e34;
}
