...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha_1: f32, alphaCutoff: f32, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_2: vec4<f32>, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, temporalProjection_3: vec4<f32>, reactive_2: f32, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    if (alphaCutoff > 0f) {
        local_25 = ((baseColorAlpha_1 * _e14.w) <= alphaCutoff);
    } else {
        local_25 = false;
    }
    let _e25 = local_25;
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e72 = f0_;
    let _e73 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e68, v_2), 0f), _e72);
    let kD_1 = ((vec3(1f) - _e73) * (1f - metallic_12));
    ...
    if (_e85 < 0f) {
        ...
        let _e114 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e88, v_2, iblRoughness, _e89, in_2.worldPos, vec3<f32>(_e93, _e96, _e99), _e103.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_2, brdfLutSampler_2);
        specularIbl = _e114;
    } else {
        ...
        let _e133 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e124, v_2, iblRoughness, _e125, _e128, prefilterMap_1, prefilterSampler_1, brdfLut_2, brdfLutSampler_2);
        specularIbl = _e133;
    }
    ...
    let _e205 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e201, (_e202 * skyFactor), probeDiffuseK, _e204, metallic_12);
    ...
    let _e227 = f0_;
    let _e228 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e225, v_2, _e226, metallic_12, a_2, _e227);
    let _e229 = color;
    ...
    let _e239 = f0_;
    let _e241 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e235, in_2.worldPos, _e237, v_2, _e238, metallic_12, a_2, _e239, false);
    color = (_e232 + _e241);
    let _e243 = color;
