...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_8: f32, worldPos_7: vec3<f32>, normal_8: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_4: f32, alphaSq_3: f32, F0_7: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_1: f32, normalBias_1: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    ...
    let nDotL_5 = max(dot(normal_8, normalize((lightPos_6 - worldPos_7))), 0f);
...
fn ltcUvX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(n: vec3<f32>, v: vec3<f32>, roughness_5: f32) -> vec2<f32> {
    ...
    return ((vec2<f32>(clamp(roughness_5, 0f, 1f), sqrt((1f - nDotV_3))) * 0.984375f) + vec2(0.0078125f));
}
...
fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_11: f32, worldPos_12: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_7: vec3<f32>, metallic_6: f32, alphaSq_5: f32, F0_9: vec3<f32>) -> vec3<f32> {
    ...
    let fresnel_1 = ((F0_9 * fresnelSample.x) + ((vec3(1f) - F0_9) * fresnelSample.y));
    ...
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_11, worldPos_12, n_3, v_3, baseColor_7, metallic_6, alphaSq_5, F0_9);
...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12: vec3<f32>, lightColor_2: vec3<f32>, axisX_3: vec3<f32>, axisY_3: vec3<f32>, halfWidth_3: f32, halfHeight_3: f32, invRangeSquared_12: f32, worldPos_13: vec3<f32>, n_4: vec3<f32>, v_4: vec3<f32>, baseColor_8: vec3<f32>, metallic_7: f32, alphaSq_6: f32, F0_10: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, lightColor_2, axisX_3, axisY_3, halfWidth_3, halfHeight_3, invRangeSquared_12, worldPos_13, n_4, v_4, baseColor_8, metallic_7, alphaSq_6, F0_10);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_9: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e107 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_8, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, 1f);
            let _e113 = tile;
            let _e115 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[_e113];
            let _e117 = sampleStandardSpotProjectorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXG4DPORPXA4TPNJSWG5DPOIX(_e115, world_pos_1, light.metadata);
            let _e118 = projector_selected;
            return ((_e107 * modifier) * select(vec3(1f), _e117, _e118));
        }
        let _e133 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return (_e133 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e151 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_9, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e151;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_10: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_9: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e69 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_10, view_dir_1, base_color_1, metallic_9, alpha_sq_1, f0_3, flat_2d_1);
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_11: vec3<f32>, viewDir_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_10: f32, alphaSq_7: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_6 = max(dot(normal_11, l_5), 0f);
    let nDotV_4 = max(dot(normal_11, viewDir_4), 0.00001f);
    ...
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_7, nDotV_4, nDotL_6, F0_11);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_4: u32, count_4: u32, normal_12: vec3<f32>, l: vec3<f32>, profile: u32) -> f32 {
    var local_18: bool;
    var local_19: bool;
    var local_20: bool;
    var local_21: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_5: u32, count_5: u32, normal_13: vec3<f32>, l_1: vec3<f32>, useNormalBias: bool) -> f32 {
    var local_30: bool;
    var local_31: bool;
    var local_32: bool;
    var local_33: bool;
    ...
    let bias_1 = select(_e33, max((_e36 * (1f - dot(normal_13, l_1))), _e46), useNormalBias);
    ...
    if (filterProfile >= 4u) {
        let _e107 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, layer_5, count_5, normal_13, l_1, filterProfile);
        return _e107;
    }
    ...
    if (kernel == 3u) {
        if all((uv_5 >= (tileLo + texel_5))) {
            local_34 = all((uv_5 <= (tileHi - texel_5)));
        } else {
            local_34 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_14: vec3<f32>, worldPos_16: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_35: bool;
    ...
    let _e32 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_16, _e28, count_6, normal_14, l_6, true);
    shadow_1 = _e32;
    let _e36 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cascadeBlend;
    if (_e36 > 0f) {
        local_35 = ((_e28 + 1u) < count_6);
    } else {
        local_35 = false;
    }
    let _e45 = local_35;
    if _e45 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e69 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_16, (_e28 + 1u), count_6, normal_14, l_6, true);
...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha_1: f32, alphaCutoff: f32, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_3: vec4<f32>, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, temporalProjection_3: vec4<f32>, reactive_3: f32, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    let _e10 = transformedPbrTemporalUvX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(transform_1, metadata_3, uv0_1, uv1_1, uv2_1, uv3_1, uv4_1, uv5_1, uv6_1, uv7_1);
    let _e14 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(baseColorTexture, baseColorSampler, _e10, metadata_3.zw);
    if (alphaCutoff > 0f) {
        local_36 = ((baseColorAlpha_1 * _e14.w) <= alphaCutoff);
    } else {
        local_36 = false;
    }
    let _e25 = local_36;
...
fn surfaceUv(input: SurfaceInput, transform_3: vec4<f32>, metadata_5: vec4<f32>) -> vec2<f32> {
    let source_3 = select(input.uv0_, input.uv1_, (metadata_5.x >= 1f));
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e285 = textureSample(ssaoBlurredTexture, ssaoBlurredSampler, ssaoUv);
    let ssaoFactor = _e285.x;
    let _e287 = get_ssao_intensityX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX();
    let _e288 = ambient;
    ambient = (_e288 * mix(1f, (ssaoFactor * ao), _e287));
    let ssaoScale = mix(1f, (ssaoFactor * ao), _e287);
    let _e296 = reflectionFallback;
    reflectionFallback = (_e296 * ssaoScale);
    let _e298 = ambient;
    color = _e298;
    ...
    let _e371 = material.thickness;
    let _e373 = finiteScalar(_e371, 0f);
    let _e377 = finiteScalar(thicknessSample, 1f);
    let worldThickness = max(((_e373 * length(worldRefractedDirection)) * _e377), 0f);
    ...
    let _e419 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e419.xyz;
    ...
    let _e427 = local_1;
    if _e427 {
        let _e435 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e435.xyz;
    }
    let _e439 = material.attenuationColor;
    let _e442 = finiteColor(_e439, vec3(1f));
    let safeAttenuationColor = clamp(_e442, vec3(0f), vec3(1f));
    let _e450 = material.attenuationDistance;
    let _e452 = finiteScalar(_e450, 0f);
    let safeAttenuationDistance = max(_e452, 0f);
    ...
    let _e469 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e469);
    let _e471 = color;
    let _e472 = transmittedBackdrop;
    let _e475 = finiteColor(_e472, vec3(0f));
    color = (_e471 + ((_e475 * transmittedEnergy) * beerAttenuation));
    let _e479 = physicalNormal;
    let _e481 = standardViewZ(in_2);
    let _e482 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e479, in_2.worldPos, _e481);
    let _e483 = physicalNormal;
    let _e484 = diffuseAlbedo;
    let _e485 = f0_;
    let _e486 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e483, v_5, _e484, metallic_13, a_4, _e485);
    let _e487 = color;
    color = (_e487 + (_e482 * _e486));
    let _e490 = color;
    let _e493 = standardViewZ(in_2);
    let _e495 = physicalNormal;
    let _e496 = diffuseAlbedo;
    let _e497 = f0_;
    let _e499 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e493, in_2.worldPos, _e495, v_5, _e496, metallic_13, a_4, _e497, false);
    color = (_e490 + _e499);
    let _e501 = color;
    color = (_e501 + _e6.emissive);
    let _e506 = color;
    output.color = vec4<f32>(_e506, alpha_1);
    let _e509 = reflectionFallback;
    output.reflectionFallback = vec4<f32>(_e509, 1f);
    let _e512 = output;
    return _e512;
}
