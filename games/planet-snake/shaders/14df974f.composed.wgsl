...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let kD = ((vec3(1f) - _e73) * (1f - metallic_10));
    ...
    let _e196 = f0_;
    let _e197 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e194, v_2, _e195, metallic_10, a_2, _e196);
    let _e198 = color;
    ...
    let _e208 = f0_;
    let _e210 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e204, in_2.worldPos, _e206, v_2, _e207, metallic_10, a_2, _e208, false);
    color = (_e201 + _e210);
    let _e212 = color;
