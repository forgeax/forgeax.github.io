...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e229 = f0_;
    let _e230 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e227, v_2, _e228, metallic_12, a_3, _e229);
    let _e231 = color;
    ...
    let _e241 = f0_;
    let _e243 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e237, in_2.worldPos, _e239, v_2, _e240, metallic_12, a_3, _e241, false);
    color = (_e234 + _e243);
    let _e245 = color;
