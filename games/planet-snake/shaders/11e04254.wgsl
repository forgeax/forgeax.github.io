...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_3: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic: f32, alphaSq: f32, F0_4: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_3 = max(dot(normal_3, l_2), 0f);
...
fn evaluate_surface(input_2: SurfaceInput) -> SurfaceData {
    ...
    let metallic_1 = clamp((_e87 * _e92), 0f, 1f);
    ...
    return SurfaceData(baseColor_1, _e133, metallic_1, roughness_6, emissive, occlusion, clamp(((_e137 * baseSample.w) * vertexColor.w), 0f, 1f), clamp(_e147, 0f, 1f));
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let kD = ((vec3(1f) - _e150) * (1f - metallic_2));
    ...
    let _e452 = f0_;
    let _e453 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e450, v, _e451, metallic_2, a_2, _e452);
    let _e454 = color;
    color = (_e454 + (_e449 * _e453));
    let _e457 = color;
    return vec4<f32>(_e457, alpha);
}
...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e5 = temporalVertexAlpha(in_5);
    let _e9 = material.alphaCutoff;
    let _e12 = material.baseColorTextureCoordinatesTransform;
    let _e15 = material.baseColorTextureCoordinatesMetadata;
    let _e20 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e32 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e3 * _e5), _e9, baseColorTexture_1, baseColorTexture_sampler, _e12, _e15, in_5.currentClip, in_5.previousClip, _e20, 1f, in_5.uv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6_, in_5.uv7_);
    return _e32;
}
