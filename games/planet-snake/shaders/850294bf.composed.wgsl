...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e212 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e208, (_e209 * skyFactor), probeDiffuseK, _e211, metallic_4);
    ...
    let _e227 = standardViewZ(in_2);
    let _e228 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e225, in_2.worldPos, _e227);
    let _e229 = physicalNormal;
    let _e230 = diffuseAlbedo;
    let _e231 = f0_;
    let _e232 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e229, v, _e230, metallic_4, a_3, _e231);
    let _e233 = color;
    color = (_e233 + (_e228 * _e232));
    let _e236 = color;
    color = (_e236 + _e6.emissive);
    let _e241 = color;
    output.color = vec4<f32>(_e241, alpha_1);
    let _e244 = reflectionFallback;
    output.reflectionFallback = vec4<f32>(_e244, 1f);
    let _e247 = output;
    return _e247;
}
