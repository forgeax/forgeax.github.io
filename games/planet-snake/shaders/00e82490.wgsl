...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let kD_1 = ((vec3(1f) - _e73) * (1f - metallic_4));
    ...
    if (_e85 < 0f) {
        ...
        let _e114 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e88, v, iblRoughness, _e89, in_2.worldPos, vec3<f32>(_e93, _e96, _e99), _e103.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_2, brdfLutSampler_2);
        specularIbl = _e114;
    } else {
        ...
        let _e133 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e124, v, iblRoughness, _e125, _e128, prefilterMap_1, prefilterSampler_1, brdfLut_2, brdfLutSampler_2);
        specularIbl = _e133;
    }
    ...
    let _e205 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e201, (_e202 * skyFactor), probeDiffuseK, _e204, metallic_4);
    ...
    let _e227 = f0_;
    let _e228 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e225, v, _e226, metallic_4, a_2, _e227);
    let _e229 = color;
    color = (_e229 + (_e224 * _e228));
    let _e232 = color;
    return vec4<f32>(_e232, alpha);
}
