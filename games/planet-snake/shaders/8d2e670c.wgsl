...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e196 = f0_;
    let _e197 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e194, v, _e195, metallic_2, a_2, _e196);
    let _e198 = color;
    color = (_e198 + (_e193 * _e197));
    let _e201 = color;
    return vec4<f32>(_e201, alpha);
}
