...
fn vs_main_impl(in_6: VsIn, meshIndex: u32, instanceIndex: u32) -> VsOut {
    ...
    let _e125 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e126 = sceneViewZX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(clipPos, _e125);
    out_2.viewZ = _e126;
    let _e127 = out_2;
    return _e127;
}
