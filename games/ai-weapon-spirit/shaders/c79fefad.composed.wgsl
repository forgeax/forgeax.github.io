...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e122 = f0_;
    let _e123 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e119, _e120, v_2, _e121, metallic_15, a_3, _e122, _e114);
    color = (_e115 + _e123);
    let _e125 = color;
