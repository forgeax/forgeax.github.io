...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e463 = f0_;
    let _e464 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e460, _e461, v_2, _e462, metallic_15, a_2, _e463, _e455);
    color = (_e456 + _e464);
    let _e468 = color;
    output.color = vec4<f32>(_e468, alpha_1);
