...
fn encodeStandardGBufferX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(normal_12: vec3<f32>, roughness_7: f32, albedo_3: vec3<f32>, metallic_4: f32, f0_4: vec3<f32>, occlusion: f32, emissive: vec3<f32>, opacity: f32, reflection: u32, probeRow_1: u32) -> GBufferOutputX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX {
    return GBufferOutputX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(vec4<f32>(((normalize(normal_12) * 0.5f) + vec3(0.5f)), roughness_7), pack4x8unorm(vec4<f32>(albedo_3, metallic_4)), vec4<f32>(f0_4, occlusion), vec4<f32>(emissive, opacity), ((reflection << 24u) | probeRow_1));
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e457 = color;
    output.color = vec4<f32>(_e457, alpha_2);
