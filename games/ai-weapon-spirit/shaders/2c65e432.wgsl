...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e442 = f0_;
    let _e443 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e439, _e440, v_5, _e441, metallic_16, a_3, _e442, _e434);
    color = (_e435 + _e443);
    let _e447 = color;
