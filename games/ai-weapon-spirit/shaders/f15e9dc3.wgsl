...
fn resolveStandardDeferred(in_2: FullscreenOutputX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX) -> DeferredOutput {
    ...
    let _e131 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(position, normal_19, direction_5, albedo_3.xyz, albedo_3.w, roughness_10, response.xyz, _e122, irradianceMap_2, linearSampler, prefilterMap_2, linearSampler, brdfLut_4, skylightPrefilterMap_1, _e123, _e124);
    let _e134 = params.x;
    if (_e134 > 0f) {
    ...
    let _e168 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(position, ndc_3, _e162, normal_19, direction_5, albedo_3.xyz, albedo_3.w, (roughness_10 * roughness_10), response.xyz, _e163);
