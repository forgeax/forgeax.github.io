...
struct TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX {
...
fn shadeTitleX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(input_2: TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX, frontFacing_1: bool) -> vec4<f32> {
    var normal_6: vec3<f32>;
    var color: vec3<f32>;

    normal_6 = normalize(input_2.worldNormal);
    if !(frontFacing_1) {
        let _e6 = normal_6;
        normal_6 = -(_e6);
    }
    let _e10 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.lightDir;
    let toLight = normalize(-(_e10));
    let _e15 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let toCamera = normalize((_e15 - input_2.worldPos));
    let _e19 = normal_6;
    let _e22 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e19, input_2.worldPos, input_2.viewZ);
    let _e23 = normal_6;
    let _e26 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.diffuseWrap;
    let diffuseNormal = normalize((_e23 + (toLight * _e26)));
    let _e32 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.baseColor;
    let _e36 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shadowColor;
    let _e40 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.sideShade;
    let _e42 = illustratedDiffuseX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU2LMNR2XG5DSMF2GKZC7NRUWO2DUNFXGOX(_e32.xyz, _e36.xyz, diffuseNormal, _e22, _e40, false);
    let _e45 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.baseColor;
    let _e49 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shadowColor;
    let _e53 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.sideShade;
    let _e55 = illustratedDiffuseX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU2LMNR2XG5DSMF2GKZC7NRUWO2DUNFXGOX(_e45.xyz, _e49.xyz, diffuseNormal, _e22, _e53, true);
    let _e58 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.baseColor;
    let _e62 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shadowColor;
    let _e66 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.sideShade;
    let _e69 = illustratedDiffuseX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU2LMNR2XG5DSMF2GKZC7NRUWO2DUNFXGOX(_e58.xyz, _e62.xyz, diffuseNormal, 0f, _e66, true);
    let _e75 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.diffuseStrength;
    color = (_e69 + ((mix(_e42, _e55, 0.65f) - _e69) * _e75));
    let _e79 = color;
    let _e82 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.baseColor;
    let _e84 = normal_6;
    let _e87 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.surfaceRoughness;
    let _e90 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.surfaceMetallic;
    let _e93 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.specularStrength;
    let _e94 = paintedSpecularX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU4DBNFXHIZLSNR4V643VOJTGCY3FX(_e82.xyz, _e84, toLight, toCamera, _e87, _e90, _e93, _e22);
    color = (_e79 + _e94);
    let _e96 = color;
    let _e99 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.rimColor;
    let _e101 = normal_6;
    let _e104 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.surfaceRoughness;
    let _e107 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.rimStrength;
    let _e108 = paintedRimX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU4DBNFXHIZLSNR4V643VOJTGCY3FX(_e101, toCamera, _e104, _e107, _e22);
    color = (_e96 + (_e99.xyz * _e108));
    let _e111 = color;
    let _e114 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.rimColor;
    let _e118 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.emissionStrength;
    color = (_e111 + (_e114.xyz * _e118));
    let _e121 = color;
    let _e125 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.baseColor.w;
    return vec4<f32>(_e121, _e125);
}

fn titleNormalX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(model: mat4x4<f32>, normal_7: vec3<f32>) -> vec3<f32> {
    let a_2 = model[0].xyz;
    let b = model[1].xyz;
    let c = model[2].xyz;
    return normalize((mat3x3<f32>(cross(b, c), cross(c, a_2), cross(a_2, b)) * normal_7));
}

@vertex 
fn vs_main(input: VsIn, @builtin(instance_index) idx: u32) -> TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX {
    var output: TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX;
    ...
    let model_1 = (_e3 * _e8);
    let world = (model_1 * vec4<f32>(input.pos, 1f));
    let _e19 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    output.clip = (_e19 * world);
    output.worldPos = world.xyz;
    let _e25 = titleNormalX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(model_1, input.normal);
    output.worldNormal = _e25;
    let _e29 = output.clip.w;
    output.viewZ = -(_e29);
    let _e31 = output;
    return _e31;
}
...
@fragment 
fn fs_main(input_1: TitleVaryingsX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    var heightIntegral: f32;

    let _e2 = shadeTitleX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJOQ5DU5DJORWGKX3TOVZGMYLDMUX(input_1, frontFacing);
    let _e6 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let ray = (input_1.worldPos - _e6);
    let _e10 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.mistFalloff;
    let _e15 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos.y;
    let _e18 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.mistBaseHeight;
    let cameraDensity = exp(clamp((-(_e10) * (_e15 - _e18)), -12f, 12f));
    let _e27 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.mistFalloff;
    let vertical = (_e27 * ray.y);
    heightIntegral = ((1f - (vertical * 0.5f)) + ((vertical * vertical) / 6f));
    if (abs(vertical) > 0.01f) {
        heightIntegral = ((1f - exp(clamp(-(vertical), -12f, 12f))) / vertical);
    }
    let _e52 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.mistDensity;
    let _e56 = heightIntegral;
    let opticalDepth = (((_e52 * length(ray)) * cameraDensity) * _e56);
    let haze = clamp((1f - exp(-(opticalDepth))), 0f, 0.94f);
    let _e68 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.mistColor;
    return vec4<f32>(mix(_e2.xyz, _e68.xyz, haze), _e2.w);
}
