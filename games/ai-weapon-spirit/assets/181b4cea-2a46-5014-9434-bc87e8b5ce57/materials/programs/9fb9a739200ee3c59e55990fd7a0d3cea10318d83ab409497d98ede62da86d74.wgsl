...
fn curve_0_(t: f32) -> f32 {
    ...
    if (t < 1f) {
        let u = ((t - 0f) / 1f);
        return (((((((((2f * u) * u) * u) - ((3f * u) * u)) + 1f) * 0.1573457f) + (((((u * u) * u) - ((2f * u) * u)) + u) * -0.4724771f)) + (((((-2f * u) * u) * u) + ((3f * u) * u)) * 1f)) + ((((u * u) * u) - (u * u)) * 1.248137f));
    }
    return 1f;
}
...
fn curve_1_(t_1: f32) -> f32 {
    ...
    if (t_1 < 0.8582278f) {
        let u_1 = ((t_1 - 0f) / 0.8582278f);
        return (((((((((2f * u_1) * u_1) * u_1) - ((3f * u_1) * u_1)) + 1f) * 0.1780822f) + (((((u_1 * u_1) * u_1) - ((2f * u_1) * u_1)) + u_1) * 0.3166253f)) + (((((-2f * u_1) * u_1) * u_1) + ((3f * u_1) * u_1)) * 1f)) + ((((u_1 * u_1) * u_1) - (u_1 * u_1)) * 0.5910336f));
    }
    return 1f;
}
...
fn curve_2_(t_2: f32) -> f32 {
    ...
    if (t_2 < 1f) {
        let u_2 = ((t_2 - 0f) / 1f);
        return (((((((((2f * u_2) * u_2) * u_2) - ((3f * u_2) * u_2)) + 1f) * 0.1573457f) + (((((u_2 * u_2) * u_2) - ((2f * u_2) * u_2)) + u_2) * -0.4724771f)) + (((((-2f * u_2) * u_2) * u_2) + ((3f * u_2) * u_2)) * 1f)) + ((((u_2 * u_2) * u_2) - (u_2 * u_2)) * 1.248137f));
    }
    return 1f;
}
...
fn curve_3_(t_3: f32) -> f32 {
    ...
    if (t_3 < 0.8582278f) {
        let u_3 = ((t_3 - 0f) / 0.8582278f);
        return (((((((((2f * u_3) * u_3) * u_3) - ((3f * u_3) * u_3)) + 1f) * 0.1780822f) + (((((u_3 * u_3) * u_3) - ((2f * u_3) * u_3)) + u_3) * 0.3166253f)) + (((((-2f * u_3) * u_3) * u_3) + ((3f * u_3) * u_3)) * 1f)) + ((((u_3 * u_3) * u_3) - (u_3 * u_3)) * 0.5910336f));
    }
    return 1f;
}
...
fn curve_4_(t_4: f32) -> f32 {
    ...
    if (t_4 < 1f) {
        let u_4 = ((t_4 - 0f) / 1f);
        return (((((((((2f * u_4) * u_4) * u_4) - ((3f * u_4) * u_4)) + 1f) * 0.1573457f) + (((((u_4 * u_4) * u_4) - ((2f * u_4) * u_4)) + u_4) * -0.4724771f)) + (((((-2f * u_4) * u_4) * u_4) + ((3f * u_4) * u_4)) * 1f)) + ((((u_4 * u_4) * u_4) - (u_4 * u_4)) * 1.248137f));
    }
    return 1f;
}
...
fn curve_5_(t_5: f32) -> f32 {
    ...
    if (t_5 < 0.8582278f) {
        let u_5 = ((t_5 - 0f) / 0.8582278f);
        return (((((((((2f * u_5) * u_5) * u_5) - ((3f * u_5) * u_5)) + 1f) * 0.1780822f) + (((((u_5 * u_5) * u_5) - ((2f * u_5) * u_5)) + u_5) * 0.3166253f)) + (((((-2f * u_5) * u_5) * u_5) + ((3f * u_5) * u_5)) * 1f)) + ((((u_5 * u_5) * u_5) - (u_5 * u_5)) * 0.5910336f));
    }
    return 1f;
}
...
fn gradient_6_(t_6: f32) -> vec4<f32> {
    ...
    if (t_6 <= 0f) {
        rgb_2 = vec3<f32>(1f, 0f, 0.24280262f);
    } else {
        if (t_6 <= 0.09117266f) {
            rgb_2 = mix(vec3<f32>(1f, 0f, 0.24280262f), vec3<f32>(1f, 0f, 0.01978827f), ((t_6 - 0f) / 0.09117266f));
        } else {
            if (t_6 <= 0.28824294f) {
                rgb_2 = mix(vec3<f32>(1f, 0f, 0.01978827f), vec3<f32>(0.5566038f, 0.03393925f, 0f), ((t_6 - 0.09117266f) / 0.19707027f));
            } else {
                if (t_6 <= 0.66764325f) {
                    rgb_2 = mix(vec3<f32>(0.5566038f, 0.03393925f, 0f), vec3<f32>(0.3962264f, 0.01219158f, 0f), ((t_6 - 0.28824294f) / 0.3794003f));
                }
            }
        }
    }
...
fn curve_8_(t_8: f32) -> f32 {
    ...
    if (t_8 < 1f) {
        let u_6 = ((t_8 - 0f) / 1f);
        return (((((((((2f * u_6) * u_6) * u_6) - ((3f * u_6) * u_6)) + 1f) * 0.32382202f) + (((((u_6 * u_6) * u_6) - ((2f * u_6) * u_6)) + u_6) * 0f)) + (((((-2f * u_6) * u_6) * u_6) + ((3f * u_6) * u_6)) * 1f)) + ((((u_6 * u_6) * u_6) - (u_6 * u_6)) * 1f));
    }
    return 1f;
}
...
fn dm_appearance(seed_1: u32, id_1: u32, t_9: f32, particle: ptr<function, Particle>) {
    ...
    (*particle).size_rotation.x = max(0f, ((mix(0.5f, 1f, _e6) * 1f) * (mix(_e13, _e14, _e16) * 2.039182f)));
    let _e26 = dm_random(seed_1, id_1, 73u);
    let _e32 = curve_2_(t_9);
    let _e33 = curve_3_(t_9);
    let _e35 = dm_random(seed_1, id_1, 6u);
    (*particle).size_rotation.y = max(0f, ((mix(0.5f, 1f, _e26) * 1f) * (mix(_e32, _e33, _e35) * 2.039182f)));
    let _e45 = dm_random(seed_1, id_1, 143u);
    let _e51 = curve_4_(t_9);
    let _e52 = curve_5_(t_9);
    let _e54 = dm_random(seed_1, id_1, 6u);
    (*particle).size_rotation.w = max(0f, ((mix(0.5f, 1f, _e45) * 1f) * (mix(_e51, _e52, _e54) * 2.039182f)));
    let _e63 = dm_random(seed_1, id_1, 5u);
    let _e64 = gradient_6_(_e63);
    let _e65 = gradient_7_(t_9);
    (*particle).color = (_e64 * _e65);
    let _e69 = curve_8_(t_9);
    (*particle).velocity.w = floor((fract((0f + ((_e69 * 0.9999f) * 1f))) * 8f));
    return;
}
...
fn dm_streams(uv: vec2<f32>, p_1: Particle, seed_3: u32) -> DmStreams {
    ...
    let custom1_ = vec4<f32>(mix(5f, 12f, _e10), 0f, 0f, 0f);
    ...
    let _e48 = stream_dm_random(seed_3, id_3, 201u);
    let _e53 = stream_dm_random(seed_3, id_3, 202u);
    o_1.rotationXY = vec2<f32>(mix(0f, 6.283185f, _e48), mix(0f, 6.283185f, _e53));
    o_1.uv1_.z = t_12;
    let _e63 = stream_dm_random(seed_3, id_3, 345u);
    o_1.uv1_.w = _e63;
    let _e64 = o_1;
    return _e64;
}
...
fn source_material(input_5: MaterialInput) -> vec4<f32> {
    ...
    let uv_2 = fract((input_5.uv0_.xy * vec2<f32>(4f, 2f)));
    let pulse = pow((0.5f + (0.5f * sin((((((uv_2.x * 0.7f) + uv_2.y) * 12f) - (age_1 * 12f)) + (phase * 6.283185f))))), 6f);
    return vec4<f32>((_e13.xyz * (0.85f + (pulse * 0.9f))), _e13.w);
}

fn repair_motion(t_10: f32) -> vec3<f32> {
    let a_1 = (t_10 * 0.034906585f);
    return vec3<f32>((6.66f * (1f - cos(a_1))), 0f, (6.66f * sin(a_1)));
}

fn repair_velocity(t_11: f32) -> vec3<f32> {
    let a_2 = (t_11 * 0.034906585f);
