...
fn curve_1_(t_1: f32) -> f32 {
    ...
    if (t_1 < 0.2625416f) {
        let u_6 = ((t_1 - 0f) / 0.2625416f);
        return (((((((((2f * u_6) * u_6) * u_6) - ((3f * u_6) * u_6)) + 1f) * 0.570776f) + (((((u_6 * u_6) * u_6) - ((2f * u_6) * u_6)) + u_6) * -0.11557979f)) + (((((-2f * u_6) * u_6) * u_6) + ((3f * u_6) * u_6)) * 0.4766391f)) + ((((u_6 * u_6) * u_6) - (u_6 * u_6)) * -0.08008222f));
    }
    if (t_1 < 0.3060009f) {
        let u_7 = ((t_1 - 0.2625416f) / 0.0434593f);
        return (((((((((2f * u_7) * u_7) * u_7) - ((3f * u_7) * u_7)) + 1f) * 0.4766391f) + (((((u_7 * u_7) * u_7) - ((2f * u_7) * u_7)) + u_7) * -0.013256251f)) + (((((-2f * u_7) * u_7) * u_7) + ((3f * u_7) * u_7)) * 1f)) + ((((u_7 * u_7) * u_7) - (u_7 * u_7)) * -0.012984261f));
    }
    if (t_1 < 0.3377866f) {
        let u_8 = ((t_1 - 0.3060009f) / 0.0317857f);
        return (((((((((2f * u_8) * u_8) * u_8) - ((3f * u_8) * u_8)) + 1f) * 1f) + (((((u_8 * u_8) * u_8) - ((2f * u_8) * u_8)) + u_8) * -0.009496559f)) + (((((-2f * u_8) * u_8) * u_8) + ((3f * u_8) * u_8)) * 0.4701471f)) + ((((u_8 * u_8) * u_8) - (u_8 * u_8)) * -0.016321767f));
    }
    if (t_1 < 0.5867438f) {
        let u_9 = ((t_1 - 0.3377866f) / 0.2489572f);
        return (((((((((2f * u_9) * u_9) * u_9) - ((3f * u_9) * u_9)) + 1f) * 0.4701471f) + (((((u_9 * u_9) * u_9) - ((2f * u_9) * u_9)) + u_9) * -0.12783803f)) + (((((-2f * u_9) * u_9) * u_9) + ((3f * u_9) * u_9)) * 0.3489168f)) + ((((u_9 * u_9) * u_9) - (u_9 * u_9)) * -0.09838261f));
    }
    if (t_1 < 0.6278235f) {
        let u_10 = ((t_1 - 0.5867438f) / 0.0410797f);
        return (((((((((2f * u_10) * u_10) * u_10) - ((3f * u_10) * u_10)) + 1f) * 0.3489168f) + (((((u_10 * u_10) * u_10) - ((2f * u_10) * u_10)) + u_10) * -0.016233826f)) + (((((-2f * u_10) * u_10) * u_10) + ((3f * u_10) * u_10)) * 0.5392179f)) + ((((u_10 * u_10) * u_10) - (u_10 * u_10)) * -0.018245516f));
    }
    if (t_1 < 0.6455854f) {
        let u_11 = ((t_1 - 0.6278235f) / 0.0177619f);
        return (((((((((2f * u_11) * u_11) * u_11) - ((3f * u_11) * u_11)) + 1f) * 0.5392179f) + (((((u_11 * u_11) * u_11) - ((2f * u_11) * u_11)) + u_11) * -0.007888934f)) + (((((-2f * u_11) * u_11) * u_11) + ((3f * u_11) * u_11)) * 0.3273815f)) + ((((u_11 * u_11) * u_11) - (u_11 * u_11)) * -0.012016151f));
    }
    return 0.3273815f;
}
...
fn curve_2_(t_2: f32) -> f32 {
    ...
    if (t_2 < 0.2625416f) {
        let u_12 = ((t_2 - 0f) / 0.2625416f);
        return (((((((((2f * u_12) * u_12) * u_12) - ((3f * u_12) * u_12)) + 1f) * 0.570776f) + (((((u_12 * u_12) * u_12) - ((2f * u_12) * u_12)) + u_12) * -0.11557979f)) + (((((-2f * u_12) * u_12) * u_12) + ((3f * u_12) * u_12)) * 0.4766391f)) + ((((u_12 * u_12) * u_12) - (u_12 * u_12)) * -0.08008222f));
    }
    if (t_2 < 0.3060009f) {
        let u_13 = ((t_2 - 0.2625416f) / 0.0434593f);
        return (((((((((2f * u_13) * u_13) * u_13) - ((3f * u_13) * u_13)) + 1f) * 0.4766391f) + (((((u_13 * u_13) * u_13) - ((2f * u_13) * u_13)) + u_13) * -0.013256251f)) + (((((-2f * u_13) * u_13) * u_13) + ((3f * u_13) * u_13)) * 1f)) + ((((u_13 * u_13) * u_13) - (u_13 * u_13)) * -0.012984261f));
    }
    if (t_2 < 0.3377866f) {
        let u_14 = ((t_2 - 0.3060009f) / 0.0317857f);
        return (((((((((2f * u_14) * u_14) * u_14) - ((3f * u_14) * u_14)) + 1f) * 1f) + (((((u_14 * u_14) * u_14) - ((2f * u_14) * u_14)) + u_14) * -0.009496559f)) + (((((-2f * u_14) * u_14) * u_14) + ((3f * u_14) * u_14)) * 0.4701471f)) + ((((u_14 * u_14) * u_14) - (u_14 * u_14)) * -0.016321767f));
    }
    if (t_2 < 0.5867438f) {
        let u_15 = ((t_2 - 0.3377866f) / 0.2489572f);
        return (((((((((2f * u_15) * u_15) * u_15) - ((3f * u_15) * u_15)) + 1f) * 0.4701471f) + (((((u_15 * u_15) * u_15) - ((2f * u_15) * u_15)) + u_15) * -0.12783803f)) + (((((-2f * u_15) * u_15) * u_15) + ((3f * u_15) * u_15)) * 0.3489168f)) + ((((u_15 * u_15) * u_15) - (u_15 * u_15)) * -0.09838261f));
    }
    if (t_2 < 0.6278235f) {
        let u_16 = ((t_2 - 0.5867438f) / 0.0410797f);
        return (((((((((2f * u_16) * u_16) * u_16) - ((3f * u_16) * u_16)) + 1f) * 0.3489168f) + (((((u_16 * u_16) * u_16) - ((2f * u_16) * u_16)) + u_16) * -0.016233826f)) + (((((-2f * u_16) * u_16) * u_16) + ((3f * u_16) * u_16)) * 0.5392179f)) + ((((u_16 * u_16) * u_16) - (u_16 * u_16)) * -0.018245516f));
    }
    if (t_2 < 0.6455854f) {
        let u_17 = ((t_2 - 0.6278235f) / 0.0177619f);
        return (((((((((2f * u_17) * u_17) * u_17) - ((3f * u_17) * u_17)) + 1f) * 0.5392179f) + (((((u_17 * u_17) * u_17) - ((2f * u_17) * u_17)) + u_17) * -0.007888934f)) + (((((-2f * u_17) * u_17) * u_17) + ((3f * u_17) * u_17)) * 0.3273815f)) + ((((u_17 * u_17) * u_17) - (u_17 * u_17)) * -0.012016151f));
    }
    return 0.3273815f;
}

fn gradient_3_(t_3: f32) -> vec4<f32> {
    var rgb_3: vec3<f32> = vec3<f32>(0.3962264f, 0.01219158f, 0f);
    var alpha_1: f32 = 1f;

    if (t_3 <= 0.09117266f) {
        rgb_3 = vec3<f32>(1f, 0f, 0.01978827f);
    } else {
        if (t_3 <= 0.28824294f) {
            rgb_3 = mix(vec3<f32>(1f, 0f, 0.01978827f), vec3<f32>(0.5566038f, 0.03393925f, 0f), ((t_3 - 0.09117266f) / 0.19707027f));
        } else {
            if (t_3 <= 0.66764325f) {
                rgb_3 = mix(vec3<f32>(0.5566038f, 0.03393925f, 0f), vec3<f32>(0.3962264f, 0.01219158f, 0f), ((t_3 - 0.28824294f) / 0.3794003f));
            }
        }
    }
    if (t_3 <= 0f) {
...
fn gradient_4_(t_4: f32) -> vec4<f32> {
    ...
    if (t_4 <= 0f) {
        ...
        if (t_4 <= 0.17941558f) {
            alpha_2 = mix(0f, 1f, ((t_4 - 0f) / 0.17941558f));
        } else {
            if (t_4 <= 0.30588236f) {
                alpha_2 = mix(1f, 1f, ((t_4 - 0.17941558f) / 0.12646678f));
            } else {
                if (t_4 <= 0.3764706f) {
                    alpha_2 = mix(1f, 0f, ((t_4 - 0.30588236f) / 0.07058824f));
                } else {
                    if (t_4 <= 0.4647135f) {
                        alpha_2 = mix(0f, 1f, ((t_4 - 0.3764706f) / 0.088242926f));
                    } else {
                        if (t_4 <= 0.69117266f) {
                            alpha_2 = mix(1f, 0f, ((t_4 - 0.4647135f) / 0.22645915f));
                        } else {
                            if (t_4 <= 0.8323491f) {
                                alpha_2 = mix(0f, 1f, ((t_4 - 0.69117266f) / 0.14117648f));
                            } else {
                                if (t_4 <= 1f) {
                                    alpha_2 = mix(1f, 0f, ((t_4 - 0.8323491f) / 0.16765088f));
                                }
                            }
                        }
                    }
...
fn gradient_5_(t_5: f32) -> vec4<f32> {
    var rgb_5: vec3<f32> = vec3<f32>(1f, 1f, 1f);
    var alpha_3: f32 = 0f;

    if (t_5 <= 0.1764706f) {
        rgb_5 = vec3<f32>(1f, 1f, 1f);
    } else {
        if (t_5 <= 0.30882734f) {
            rgb_5 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_5 - 0.1764706f) / 0.13235676f));
        } else {
            if (t_5 <= 0.4617685f) {
                rgb_5 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_5 - 0.30882734f) / 0.15294118f));
            } else {
                if (t_5 <= 0.8352941f) {
                    rgb_5 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_5 - 0.4617685f) / 0.3735256f));
                }
            }
        }
    }
    if (t_5 <= 0f) {
        ...
        if (t_5 <= 0.17941558f) {
            alpha_3 = mix(0f, 1f, ((t_5 - 0f) / 0.17941558f));
        } else {
            if (t_5 <= 0.30588236f) {
                alpha_3 = mix(1f, 1f, ((t_5 - 0.17941558f) / 0.12646678f));
            } else {
                if (t_5 <= 0.3764706f) {
                    alpha_3 = mix(1f, 0f, ((t_5 - 0.30588236f) / 0.07058824f));
                } else {
                    if (t_5 <= 0.4647135f) {
                        alpha_3 = mix(0f, 1f, ((t_5 - 0.3764706f) / 0.088242926f));
                    } else {
                        if (t_5 <= 0.69117266f) {
                            alpha_3 = mix(1f, 0f, ((t_5 - 0.4647135f) / 0.22645915f));
                        } else {
                            if (t_5 <= 0.8323491f) {
                                alpha_3 = mix(0f, 1f, ((t_5 - 0.69117266f) / 0.14117648f));
                            } else {
                                if (t_5 <= 1f) {
                                    alpha_3 = mix(1f, 0f, ((t_5 - 0.8323491f) / 0.16765088f));
                                }
                            }
                        }
                    }
...
fn dm_appearance(seed_2: u32, id_3: u32, t_6: f32, particle: ptr<function, Particle>) {
    let _e6 = dm_random(seed_2, id_3, 3u);
    let _e13 = curve_0_(t_6);
    (*particle).size_rotation.x = max(0f, ((mix(1f, 2.5f, _e6) * 1f) * (_e13 * 1.5f)));
    let _e22 = dm_random(seed_2, id_3, 3u);
    let _e28 = curve_1_(t_6);
    (*particle).size_rotation.y = max(0f, ((mix(1f, 2.5f, _e22) * 1f) * (_e28 * 1.5f)));
    let _e37 = dm_random(seed_2, id_3, 3u);
    let _e43 = curve_2_(t_6);
    (*particle).size_rotation.w = max(0f, ((mix(1f, 2.5f, _e37) * 1f) * (_e43 * 1.5f)));
    let _e51 = dm_random(seed_2, id_3, 5u);
    let _e52 = gradient_3_(_e51);
    let _e53 = gradient_4_(t_6);
    let _e54 = gradient_5_(t_6);
    let _e56 = dm_random(seed_2, id_3, 7u);
    (*particle).color = (_e52 * mix(_e53, _e54, _e56));
    let _e62 = dm_random(seed_2, id_3, 26u);
    (*particle).velocity.w = floor((fract((0f + (mix(0f, 0.75f, _e62) * 1f))) * 4f));
    return;
}
...
fn dm_streams(uv: vec2<f32>, p_1: Particle, seed_4: u32) -> DmStreams {
    ...
    let id_5 = p_1.id;
    let t_8 = clamp((p_1.age / p_1.lifetime), 0f, 1f);
    let _e10 = stream_dm_random(seed_4, id_5, 160u);
    let custom1_ = vec4<f32>(mix(6f, 12f, _e10), 0f, 0f, 0f);
...
fn source_vertex(input_2: MaterialInput) -> vec3<f32> {
    ...
    let n11_ = textureSampleLevel(texAX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX, texA_samplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX, vec2<f32>(((n8_ * vec2<f32>(2f, 2f)) + vec2<f32>(0f, 0f)).x, (1f - ((n8_ * vec2<f32>(2f, 2f)) + vec2<f32>(0f, 0f)).y)), 0f);
...
fn source_material(input_3: MaterialInput) -> vec4<f32> {
    ...
    let n3_1 = vec4<f32>(0.1f, 0.1f, 0f, 0f);
    let n4_1 = input_3.time;
    let n5_1 = (n3_1 * vec4(n4_1));
    let n6_1 = ((n2_1.xy * vec2<f32>(1f, 1f)) + n5_1.xy);
    let n103_ = textureSample(texAX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX, texA_samplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX, vec2<f32>(((n6_1 * vec2<f32>(2f, 2f)) + vec2<f32>(0f, 0f)).x, (1f - ((n6_1 * vec2<f32>(2f, 2f)) + vec2<f32>(0f, 0f)).y)));
    let n8_1 = (n1_1 * n103_);
    let n10_ = (1f - 1f);
    ...
    let n28_1 = vec4<f32>(0.3f, 0f, 0f, 0f);
...
fn curve_6_(t_7: f32) -> f32 {
    if (t_7 <= 0f) {
        return 1f;
    }
    if (t_7 < 0.02875004f) {
        let u_18 = ((t_7 - 0f) / 0.02875004f);
    ...
    if (t_7 < 1f) {
        let u_19 = ((t_7 - 0.02875004f) / 0.97124994f);
...
fn vs_main(native: NativeInput, @builtin(vertex_index) vertex: u32) -> Varying {
    ...
    up = _e108;
    let _e113 = frame.layer.x;
    let columns = u32(_e113);
    let _e118 = frame.layer.y;
    let rows = u32(_e118);
    let _e122 = p.velocity.w;
    let tile = min(u32(max(_e122, 0f)), ((columns * rows) - 1u));
    let cell_1 = vec2<f32>(f32((tile % columns)), f32(((rows - 1u) - (tile / columns))));
    let _e144 = frame.extra.x;
    let _e147 = p.id;
    let _e149 = dm_random(bitcast<u32>(_e144), _e147, 210u);
    let _e159 = frame.extra.x;
    let _e162 = p.id;
    let _e164 = dm_random(bitcast<u32>(_e159), _e162, 211u);
    let uvCorner = vec2<f32>(select(_e79.x, -(_e79.x), (_e149 < 0f)), select(_e79.y, -(_e79.y), (_e164 < 0f)));
    let _e175 = frame.layer;
    let _e178 = p;
    let _e182 = frame.extra.x;
    let _e184 = dm_streams((((uvCorner + vec2(0.5f)) + cell_1) / _e175.xy), _e178, bitcast<u32>(_e182));
    let _e187 = frame.layer;
    let _e190 = size;
    let plane = vec3<f32>(((_e79 + _e187.zw) * _e190), 0f);
    let _e198 = p.size_rotation.z;
    let _e203 = dm_rotate(plane, (vec3<f32>(-(_e184.rotationXY), -(_e198)) * 57.29578f));
    let _e204 = right;
    let _e205 = up;
    let normal = normalize(cross(_e204, _e205));
    let _e208 = center;
    let _e209 = right;
    let _e212 = up;
    let _e222 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
    world = (_e208 + ((((_e209 * _e203.x) + (_e212 * _e203.y)) + (normal * _e203.z)) * _e222));
    let _e229 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.x;
    if (_e229 > 0f) {
        let _e233 = p.age;
        let _e235 = p.lifetime;
        let age_1 = clamp((_e233 / _e235), 0f, 1f);
        let _e243 = frame.extra.x;
        let seed_5 = bitcast<u32>(_e243);
        let _e247 = p.size_rotation.z;
        let phase = (-(_e247) + ((age_1 - 0.2f) * 0.95f));
        let _e262 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.y;
        let _e269 = p.id;
        let sweep = (((((_e79.x + 0.5f) * 2.5f) * _e262) + phase) + (0.12f * sin(((_e79.y * 5f) + f32(_e269)))));
        let _e277 = size.x;
        let radius_1 = (max(_e277, 0.03f) * (0.43f + (_e79.y * 0.58f)));
        let _e292 = p.id;
        let ripple = (1f + (0.09f * sin(((((_e79.x + 0.5f) * 15f) + (f32(_e292) * 2.3f)) + (age_1 * 8f)))));
        let _e318 = p.id;
        let _e323 = size.x;
        let ribbon = vec3<f32>((((cos(sweep) * radius_1) * ripple) * 1.12f), (((sin(sweep) * radius_1) * ripple) * 0.82f), ((sin(((sweep * 1.4f) + f32(_e318))) * _e323) * 0.24f));
        let knot = min(u32(((_e79.x + 0.5f) * 6f)), 5u);
        let along = clamp((((_e79.x + 0.5f) * 6f) - f32(knot)), 0f, 1f);
        let _e347 = p.id;
        let _e348 = boltPoint(knot, _e347, seed_5);
        let _e352 = p.id;
        let _e353 = boltPoint((knot + 1u), _e352, seed_5);
        let direction = normalize((_e353 - _e348));
        na = vec2<f32>(-(direction.y), direction.x);
        let _e361 = na;
        nb = _e361;
        if (knot > 0u) {
            let _e368 = p.id;
            let _e369 = boltPoint((knot - 1u), _e368, seed_5);
            let prev = normalize((_e348 - _e369));
            let n_2 = vec2<f32>(-(prev.y), prev.x);
            let _e376 = na;
            let join = normalize((n_2 + _e376));
            let _e379 = na;
            na = (join / vec2(max(0.55f, dot(join, _e379))));
        }
        if (knot < 5u) {
            let _e390 = p.id;
            let _e391 = boltPoint((knot + 2u), _e390, seed_5);
            let next = normalize((_e391 - _e353));
            let n_3 = vec2<f32>(-(next.y), next.x);
            let base = vec2<f32>(-(direction.y), direction.x);
            let join_1 = normalize((n_3 + base));
            nb = (join_1 / vec2(max(0.55f, dot(join_1, base))));
        }
        let _e410 = p.id;
        let lane = (f32((_e410 % 3u)) - 1f);
        let _e420 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.z;
        let _e426 = na;
        let _e427 = nb;
        let line = ((mix(_e348, _e353, along) * (1f + (_e420 * 0.2f))) + ((mix(_e426, _e427, along) * _e79.y) * 0.11f));
        let rotated_1 = vec2<f32>(((cos(phase) * line.x) - (sin(phase) * line.y)), ((sin(phase) * line.x) + (cos(phase) * line.y)));
        let _e450 = size.x;
        let boltSize = min((_e450 * 0.65f), 2.2f);
        let _e466 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.z;
        let bolt = vec3<f32>((rotated_1 * boltSize), (((mix(_e348.y, _e353.y, along) * 0.25f) + ((lane * 0.35f) * _e466)) * boltSize));
        let _e474 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.y;
        let surface = mix(ribbon, bolt, _e474);
        let _e477 = p.id;
        let _e481 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.z;
        let _e482 = shapePlane(surface, _e477, _e481);
        let _e483 = right;
        let _e486 = up;
        let facing = ((_e483 * surface.x) + (_e486 * surface.y));
        let _e493 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.z;
        let spatial = mix(facing, _e482, min(1f, _e493));
        let _e497 = center;
        let _e503 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.z;
        let _e509 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.y;
        let _e517 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.z;
        let anchor = ((_e497 * 0.65f) + vec3<f32>(0f, 0.1f, ((lane * (0.14f + ((0.4f * _e503) * _e509))) * _e517)));
        let _e523 = world;
        let _e527 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.settings.w;
        let _e533 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.x;
        world = mix(_e523, (anchor + (spatial * _e527)), _e533);
    }
    let _e535 = right;
    let _e536 = right;
    let tangent = normalize((_e535 - (normal * dot(_e536, normal))));
    let objectNormal = vec3<f32>(0f, 0f, 1f);
    let _e547 = frame.eye;
    let _e551 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    let _e554 = magic_local_axisX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX((_e547.xyz - _e551.xyz));
    let _e555 = world;
    let viewDir = (_e554 - _e555);
    let _e557 = right;
    let _e559 = up;
    let objectView = vec3<f32>(dot(viewDir, _e557), dot(viewDir, _e559), dot(viewDir, normal));
    input.uv0_ = _e184.uv0_;
    input.custom1_ = _e184.uv1_;
    input.custom2_ = _e184.uv2_;
    input.custom3_ = _e184.uv3_;
    let _e574 = p.color;
    input.color = _e574;
    input.normal = normal;
    let _e577 = world;
    input.worldPosition = _e577;
    input.viewDirection = viewDir;
    input.objectPosition = _e203;
    ...
    let _e589 = frame.settings.x;
    input.time = _e589;
    input.delta = 0.008333334f;
    let _e592 = world;
    let _e593 = input;
    let _e594 = source_vertex(_e593);
    let _e596 = input.objectPosition;
    let _e600 = p.age;
    let _e601 = magic_placeX_naga_oil_mod_XMFUV653FMFYG63S7ONYGS4TJORPW2YLHNFRTUOTQNRQWGZLNMVXHIX((_e592 + (_e594 - _e596)), _e600);
    let _e604 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.anchor;
    world = (_e601 + _e604.xyz);
    let _e611 = frame.vp;
    let _e612 = world;
    o.position = (_e611 * vec4<f32>(_e612, 1f));
    o.uv = _e184.uv0_;
    o.custom = _e184.uv1_;
    o.custom2_ = _e184.uv2_;
    o.custom3_ = _e184.uv3_;
    let _e626 = p.color;
    o.color = _e626;
    let _e628 = world;
    o.world = _e628;
    let _e632 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e636 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e640 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.normal = normalize((mat3x3<f32>(_e632.xyz, _e636.xyz, _e640.xyz) * normal));
    let _e648 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisX;
    let _e652 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisY;
    let _e656 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.basisZ;
    o.tangent = normalize((mat3x3<f32>(_e648.xyz, _e652.xyz, _e656.xyz) * tangent));
    o.object = _e203;
    o.objectNormal = objectNormal;
    let _e665 = p.id;
    let _e674 = frame.extra.x;
    let _e677 = p.id;
    let _e679 = dm_random(bitcast<u32>(_e674), _e677, 390u);
    o.bolt = vec4<f32>(_e79, (f32((_e665 % 3u)) - 1f), _e679);
    let _e681 = o;
    return _e681;
}
...
fn fs_main(i: Varying, @builtin(front_facing) front: bool) -> @location(0) vec4<f32> {
    ...
    if (_e96 > 0f) {
        ...
        rgb = _e109;
        let _e110 = alpha;
        let _e114 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.detailA.z;
        let _e118 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.detailA.y;
        alpha = pow(_e110, (1f / mix(1f, _e114, _e118)));
    }
    let _e127 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.x;
    let _e131 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.y;
    if ((_e127 * _e131) > 0f) {
        let side = abs(i.bolt.y);
        let along_1 = (i.bolt.x + 0.5f);
        let _e142 = fwidth(side);
        let aa = max(_e142, 0.015f);
        let coreWidth = (0.045f + (0.018f * sin(((along_1 * 27f) + (i.bolt.w * 15f)))));
        let core_1 = (1f - smoothstep((coreWidth - aa), (coreWidth + aa), side));
        let halo = (1f - smoothstep(0.05f, 0.42f, side));
        let ends = (smoothstep(0f, 0.035f, along_1) * (1f - smoothstep(0.965f, 1f, along_1)));
        let flicker = clamp(i.color.w, 0f, 1f);
        let laneGain = mix(0.42f, 0.95f, ((i.bolt.z * 0.5f) + 0.5f));
        let cut = (0.22f + (i.bolt.w * 0.55f));
        let gap = smoothstep(0.009f, 0.025f, abs((along_1 - cut)));
        let grain = (0.6f + (0.4f * clamp((_e82.w * 3f), 0f, 1f)));
        let coverage = ((((((core_1 * 0.88f) + (halo * 0.16f)) * ends) * flicker) * gap) * grain);
        let _e222 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeC;
        let tint = _e222.xyz;
        let lineColor = (((tint * (0.35f + (halo * 0.5f))) + (mix(tint, vec3(1.4f), 0.75f) * core_1)) * laneGain);
        let _e239 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.x;
        let _e243 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeB.y;
        let blend = (_e239 * _e243);
        let _e245 = rgb;
        let _e246 = rgb;
        rgb = mix(_e245, (lineColor + ((_e246 * 0.06f) * coverage)), blend);
        let _e252 = alpha;
        alpha = mix(_e252, clamp(coverage, 0f, 1f), blend);
    }
    let _e257 = rgb;
    let _e261 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeC.w;
    rgb = (_e257 * _e261);
    let _e263 = alpha;
    let _e267 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeA.x;
    let _e271 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.shapeC.w;
    alpha = (_e263 * (_e267 * min(1f, _e271)));
    let _e277 = rgb.x;
    let _e279 = rgb.y;
    let _e282 = rgb.z;
    let peak_1 = max(max(_e277, _e279), _e282);
    let eclipse = (mix(vec3<f32>(0.32f, 0.045f, 0.82f), vec3<f32>(0.88f, 0.78f, 1f), smoothstep(0.6f, 4f, peak_1)) * peak_1);
    let _e300 = frame.design.z;
    if (_e300 > 0.5f) {
        let _e303 = rgb;
        let _e307 = frame.design.y;
        let _e308 = enchantmentParticleColor(_e303, _e307);
        rgb = _e308;
    } else {
        let _e309 = rgb;
        rgb = mix(_e309, eclipse, 0f);
    }
    let _e312 = alpha;
    let _e316 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.tint.w;
    alpha = (_e312 * _e316);
    let _e318 = rgb;
    let _e321 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.tint;
    let _e324 = alpha;
    let _e326 = alpha;
    return vec4<f32>(((_e318 * _e321.xyz) * _e324), _e326);
}
