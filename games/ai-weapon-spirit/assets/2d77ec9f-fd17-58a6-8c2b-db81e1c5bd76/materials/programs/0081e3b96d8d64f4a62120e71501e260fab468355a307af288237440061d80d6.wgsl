...
fn curve_2_(t_2: f32) -> f32 {
    ...
    if (t_2 < 0.2625416f) {
        let u_14 = ((t_2 - 0f) / 0.2625416f);
        return (((((((((2f * u_14) * u_14) * u_14) - ((3f * u_14) * u_14)) + 1f) * 0.570776f) + (((((u_14 * u_14) * u_14) - ((2f * u_14) * u_14)) + u_14) * -0.11557979f)) + (((((-2f * u_14) * u_14) * u_14) + ((3f * u_14) * u_14)) * 0.4766391f)) + ((((u_14 * u_14) * u_14) - (u_14 * u_14)) * -0.08008222f));
    }
    if (t_2 < 0.3060009f) {
        let u_15 = ((t_2 - 0.2625416f) / 0.0434593f);
        return (((((((((2f * u_15) * u_15) * u_15) - ((3f * u_15) * u_15)) + 1f) * 0.4766391f) + (((((u_15 * u_15) * u_15) - ((2f * u_15) * u_15)) + u_15) * -0.013256251f)) + (((((-2f * u_15) * u_15) * u_15) + ((3f * u_15) * u_15)) * 1f)) + ((((u_15 * u_15) * u_15) - (u_15 * u_15)) * -0.012984261f));
    }
    if (t_2 < 0.3377866f) {
        let u_16 = ((t_2 - 0.3060009f) / 0.0317857f);
        return (((((((((2f * u_16) * u_16) * u_16) - ((3f * u_16) * u_16)) + 1f) * 1f) + (((((u_16 * u_16) * u_16) - ((2f * u_16) * u_16)) + u_16) * -0.009496559f)) + (((((-2f * u_16) * u_16) * u_16) + ((3f * u_16) * u_16)) * 0.4701471f)) + ((((u_16 * u_16) * u_16) - (u_16 * u_16)) * -0.016321767f));
    }
    if (t_2 < 0.5867438f) {
        let u_17 = ((t_2 - 0.3377866f) / 0.2489572f);
        return (((((((((2f * u_17) * u_17) * u_17) - ((3f * u_17) * u_17)) + 1f) * 0.4701471f) + (((((u_17 * u_17) * u_17) - ((2f * u_17) * u_17)) + u_17) * -0.12783803f)) + (((((-2f * u_17) * u_17) * u_17) + ((3f * u_17) * u_17)) * 0.3489168f)) + ((((u_17 * u_17) * u_17) - (u_17 * u_17)) * -0.09838261f));
    }
    if (t_2 < 0.6278235f) {
        let u_18 = ((t_2 - 0.5867438f) / 0.0410797f);
        return (((((((((2f * u_18) * u_18) * u_18) - ((3f * u_18) * u_18)) + 1f) * 0.3489168f) + (((((u_18 * u_18) * u_18) - ((2f * u_18) * u_18)) + u_18) * -0.016233826f)) + (((((-2f * u_18) * u_18) * u_18) + ((3f * u_18) * u_18)) * 0.5392179f)) + ((((u_18 * u_18) * u_18) - (u_18 * u_18)) * -0.018245516f));
    }
    if (t_2 < 0.6455854f) {
        let u_19 = ((t_2 - 0.6278235f) / 0.0177619f);
        return (((((((((2f * u_19) * u_19) * u_19) - ((3f * u_19) * u_19)) + 1f) * 0.5392179f) + (((((u_19 * u_19) * u_19) - ((2f * u_19) * u_19)) + u_19) * -0.007888934f)) + (((((-2f * u_19) * u_19) * u_19) + ((3f * u_19) * u_19)) * 0.3273815f)) + ((((u_19 * u_19) * u_19) - (u_19 * u_19)) * -0.012016151f));
    }
    if (t_2 < 1f) {
        let u_20 = ((t_2 - 0.6455854f) / 0.3544146f);
        return (((((((((2f * u_20) * u_20) * u_20) - ((3f * u_20) * u_20)) + 1f) * 0.3273815f) + (((((u_20 * u_20) * u_20) - ((2f * u_20) * u_20)) + u_20) * -0.23976597f)) + (((((-2f * u_20) * u_20) * u_20) + ((3f * u_20) * u_20)) * 0f)) + ((((u_20 * u_20) * u_20) - (u_20 * u_20)) * -0.5278821f));
    }
    return 0f;
}
...
fn gradient_3_(t_3: f32) -> vec4<f32> {
    ...
    if (t_3 <= 0.1617609f) {
        ...
        if (t_3 <= 1f) {
            rgb_2 = mix(vec3<f32>(1f, 0f, 0.01978827f), vec3<f32>(0.3962264f, 0.01219158f, 0f), ((t_3 - 0.1617609f) / 0.83823913f));
        }
    }
    if (t_3 <= 0f) {
        alpha_1 = 1f;
...
fn gradient_4_(t_4: f32) -> vec4<f32> {
    ...
    if (t_4 <= 0.2147097f) {
        ...
        if (t_4 <= 0.5000076f) {
            rgb_3 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_4 - 0.2147097f) / 0.28529793f));
        } else {
            if (t_4 <= 0.69411767f) {
                rgb_3 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_4 - 0.5000076f) / 0.19411002f));
            } else {
                if (t_4 <= 0.90293735f) {
                    rgb_3 = mix(vec3<f32>(1f, 1f, 1f), vec3<f32>(1f, 1f, 1f), ((t_4 - 0.69411767f) / 0.20881972f));
                }
            }
        }
    }
    if (t_4 <= 0f) {
        ...
        if (t_4 <= 0.20588998f) {
            alpha_2 = mix(1f, 1f, ((t_4 - 0f) / 0.20588998f));
        } else {
            if (t_4 <= 0.33235675f) {
                alpha_2 = mix(1f, 0f, ((t_4 - 0.20588998f) / 0.12646678f));
            } else {
                if (t_4 <= 0.5029374f) {
                    alpha_2 = mix(0f, 1f, ((t_4 - 0.33235675f) / 0.17058061f));
                } else {
                    if (t_4 <= 0.7000076f) {
                        alpha_2 = mix(1f, 1f, ((t_4 - 0.5029374f) / 0.19707027f));
                    } else {
                        if (t_4 <= 0.802945f) {
                            alpha_2 = mix(1f, 0f, ((t_4 - 0.7000076f) / 0.10293736f));
                        } else {
                            if (t_4 <= 0.90293735f) {
                                alpha_2 = mix(0f, 0.6470588f, ((t_4 - 0.802945f) / 0.09999237f));
                            } else {
                                if (t_4 <= 1f) {
                                    alpha_2 = mix(0.6470588f, 0f, ((t_4 - 0.90293735f) / 0.09706264f));
                                }
                            }
                        }
                    }
...
fn curve_6_(t_6: f32) -> f32 {
    if (t_6 <= 0f) {
        return 0f;
    }
    if (t_6 < 1f) {
        let u_21 = ((t_6 - 0f) / 1f);
        return (((((((((2f * u_21) * u_21) * u_21) - ((3f * u_21) * u_21)) + 1f) * 0f) + (((((u_21 * u_21) * u_21) - ((2f * u_21) * u_21)) + u_21) * 1f)) + (((((-2f * u_21) * u_21) * u_21) + ((3f * u_21) * u_21)) * 1f)) + ((((u_21 * u_21) * u_21) - (u_21 * u_21)) * 1f));
    }
    return 1f;
}

fn dm_appearance(seed_1: u32, id_1: u32, t_7: f32, particle: ptr<function, Particle>) {
    ...
    let _e28 = curve_1_(t_7);
    (*particle).size_rotation.y = max(0f, ((mix(0.3f, 1.4f, _e22) * 1f) * (_e28 * 1f)));
    let _e37 = dm_random(seed_1, id_1, 3u);
    let _e43 = curve_2_(t_7);
    (*particle).size_rotation.w = max(0f, ((mix(0.3f, 1.4f, _e37) * 1f) * (_e43 * 1f)));
    let _e51 = dm_random(seed_1, id_1, 5u);
    let _e52 = gradient_3_(_e51);
    let _e53 = gradient_4_(t_7);
    let _e54 = gradient_5_(t_7);
    let _e56 = dm_random(seed_1, id_1, 7u);
    (*particle).color = (_e52 * mix(_e53, _e54, _e56));
    let _e62 = dm_random(seed_1, id_1, 61u);
    let _e66 = curve_6_(t_7);
    (*particle).velocity.w = floor((fract((mix(0f, 0.9999f, _e62) + ((_e66 * 0.9999f) * 1f))) * 4f));
    return;
}
...
fn dm_streams(uv: vec2<f32>, p_1: Particle, seed_3: u32) -> DmStreams {
    ...
    let _e10 = stream_dm_random(seed_3, id_3, 160u);
    ...
    o_1.uv1_.z = t_10;
    let _e54 = stream_dm_random(seed_3, id_3, 345u);
    o_1.uv1_.w = _e54;
    let _e55 = o_1;
    return _e55;
}
...
fn engravedBaseMaterial(input_4: MaterialInput) -> vec4<f32> {
    ...
    let n2_1 = input_4.uv0_;
    let n3_1 = vec4<f32>(0.1f, 0.1f, 0f, 0f);
    let n4_1 = input_4.time;
...
fn repair_motion(t_8: f32) -> vec3<f32> {
    let a_1 = (t_8 * 0.034906585f);
    return vec3<f32>((6.66f * (1f - cos(a_1))), 0f, (6.66f * sin(a_1)));
}

fn repair_velocity(t_9: f32) -> vec3<f32> {
    let a_2 = (t_9 * 0.034906585f);
...
fn fs_main(i: Varying, @builtin(front_facing) front: bool) -> @location(0) vec4<f32> {
    ...
    let _e96 = rgb.y;
    let _e99 = rgb.z;
    let peak_1 = max(max(_e94, _e96), _e99);
    let eclipse = (mix(vec3<f32>(0.32f, 0.045f, 0.82f), vec3<f32>(0.88f, 0.78f, 1f), smoothstep(0.6f, 4f, peak_1)) * peak_1);
    let _e117 = frame.design.z;
    if (_e117 > 0.5f) {
        let _e120 = rgb;
        let _e124 = frame.design.y;
        let _e125 = enchantmentParticleColor(_e120, _e124);
        rgb = _e125;
    } else {
        let _e126 = rgb;
        let _e130 = frame.design.x;
        rgb = mix(_e126, eclipse, _e130);
    }
    let _e132 = alpha;
    let _e136 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.tint.w;
    alpha = (_e132 * _e136);
    let _e138 = rgb;
    let _e141 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU4DBOJQW2ZLUMVZHGX.tint;
    let _e144 = alpha;
    let _e146 = alpha;
    return vec4<f32>(((_e138 * _e141.xyz) * _e144), _e146);
}
