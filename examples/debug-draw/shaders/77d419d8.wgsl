...
fn evaluate_point_lightX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(light: LightSlotX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX, world_pos: vec3<f32>, N: vec3<f32>, V: vec3<f32>, base_color: vec3<f32>, metallic: f32, roughness_2: f32) -> vec3<f32> {
    ...
    let alpha = (roughness_2 * roughness_2);
    let alpha2_ = (alpha * alpha);
...
fn evaluate_spot_lightX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(light_1: LightSlotX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX, world_pos_1: vec3<f32>, N_1: vec3<f32>, V_1: vec3<f32>, base_color_1: vec3<f32>, metallic_1: f32, roughness_3: f32) -> vec3<f32> {
    ...
    let alpha_1 = (roughness_3 * roughness_3);
    let alpha2_1 = (alpha_1 * alpha_1);
...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e43 = a;
    a = (_e42 * _e43);
    let _e47 = material.normalUvScale;
    let _e50 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e1, _e47);
    let normSampleRg = _e50.xy;
    let _e52 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg);
    let _e55 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e52);
    let _e58 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e58 - in_1.worldPos));
    let f0_1 = mix(vec3(0.04f), albedo, metallic_5);
    let _e70 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e55, v), 0f), f0_1);
    let kD_2 = ((vec3(1f) - _e70) * (1f - metallic_5));
    let _e77 = material.roughness;
    let iblRoughness = (max(_e77, 0.04f) * _e33);
    let _e83 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e55, irradianceMap_1, irradianceSampler_1);
    let _e88 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e55, v, iblRoughness, f0_1, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e91 = material.occlusionUvScale;
    let _e94 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e1, _e91);
    let _e98 = material.occlusionStrength;
    let ao = mix(1f, _e94.x, _e98);
    let _e103 = skylight.colorR;
    let _e106 = skylight.colorG;
    let _e109 = skylight.colorB;
    let skyColor = vec3<f32>(_e103, _e106, _e109);
    let _e117 = skylight.intensity;
    ambient = ((((((kD_2 * _e83) * albedo) + _e88) * skyColor) * _e117) * ao);
    let ssaoUv = ((in_1.ndc.xy * vec2<f32>(0.5f, -0.5f)) + vec2<f32>(0.5f, 0.5f));
    let _e133 = textureSample(ssaoBlurredTexture, ssaoBlurredSampler, ssaoUv);
    let ssaoFactor = _e133.x;
    let _e135 = get_ssao_intensityX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX();
    let _e136 = ambient;
    ambient = (_e136 * mix(1f, (ssaoFactor * ao), _e135));
    let _e141 = ambient;
    color = _e141;
    let _e143 = color;
    let _e144 = a;
    let _e147 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e55, v, albedo, metallic_5, _e144, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e143 + _e147);
    let _e149 = color;
    let _e153 = a;
    let _e154 = evaluate_cluster_lightsX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(in_1.ndc, in_1.viewZ, in_1.worldPos, _e55, v, albedo, metallic_5, _e153);
    color = (_e149 + _e154);
    let _e158 = material.emissiveUvScale;
    let _e161 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e1, _e158);
    let emissiveSample = _e161.xyz;
    let _e163 = color;
    let _e166 = material.emissive;
    let _e169 = material.emissiveIntensity;
    color = (_e163 + ((_e166 * _e169) * emissiveSample));
    let _e173 = color;
    let _e177 = material.baseColor.w;
    return vec4<f32>(_e173, (_e177 * _e7.w));
}
