...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e438 = color;
    color = (_e438 + _e6.emissive);
    let _e441 = physicalNormal;
    let _e443 = standardViewZ(in_2);
    let _e444 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e441, in_2.worldPos, _e443);
    let _e445 = color;
    let _e449 = standardViewZ(in_2);
    let _e450 = physicalNormal;
    let _e451 = diffuseAlbedo;
    let _e452 = f0_;
    let _e453 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e449, _e450, v, _e451, metallic_7, a_3, _e452, _e444);
    color = (_e445 + _e453);
    let _e457 = color;
    output.color = vec4<f32>(_e457, alpha_4);
