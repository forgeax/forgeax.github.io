...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha: f32, alphaCutoff: f32, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_1: vec4<f32>, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, reactive_2: f32, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    let _e29 = packSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(currentClip_1, previousClip_1, reactive_2);
    return _e29;
}
...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e55 = material.metallicChannel;
    let _e57 = pick_channel(_e49, u32(_e55));
    let metallic_5 = (_e52 * _e57);
    let _e61 = material.roughnessChannel;
    let _e63 = pick_channel(_e49, u32(_e61));
    let _e66 = material.roughness;
    a = max(_e66, 0.04f);
    let _e70 = a;
    a = (_e70 * _e63);
    let _e72 = a;
    let _e73 = a;
    a = (_e72 * _e73);
    let _e77 = material.normalTextureCoordinatesTransform;
    let _e80 = material.normalTextureCoordinatesMetadata;
    let _e81 = transformedMaterialUv(_e77, _e80, in_1);
    let _e84 = material.normalTextureCoordinatesMetadata;
    let _e88 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e81, _e84.zw);
    let normSampleRg = _e88.xy;
    let _e90 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg);
    let _e93 = material.normalScale;
    let _e94 = scaleTangentSpaceNormalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(_e90, _e93);
    let _e97 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e94);
    let _e100 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e100 - in_1.worldPos));
    let _e106 = material.specularTintTextureCoordinatesTransform;
    let _e109 = material.specularTintTextureCoordinatesMetadata;
    let _e110 = transformedMaterialUv(_e106, _e109, in_1);
    let _e113 = material.specularTint;
    let _e116 = material.specularTintTextureCoordinatesMetadata;
    let _e120 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e110, _e116.zw);
    let specularTint = (_e113 * _e120.xyz);
    let f0_1 = mix((vec3(0.04f) * specularTint), albedo, metallic_5);
    let _e129 = material.clearcoatRoughness;
    let coatRoughness = max(_e129, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e138 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e97, v), 0f), vec3(0.04f));
    let _e141 = material.clearcoat;
    let coatF = (_e138 * _e141);
    let _e148 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e97, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e148) * (1f - metallic_5));
    let _e155 = material.roughness;
    let iblRoughness = (max(_e155, 0.04f) * _e63);
    let _e161 = skylight.rotation;
    let _e164 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e97, _e161, irradianceMap_1, irradianceSampler_1);
    let _e167 = skylight.rotation;
    let _e172 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e97, v, iblRoughness, f0_1, _e167, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e175 = material.occlusionTextureCoordinatesTransform;
    let _e178 = material.occlusionTextureCoordinatesMetadata;
    let _e179 = transformedMaterialUv(_e175, _e178, in_1);
    let _e182 = material.occlusionTextureCoordinatesMetadata;
    let _e186 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e179, _e182.zw);
    let _e190 = material.occlusionStrength;
    let ao = mix(1f, _e186.x, _e190);
    let _e195 = skylight.colorR;
    let _e198 = skylight.colorG;
    let _e201 = skylight.colorB;
    let skyColor = vec3<f32>(_e195, _e198, _e201);
    ambient = ((((kD * _e164) * albedo) + _e172) * (vec3(1f) - coatF));
    let _e213 = material.clearcoat;
    if (_e213 != 0f) {
        let _e220 = skylight.rotation;
        let _e225 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e97, v, coatRoughness, vec3(0.04f), _e220, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
        let _e226 = ambient;
        let _e229 = material.clearcoat;
        ambient = (_e226 + (_e225 * _e229));
    }
    let _e232 = ambient;
    let _e236 = skylight.intensity;
    ambient = (((_e232 * skyColor) * _e236) * ao);
    let _e239 = ambient;
    color = _e239;
    let _e243 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e97, in_1.worldPos, in_1.viewZ);
    let _e244 = a;
    let _e245 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e97, v, albedo, metallic_5, _e244, f0_1);
    let _e246 = color;
    color = (_e246 + (_e243 * _e245));
    let _e251 = material.clearcoat;
    if (_e251 != 0f) {
        let _e259 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e97, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
        let _e260 = color;
        let _e263 = material.clearcoat;
        color = (_e260 + ((_e243 * _e263) * _e259));
    }
    ...
    loop {
        ...
        {
            let _e275 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e275];
            let _e278 = color;
            let _e283 = a;
            let _e284 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e97, v, albedo, metallic_5, _e283, f0_1);
            color = (_e278 + _e284);
            let _e288 = material.clearcoat;
            if (_e288 != 0f) {
                let _e291 = color;
                let _e294 = material.clearcoat;
                let _e304 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e97, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                color = (_e291 + (_e294 * _e304));
            }
        }
        continuing {
            let _e307 = i;
    ...
    loop {
        ...
        {
            let _e318 = i_1;
            let s_2 = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e318];
            if (s_2.shadowAtlasTile >= 0i) {
                let _e324 = color;
                let _e332 = a;
                let _e337 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_2.shadowAtlasTile];
                let _e341 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_2.position, s_2.direction, s_2.colorTimesIntensity, s_2.cosInner, s_2.cosOuter, s_2.invRangeSquared, in_1.worldPos, _e97, v, albedo, metallic_5, _e332, f0_1, _e337, s_2.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e324 + _e341);
                let _e345 = material.clearcoat;
                if (_e345 != 0f) {
                    let _e348 = color;
                    let _e351 = material.clearcoat;
                    let _e367 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_2.shadowAtlasTile];
                    let _e372 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_2.position, s_2.direction, s_2.colorTimesIntensity, s_2.cosInner, s_2.cosOuter, s_2.invRangeSquared, in_1.worldPos, _e97, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), _e367, s_2.shadowAtlasTile, 0.005f, 0.05f);
                    color = (_e348 + (_e351 * _e372));
                }
            } else {
                let _e375 = color;
                let _e383 = a;
                let _e384 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_2.position, s_2.direction, s_2.colorTimesIntensity, s_2.cosInner, s_2.cosOuter, s_2.invRangeSquared, in_1.worldPos, _e97, v, albedo, metallic_5, _e383, f0_1);
                color = (_e375 + _e384);
                let _e388 = material.clearcoat;
                if (_e388 != 0f) {
                    let _e391 = color;
                    let _e394 = material.clearcoat;
                    let _e407 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_2.position, s_2.direction, s_2.colorTimesIntensity, s_2.cosInner, s_2.cosOuter, s_2.invRangeSquared, in_1.worldPos, _e97, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                    color = (_e391 + (_e394 * _e407));
                }
            }
        }
        continuing {
    ...
    let _e415 = material.emissiveTextureCoordinatesTransform;
    let _e418 = material.emissiveTextureCoordinatesMetadata;
    let _e419 = transformedMaterialUv(_e415, _e418, in_1);
    let _e422 = material.emissiveTextureCoordinatesMetadata;
    let _e426 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e419, _e422.zw);
    let emissiveSample = _e426.xyz;
    let _e428 = color;
    let _e431 = material.emissive;
    let _e434 = material.emissiveIntensity;
    color = (_e428 + ((_e431 * _e434) * emissiveSample));
    let _e439 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX;
    let _e440 = color;
    let _e442 = applySceneFog(_e439, _e440, alpha_3, in_1.worldPos);
    return _e442;
}
...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e25 = reactive;
    let _e36 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e10 * _e12), _e16, baseColorTexture_1, baseColorSampler_1, _e19, _e22, in_4.currentClip, in_4.previousClip, _e25, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return _e36;
}
