...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let metallic_14 = clamp(_e13, 0f, 1f);
    ...
    let _e54 = f0_;
    let _e55 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e50, v_5), 0f), _e54);
    let kD_1 = ((vec3(1f) - _e55) * (1f - metallic_14));
    ...
    if (_e67 < 0f) {
        ...
        let _e96 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e70, v_5, iblRoughness, _e71, in_2.worldPos, vec3<f32>(_e75, _e78, _e81), _e85.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e96;
    } else {
        ...
        let _e115 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e106, v_5, iblRoughness, _e107, _e110, prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e115;
    }
    ...
    let _e198 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e194, (_e195 * skyFactor), probeDiffuseK, _e197, metallic_14);
    ...
    let _e245 = f0_;
    let _e246 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e243, v_5, _e244, metallic_14, a_4, _e245);
    let _e247 = color;
    ...
    let _e257 = f0_;
    let _e260 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e253, in_2.worldPos, _e255, v_5, _e256, metallic_14, a_4, _e257, false, true);
    color = (_e250 + _e260);
    let _e262 = color;
