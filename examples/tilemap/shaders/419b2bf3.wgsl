...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e43 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.x;
    reactive = _e43;
    let _e49 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.y;
    motionValid = (_e49 >= 0.5f);
    let _e57 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e58 = reactive;
    let _e59 = motionValid;
    let _e60 = packSceneTemporalV1WithValidityX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(in_5.currentClip, in_5.previousClip, _e57, _e58, _e59);
    return _e60;
}
