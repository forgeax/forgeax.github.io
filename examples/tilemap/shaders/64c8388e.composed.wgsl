...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_16: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    ...
    let slope = ((abs(dot(normal_16, right_1)) + abs(dot(normal_16, up_1))) / nDotL_6);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_5: u32, count_4: u32, normal_17: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_24: bool;
    var local_25: bool;
    var local_26: bool;
    var local_27: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_6: u32, count_5: u32, normal_18: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_36: bool;
    var local_37: bool;
    var local_38: bool;
    var local_39: bool;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, layer_6, count_5, normal_18, l_2, filterProfile);
        return _e90;
    }
    ...
    if (kernel == 3u) {
        if all((uv_4 >= (tileLo + texel_5))) {
            local_40 = all((uv_4 <= (tileHi - texel_5)));
        } else {
            local_40 = false;
        }
...
fn resolveStandardDeferred(in_2: FullscreenOutputX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX) -> DeferredOutput {
    ...
    if (probeRow > 0u) {
        local_42 = ((base_1 + 9u) < arrayLength((&probeBlendRecords)));
    } else {
        local_42 = false;
    }
    let _e82 = local_42;
