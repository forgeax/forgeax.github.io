...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e368 = standardViewZ(in_1);
    let _e369 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e366, in_1.worldPos, _e368);
    let _e370 = color;
    let _e374 = standardViewZ(in_1);
    let _e375 = physicalNormal;
    let _e376 = diffuseAlbedo;
    let _e377 = f0_;
    let _e378 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e374, _e375, v, _e376, metallic_7, a_3, _e377, _e369);
    color = (_e370 + _e378);
    let _e382 = color;
    output.color = vec4<f32>(_e382, alpha_4);
