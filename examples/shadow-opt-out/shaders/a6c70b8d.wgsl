...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let albedo = _e8.baseColor;
    let _e13 = finiteScalar(_e8.metallic, 0f);
    let metallic_11 = clamp(_e13, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e54) * _e56), albedo, metallic_11);
    physicalNormal = n_5;
    ...
    let kD = ((vec3(1f) - _e69) * (1f - metallic_11));
    ...
    let environmentScale = (_e148 * ao);
    let _e163 = ambient;
    ambient = (_e163 * environmentScale);
    let _e165 = ambient;
    color = _e165;
    let _e167 = color;
    color = (_e167 + _e8.emissive);
    let _e170 = physicalNormal;
    let _e172 = standardViewZ(in_2);
    let _e173 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e170, in_2.worldPos, _e172);
    let _e174 = physicalNormal;
    let _e175 = diffuseAlbedo;
    let _e176 = f0_;
    let _e177 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e174, v_5, _e175, metallic_11, a_3, _e176);
    let _e178 = color;
    color = (_e178 + (_e173 * _e177));
    let _e181 = color;
    let _e184 = standardViewZ(in_2);
    let _e186 = physicalNormal;
    let _e187 = diffuseAlbedo;
    let _e188 = f0_;
    let _e191 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e184, in_2.worldPos, _e186, v_5, _e187, metallic_11, a_3, _e188, false, true);
    color = (_e181 + _e191);
    let _e193 = color;
    return vec4<f32>(_e193, alpha);
}
