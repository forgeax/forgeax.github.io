...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e303 = textureSampleLevel(transmissionBackdropTexture, prefilterSampler_2, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e311 = local_1;
    if _e311 {
        let _e319 = textureSampleLevel(transmissionBackdropTexture, prefilterSampler_2, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e363 = physicalNormal;
    let _e365 = standardViewZ(in_2);
    let _e366 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e363, in_2.worldPos, _e365);
    let _e367 = color;
    let _e371 = standardViewZ(in_2);
    let _e372 = physicalNormal;
    let _e373 = diffuseAlbedo;
    let _e374 = f0_;
    let _e375 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e371, _e372, v, _e373, metallic_7, a_4, _e374, _e366);
    color = (_e367 + _e375);
    let _e377 = color;
    color = (_e377 + _e6.emissive);
    let _e382 = color;
    output.color = vec4<f32>(_e382, alpha_5);
    let _e385 = reflectionFallback;
    let _e386 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e385, _e386);
    let _e388 = output;
    return _e388;
}
