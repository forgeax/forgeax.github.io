...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let kD = ((vec3(1f) - _e71) * (1f - metallic_6));
    ...
    let _e92 = material.occlusionUvScale;
    let _e95 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e2, _e92);
    let _e99 = material.occlusionStrength;
    let ao = mix(1f, _e95.x, _e99);
    let _e104 = skylight.colorR;
    let _e107 = skylight.colorG;
    let _e110 = skylight.colorB;
    let skyColor = vec3<f32>(_e104, _e107, _e110);
    let _e118 = skylight.intensity;
    ambient = ((((((kD * _e84) * albedo) + _e89) * skyColor) * _e118) * ao);
    let _e122 = ambient;
    color = _e122;
    let _e124 = color;
    let _e125 = a;
    let _e128 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e56, v, albedo, metallic_6, _e125, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e124 + _e128);
    ...
    loop {
        ...
        {
            let _e138 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e138];
            let _e141 = color;
            let _e146 = a;
            let _e147 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_6, _e146, f0_1);
            color = (_e141 + _e147);
        }
        continuing {
            let _e149 = i;
    ...
    loop {
        ...
        {
            let _e160 = i_1;
            let s = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e160];
            if (s.shadowAtlasTile >= 0i) {
                let _e166 = color;
                let _e174 = a;
                let _e179 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s.shadowAtlasTile];
                let _e183 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_6, _e174, f0_1, _e179, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e166 + _e183);
            } else {
                let _e185 = color;
                let _e193 = a;
                let _e194 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_6, _e193, f0_1);
                color = (_e185 + _e194);
            }
        }
        continuing {
    ...
    let _e201 = material.emissiveUvScale;
    let _e204 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e2, _e201);
    let emissiveSample = _e204.xyz;
    let _e206 = color;
    let _e209 = material.emissive;
    let _e212 = material.emissiveIntensity;
    color = (_e206 + ((_e209 * _e212) * emissiveSample));
    let _e216 = color;
    let _e220 = material.baseColor.w;
    return vec4<f32>(_e216, (_e220 * _e8.w));
}
...
fn fs_gbuffer(in_2: VsOut) -> GBufferOutput {
    ...
    let _e10 = material.baseColor;
    let albedo_1 = (_e10.xyz * _e7.xyz);
    let _e16 = material.metallicRoughnessUvScale;
    let _e19 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(metallicRoughnessTexture, metallicRoughnessSampler, _e1, _e16);
    let _e22 = material.metallic;
    let _e25 = material.metallicChannel;
    let _e27 = pick_channel(_e19, u32(_e25));
    let metallic_7 = (_e22 * _e27);
    let _e31 = material.roughnessChannel;
    let _e33 = pick_channel(_e19, u32(_e31));
    let _e36 = material.roughness;
    a_1 = max(_e36, 0.04f);
    let _e40 = a_1;
    a_1 = (_e40 * _e33);
    let _e44 = material.normalUvScale;
    let _e47 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e1, _e44);
    let normSampleRg_1 = _e47.xy;
    let _e49 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg_1);
    let _e52 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_2.worldNormal, in_2.worldTangent, _e49);
    let _e55 = material.emissiveUvScale;
    let _e58 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e1, _e55);
    let emissiveSample_1 = _e58.xyz;
    let _e62 = material.emissive;
    let _e65 = material.emissiveIntensity;
    let emissive = ((_e62 * _e65) * emissiveSample_1);
    let _e70 = material.occlusionUvScale;
    let _e73 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e1, _e70);
    let _e77 = material.occlusionStrength;
    let ao_1 = mix(1f, _e73.x, _e77);
    let _e87 = a_1;
    out_1.normal_roughness = vec4<f32>(((_e52 * 0.5f) + vec3(0.5f)), _e87);
