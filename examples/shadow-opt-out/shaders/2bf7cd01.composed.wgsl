...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e180 = f0_;
    let _e181 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e178, v_2, _e179, metallic_10, a_2, _e180);
    let _e182 = color;
    ...
    let _e192 = f0_;
    let _e195 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e188, in_1.worldPos, _e190, v_2, _e191, metallic_10, a_2, _e192, false, true);
    color = (_e185 + _e195);
    let _e197 = color;
