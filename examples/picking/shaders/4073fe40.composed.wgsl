...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e205 = f0_;
    let _e208 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e201, in_1.worldPos, _e203, v_5, _e204, metallic_14, a_4, _e205, false, true);
    color = (_e198 + _e208);
    let _e210 = color;
