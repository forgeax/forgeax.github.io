...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_3: vec3<f32>, lightDir_1: vec3<f32>, colorTimesIntensity_3: vec3<f32>, cosInner_1: f32, cosOuter_1: f32, invRangeSquared_3: f32, worldPos_5: vec3<f32>, normal_8: vec3<f32>, viewDir_5: vec3<f32>, baseColor_5: vec3<f32>, metallic_5: f32, alphaSq_5: f32, F0_7: vec3<f32>, lightViewProj: mat4x4<f32>, shadowAtlasTile: i32, depthBias_1: f32, normalBias_1: f32) -> vec3<f32> {
    var local_6: bool;
    var local_7: bool;
    var local_8: bool;
    var local_9: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_3, lightDir_1, colorTimesIntensity_3, cosInner_1, cosOuter_1, invRangeSquared_3, worldPos_5, normal_8, viewDir_5, baseColor_5, metallic_5, alphaSq_5, F0_7);
    ...
    let nDotL_4 = max(dot(normal_8, normalize((lightPos_3 - worldPos_5))), 0f);
...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e79 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e76);
    let _e82 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e82 - in_1.worldPos));
    let _e88 = material.specularTintCoordinates;
    let _e89 = transformedMaterialUv(_e88, in_1);
    let _e92 = material.specularTint;
    let _e96 = material.specularTintCoordinates.metadata;
    let _e100 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e89, _e96.zw);
    let specularTint = (_e92 * _e100.xyz);
    let f0_1 = mix((vec3(0.04f) * specularTint), albedo, metallic_6);
    let _e109 = material.clearcoatRoughness;
    let coatRoughness = max(_e109, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e118 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e79, v), 0f), vec3(0.04f));
    let _e121 = material.clearcoat;
    let coatF = (_e118 * _e121);
    let _e128 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e79, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e128) * (1f - metallic_6));
    let _e135 = material.roughness;
    let iblRoughness = (max(_e135, 0.04f) * _e51);
    let _e141 = skylight.rotation;
    let _e144 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e79, _e141, irradianceMap_1, irradianceSampler_1);
    let _e147 = skylight.rotation;
    let _e152 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e79, v, iblRoughness, f0_1, _e147, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e157 = skylight.rotation;
    let _e162 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e79, v, coatRoughness, vec3(0.04f), _e157, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e165 = material.occlusionCoordinates;
    let _e166 = transformedMaterialUv(_e165, in_1);
    let _e170 = material.occlusionCoordinates.metadata;
    let _e174 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e166, _e170.zw);
    let _e178 = material.occlusionStrength;
    let ao = mix(1f, _e174.x, _e178);
    let _e183 = skylight.colorR;
    let _e186 = skylight.colorG;
    let _e189 = skylight.colorB;
    let skyColor = vec3<f32>(_e183, _e186, _e189);
    let _e200 = material.clearcoat;
    let _e206 = skylight.intensity;
    ambient = ((((((((kD * _e144) * albedo) + _e152) * (vec3(1f) - coatF)) + (_e162 * _e200)) * skyColor) * _e206) * ao);
    let _e210 = ambient;
    color = _e210;
    let _e212 = color;
    let _e213 = a;
    let _e216 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e79, v, albedo, metallic_6, _e213, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e212 + _e216);
    let _e218 = color;
    let _e221 = material.clearcoat;
    let _e229 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e79, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e218 + (_e221 * _e229));
    ...
    loop {
        ...
        {
            let _e240 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e240];
            let _e243 = color;
            let _e248 = a;
            let _e249 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e79, v, albedo, metallic_6, _e248, f0_1);
            color = (_e243 + _e249);
            let _e251 = color;
            let _e254 = material.clearcoat;
            let _e264 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e79, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e251 + (_e254 * _e264));
        }
        continuing {
            let _e267 = i;
            i = (_e267 + 1u);
    ...
    loop {
        ...
        {
            let _e278 = i_1;
            let s_1 = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e278];
            if (s_1.shadowAtlasTile >= 0i) {
                let _e284 = color;
                let _e292 = a;
                let _e297 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_1.shadowAtlasTile];
                let _e301 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e79, v, albedo, metallic_6, _e292, f0_1, _e297, s_1.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e284 + _e301);
                let _e303 = color;
                let _e306 = material.clearcoat;
                let _e322 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_1.shadowAtlasTile];
                let _e327 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e79, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), _e322, s_1.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e303 + (_e306 * _e327));
            } else {
                let _e330 = color;
                let _e338 = a;
                let _e339 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e79, v, albedo, metallic_6, _e338, f0_1);
                color = (_e330 + _e339);
                let _e341 = color;
                let _e344 = material.clearcoat;
                let _e357 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e79, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                color = (_e341 + (_e344 * _e357));
            }
        }
        continuing {
            let _e360 = i_1;
    ...
    let _e365 = material.emissiveCoordinates;
    let _e366 = transformedMaterialUv(_e365, in_1);
    let _e370 = material.emissiveCoordinates.metadata;
    let _e374 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e366, _e370.zw);
    let emissiveSample = _e374.xyz;
    let _e376 = color;
    let _e379 = material.emissive;
    let _e382 = material.emissiveIntensity;
    color = (_e376 + ((_e379 * _e382) * emissiveSample));
    let _e386 = color;
    let _e390 = material.baseColor.w;
    return vec4<f32>(_e386, (_e390 * _e13.w));
}
...
fn fs_gbuffer(in_2: VsOut) -> GBufferOutput {
    ...
    let _e21 = material.baseColor;
    let albedo_1 = (_e21.xyz * _e12.xyz);
    let _e27 = material.metallicRoughnessCoordinates;
    let _e28 = transformedMaterialUv(_e27, in_2);
    let _e32 = material.metallicRoughnessCoordinates.metadata;
    let _e36 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(metallicRoughnessTexture, metallicRoughnessSampler, _e28, _e32.zw);
    let _e39 = material.metallic;
    let _e42 = material.metallicChannel;
    let _e44 = pick_channel(_e36, u32(_e42));
    let metallic_7 = (_e39 * _e44);
    let _e48 = material.roughnessChannel;
    let _e50 = pick_channel(_e36, u32(_e48));
    let _e53 = material.roughness;
    a_1 = max(_e53, 0.04f);
    let _e57 = a_1;
    a_1 = (_e57 * _e50);
    let _e61 = material.normalCoordinates;
    let _e62 = transformedMaterialUv(_e61, in_2);
    let _e66 = material.normalCoordinates.metadata;
    let _e70 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e62, _e66.zw);
    let normSampleRg_1 = _e70.xy;
    let _e72 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg_1);
    let _e75 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_2.worldNormal, in_2.worldTangent, _e72);
    let _e78 = material.emissiveCoordinates;
    let _e79 = transformedMaterialUv(_e78, in_2);
    let _e83 = material.emissiveCoordinates.metadata;
    let _e87 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e79, _e83.zw);
    let emissiveSample_1 = _e87.xyz;
    let _e91 = material.emissive;
    let _e94 = material.emissiveIntensity;
    let emissive = ((_e91 * _e94) * emissiveSample_1);
    let _e99 = material.occlusionCoordinates;
    let _e100 = transformedMaterialUv(_e99, in_2);
    let _e104 = material.occlusionCoordinates.metadata;
    let _e108 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e100, _e104.zw);
    let _e112 = material.occlusionStrength;
    let ao_1 = mix(1f, _e108.x, _e112);
    let _e122 = a_1;
    out_1.normal_roughness = vec4<f32>(((_e75 * 0.5f) + vec3(0.5f)), _e122);
