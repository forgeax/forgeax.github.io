...
fn evaluateProbeDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX(shPreblend_1: array<vec4<f32>, 9>, localBlendFraction: f32, normal_1: vec3<f32>, e_sky: vec3<f32>, k_d: vec3<f32>, albedo: vec3<f32>, metallic: f32) -> vec3<f32> {
    ...
    let local_43 = (max(_e2, vec3(0f)) * PROBE_INV_PIX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX);
    let skyResidualFraction = (1f - localBlendFraction);
    return ((((local_43 + (skyResidualFraction * e_sky)) * k_d) * albedo) * (1f - metallic));
}
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_13: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    ...
    let slope = ((abs(dot(normal_13, right_1)) + abs(dot(normal_13, up_1))) / nDotL_6);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_14: vec3<f32>, layer_5: u32, count_4: u32, normal_14: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_16: bool;
    var local_17: bool;
    var local_18: bool;
    var local_19: bool;
    ...
    let _e60 = local_19;
    if _e60 {
        local_20 = (projCoords.z >= 0f);
    } else {
        local_20 = false;
    }
    let _e67 = local_20;
    if _e67 {
        local_21 = (projCoords.z <= 1f);
    } else {
        local_21 = false;
    }
    let _e74 = local_21;
    ...
    if (lightDepthWorldSpan > 0f) {
        local_25 = (worldUnitsPerTexel > 0f);
    } else {
        local_25 = false;
    }
    let _e213 = local_25;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_6: u32, count_5: u32, normal_15: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_28: bool;
    var local_29: bool;
    var local_30: bool;
    var local_31: bool;
    ...
    if (tileUv_1.x >= 0f) {
        local_28 = (tileUv_1.x <= 1f);
    } else {
        local_28 = false;
    }
    let _e40 = local_28;
    if _e40 {
        local_29 = (tileUv_1.y >= 0f);
    } else {
        local_29 = false;
    }
    let _e47 = local_29;
    if _e47 {
        local_30 = (tileUv_1.y <= 1f);
    } else {
        local_30 = false;
    }
    let _e54 = local_30;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15, layer_6, count_5, normal_15, l_2, filterProfile);
        return _e90;
    }
    ...
    if (kernel == 3u) {
        if all((uv_6 >= (tileLo + texel_5))) {
            local_32 = all((uv_6 <= (tileHi - texel_5)));
        } else {
            local_32 = false;
        }
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_34 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_34 = false;
    }
    let _e10 = local_34;
    if _e10 {
        local_35 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_35 = false;
    }
    let _e17 = local_35;
    if _e17 {
        local_36 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_36 = false;
    }
    let validReceiver = local_36;
    ...
    if all((uv_7 >= vec2(0f))) {
        local_37 = all((uv_7 <= vec2(1f)));
    } else {
        local_37 = false;
    }
    let inRange = local_37;
    if (shadowProjection.y > 0.5f) {
        local_38 = (shadowProjection.z < 0.5f);
    } else {
        local_38 = false;
    }
    let _e64 = local_38;
    if _e64 {
        local_39 = (shadowProjection.x > 0f);
    } else {
        local_39 = false;
    }
    let available = local_39;
...
fn evaluateStandardSurfaceX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX(in_2: VsOutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, factors: StandardSurfaceFactorsX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX) -> StandardPbrOutputX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX {
    ...
    let _e425 = a_2;
    let _e426 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, v_5, _e424, metallic_11, _e425, f0_3);
    let _e427 = color;
    ...
    let _e484 = a_2;
    let _e487 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, in_2.viewZ, in_2.worldPos, _e108, v_5, _e483, metallic_11, _e484, f0_3, false, factors.receiveShadows);
    color = (_e478 + _e487);
    if (factors.clearcoat != 0f) {
        let _e492 = color;
