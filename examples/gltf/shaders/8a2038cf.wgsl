...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_5: vec3<f32>, normal_10: vec3<f32>, viewDir_1: vec3<f32>, baseColor_1: vec3<f32>, metallic_2: f32, alphaSq_1: f32, F0_6: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_6 = max(dot(normal_10, l_4), 0f);
    let nDotV_3 = max(dot(normal_10, viewDir_1), 0.00001f);
    let nDotH_2 = max(dot(normal_10, h_1), 0f);
...
fn evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2: vec3<f32>, colorTimesIntensity_1: vec3<f32>, invRangeSquared_3: f32, worldPos_6: vec3<f32>, normal_11: vec3<f32>, viewDir_2: vec3<f32>, baseColor_2: vec3<f32>, metallic_3: f32, alphaSq_2: f32, F0_7: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2, colorTimesIntensity_1, invRangeSquared_3, worldPos_6, normal_11, viewDir_2, baseColor_2, metallic_3, alphaSq_2, F0_7);
    return _e10;
}
...
fn evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, lightDir_2: vec3<f32>, colorTimesIntensity_4: vec3<f32>, cosInner_2: f32, cosOuter_2: f32, invRangeSquared_7: f32, worldPos_9: vec3<f32>, normal_12: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_4: f32, alphaSq_3: f32, F0_8: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5, colorTimesIntensity_4, invRangeSquared_7, worldPos_9, normal_12, viewDir_3, baseColor_5, metallic_4, alphaSq_3, F0_8);
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_8: f32, worldPos_10: vec3<f32>, normal_13: vec3<f32>, viewDir_4: vec3<f32>, baseColor_6: vec3<f32>, metallic_5: f32, alphaSq_4: f32, F0_9: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_2: f32, normalBias_2: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    var local_22: bool;
    var local_23: bool;
    var local_24: bool;
    var local_25: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6, lightDir_3, colorTimesIntensity_5, cosInner_3, cosOuter_3, invRangeSquared_8, worldPos_10, normal_13, viewDir_4, baseColor_6, metallic_5, alphaSq_4, F0_9);
    ...
    let nDotL_7 = max(dot(normal_13, normalize((lightPos_6 - worldPos_10))), 0f);
...
fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_11: f32, worldPos_15: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_8: vec3<f32>, metallic_7: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_11, worldPos_15, n_3, v_3, baseColor_8, metallic_7, alphaSq_6, F0_11);
...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12: vec3<f32>, lightColor_2: vec3<f32>, axisX_3: vec3<f32>, axisY_3: vec3<f32>, halfWidth_3: f32, halfHeight_3: f32, invRangeSquared_12: f32, worldPos_16: vec3<f32>, n_4: vec3<f32>, v_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_8: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, lightColor_2, axisX_3, axisY_3, halfWidth_3, halfHeight_3, invRangeSquared_12, worldPos_16, n_4, v_4, baseColor_9, metallic_8, alphaSq_7, F0_12);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos: vec3<f32>, normal_14: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_9: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos, normal_14, view_dir, base_color, metallic_9, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_14, view_dir, base_color, metallic_9, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            return (_e110 * modifier);
        }
        let _e124 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_14, view_dir, base_color, metallic_9, alpha_sq, f0_2);
        return (_e124 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e142 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_14, view_dir, base_color, metallic_9, alpha_sq, f0_2);
        return _e142;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_1: vec3<f32>, normal_15: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_10: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_1, normal_15, view_dir_1, base_color_1, metallic_10, alpha_sq_1, f0_3, flat_2d_1, receive_shadows_1);
...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha_1: f32, alphaCutoff: f32, baseColorTextureEnabled: bool, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_2: vec4<f32>, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, temporalProjection_3: vec4<f32>, reactive_2: f32, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    if (alphaCutoff > 0f) {
        ...
        local_33 = ((baseColorAlpha_1 * _e24) <= alphaCutoff);
    } else {
        local_33 = false;
    }
    let _e30 = local_33;
...
fn evaluate_standard_surface(input_2: SurfaceInput, materialValue: MaterialParameters) -> SurfaceData {
    ...
    normal_17 = normalize(input_2.geometricNormalWS);
...
fn evaluateStandardSurface(in_10: VsOut, frontFacing_2: bool) -> SurfaceData {
    ...
    let _e21 = materialVertexColor(in_10);
    let input_4 = SurfaceInput(positionOS, in_10.worldPos, in_10.worldNormal, in_10.worldTangent, viewDirectionWS, in_10.uv, in_10.uv1_, in_10.uv2_, in_10.uv3_, in_10.uv4_, in_10.uv5_, in_10.uv6And7_.xy, in_10.uv6And7_.zw, _e21, frontFacing_2);
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e4 = standardSkinVariantIdentity();
    let _e7 = evaluateStandardSurface(in_2, frontFacing);
    alphaTestSurface(_e7);
    let alpha = _e7.opacity;
    let albedo_2 = _e7.baseColor;
    let _e12 = finiteScalar(_e7.metallic, 0f);
    let metallic_13 = clamp(_e12, 0f, 1f);
    ...
    let v_5 = normalize((_e27 - in_2.worldPos));
    let _e33 = material.specularColor;
    specularColor = _e33;
    let _e37 = material.specular;
    let _e39 = finiteScalar(_e37, 1f);
    specularWeight = clamp(_e39, 0f, 1f);
    let _e46 = material.ior;
    let _e48 = finiteScalar(_e46, 1.5f);
    let safeIor = max(_e48, 1f);
    let dielectricF0_ = pow(((safeIor - 1f) / (safeIor + 1f)), 2f);
    let _e59 = specularColor;
    let _e61 = specularWeight;
    f0_ = mix(((vec3(dielectricF0_) * _e59) * _e61), albedo_2, metallic_13);
    physicalNormal = n_5;
    diffuseAlbedo = albedo_2;
    let _e67 = standardUsesTransmissionTexture();
    if _e67 {
        let _e70 = material.transmissionTextureCoordinatesTransform;
        let _e73 = material.transmissionTextureCoordinatesMetadata;
        let _e74 = transformedMaterialUv(_e70, _e73, in_2);
        let _e77 = material.transmissionTextureCoordinatesMetadata;
        let _e81 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(transmissionTexture, transmissionSampler, _e74, _e77.zw);
        transmissionSample = _e81.x;
    }
    let _e84 = standardUsesThicknessTexture();
    if _e84 {
        let _e87 = material.thicknessTextureCoordinatesTransform;
        let _e90 = material.thicknessTextureCoordinatesMetadata;
        let _e91 = transformedMaterialUv(_e87, _e90, in_2);
        let _e94 = material.thicknessTextureCoordinatesMetadata;
        let _e98 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(thicknessTexture, thicknessSampler, _e91, _e94.zw);
        thicknessSample = _e98.y;
    }
    let _e103 = material.transmission;
    let _e105 = finiteScalar(_e103, 0f);
    let _e106 = transmissionSample;
    let _e108 = finiteScalar(_e106, 1f);
    let transmissionFactor = clamp((_e105 * _e108), 0f, 1f);
    let _e115 = finiteScalar(dot(n_5, v_5), 0f);
    let refractionFromInside = (_e115 < 0f);
    ...
    let viewCos = clamp(abs(_e115), 0f, 1f);
    let _e131 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(viewCos, vec3(dielectricF0_));
    let fresnel_2 = clamp(_e131.x, 0f, 1f);
    ...
    let _e151 = physicalNormal;
    let _e155 = f0_;
    let _e156 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e151, v_5), 0f), _e155);
    let kD_1 = ((vec3(1f) - _e156) * (1f - metallic_13));
    let _e162 = coatRoughness;
    let _e163 = coatRoughness;
    coatAlpha = (_e162 * _e163);
    let _e168 = skylight.intensity;
    if (_e168 < 0f) {
        let _e171 = physicalNormal;
        let _e172 = f0_;
        let _e176 = skylight.colorR;
        let _e179 = skylight.colorG;
        let _e182 = skylight.colorB;
        let _e186 = skylight.rotation;
        let _e197 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e171, v_5, iblRoughness, _e172, in_2.worldPos, vec3<f32>(_e176, _e179, _e182), _e186.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e197;
    } else {
        let _e199 = physicalNormal;
        let _e202 = skylight.rotation;
        let _e205 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e199, _e202, irradianceMap_1, irradianceSampler_1);
        irradiance = _e205;
        let _e207 = physicalNormal;
        let _e208 = f0_;
        let _e211 = skylight.rotation;
        let _e216 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e207, v_5, iblRoughness, _e208, _e211, prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e216;
    }
    let ao = _e7.occlusion;
    let _e220 = skylight.colorR;
    let _e223 = skylight.colorG;
    let _e226 = skylight.colorB;
    let skyColor_1 = vec3<f32>(_e220, _e223, _e226);
    let _e230 = skylight.intensity;
    let skyFactor = (skyColor_1 * _e230);
    let _e234 = skylight.intensity;
    let _e235 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(skyColor_1, _e234);
    let _e236 = irradiance;
    let _e238 = diffuseAlbedo;
    let _e240 = specularIbl;
    let _e245 = coatF;
    ambient = ((((kD_1 * _e236) * _e238) + _e240) * (vec3(1f) - _e245));
    let _e251 = probeBlendRecords[1];
    let _e254 = probeBlendRecords[2];
    let _e257 = probeBlendRecords[3];
    let _e260 = probeBlendRecords[4];
    let _e263 = probeBlendRecords[5];
    let _e266 = probeBlendRecords[6];
    let _e269 = probeBlendRecords[7];
    let _e272 = probeBlendRecords[8];
    let _e275 = probeBlendRecords[9];
    let probeShPreblend = array<vec4<f32>, 9>(_e251, _e254, _e257, _e260, _e263, _e266, _e269, _e272, _e275);
    let probeLocalBlendFraction = probeBlendRecords[0].z;
    let probeDiffuseK = (kD_1 / max(vec3((1f - metallic_13)), vec3(0.0001f)));
    let _e288 = physicalNormal;
    let _e289 = irradiance;
    let _e291 = diffuseAlbedo;
    let _e292 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e288, (_e289 * skyFactor), probeDiffuseK, _e291, metallic_13);
    let _e293 = specularIbl;
    let _e298 = coatF;
    ambient = ((_e292 + (_e293 * _e235)) * (vec3(1f) - _e298));
    let _e301 = ambient;
    ambient = (_e301 * ao);
    let _e303 = ambient;
    color = _e303;
    ...
    let _e376 = material.thickness;
    let _e378 = finiteScalar(_e376, 0f);
    let _e381 = thicknessSample;
    let _e383 = finiteScalar(_e381, 1f);
    let worldThickness = max(((_e378 * length(worldRefractedDirection)) * _e383), 0f);
    ...
    let _e425 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e425.xyz;
    ...
    let _e433 = local_1;
    if _e433 {
        let _e441 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e441.xyz;
    }
    let _e445 = material.attenuationColor;
    let _e448 = finiteColor(_e445, vec3(1f));
    let safeAttenuationColor = clamp(_e448, vec3(0f), vec3(1f));
    let _e456 = material.attenuationDistance;
    let _e458 = finiteScalar(_e456, 0f);
    let safeAttenuationDistance = max(_e458, 0f);
    ...
    let _e475 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e475);
    let _e477 = color;
    let _e478 = transmittedBackdrop;
    let _e481 = finiteColor(_e478, vec3(0f));
    color = (_e477 + ((_e481 * transmittedEnergy) * beerAttenuation));
    let _e485 = color;
    color = (_e485 + _e7.emissive);
    let _e488 = physicalNormal;
    let _e490 = standardViewZ(in_2);
    let _e491 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e488, in_2.worldPos, _e490);
    let _e492 = physicalNormal;
    let _e493 = diffuseAlbedo;
    let _e494 = f0_;
    let _e495 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e492, v_5, _e493, metallic_13, a_3, _e494);
    let _e496 = color;
    color = (_e496 + (_e491 * _e495));
    let _e499 = color;
    let _e502 = standardViewZ(in_2);
    let _e504 = physicalNormal;
    let _e505 = diffuseAlbedo;
    let _e506 = f0_;
    let _e509 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e502, in_2.worldPos, _e504, v_5, _e505, metallic_13, a_3, _e506, false, true);
    color = (_e499 + _e509);
    let _e511 = color;
    return vec4<f32>(_e511, alpha);
}
...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e37 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e8 * _e10), _e14, _e15, baseColorTexture_1, baseColorTexture_sampler, _e18, _e21, in_5.currentClip, in_5.previousClip, _e26, reactive_3, in_5.uv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6_, in_5.uv7_);
    return _e37;
}
