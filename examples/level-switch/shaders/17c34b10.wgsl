...
fn evaluate_cluster_lightsX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(ndc: vec3<f32>, view_z: f32, world_pos_1: vec3<f32>, normal_7: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_5: f32, alpha_sq_1: f32, f0_2: vec3<f32>) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e40 = total_radiance;
            let _e42 = i_1;
            let _e44 = light_data_uniformX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX[_e42];
            let _e52 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(_e44, world_pos_1, normal_7, view_dir_1, base_color_1, metallic_5, alpha_sq_1, f0_2);
            total_radiance = (_e40 + _e52);
        }
        continuing {
            let _e54 = i_1;
            i_1 = (_e54 + 1u);
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_4: vec3<f32>, layer_3: u32, count_4: u32, normal_9: vec3<f32>, l: vec3<f32>) -> f32 {
    ...
    if (kernel == 3u) {
        if all((uv_4 >= (tileLo + texel_2))) {
            local_11 = all((uv_4 <= (tileHi - texel_2)));
        } else {
            local_11 = false;
        }
...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e41 = transformedMaterialUv(_e37, _e40, in_1);
    ...
    let _e53 = finiteScalar(_e51, 0f);
    let _e56 = material.metallicChannel;
    let _e58 = pick_channel(_e48, u32(_e56));
    let _e60 = finiteScalar(_e58, 1f);
    let metallic_7 = clamp((_e53 * _e60), 0f, 1f);
    let _e67 = material.roughnessChannel;
    let _e69 = pick_channel(_e48, u32(_e67));
    let _e71 = finiteScalar(_e69, 1f);
    let roughnessTex = clamp(_e71, 0f, 1f);
    let _e77 = material.roughness;
    let _e79 = finiteScalar(_e77, 0.5f);
    a = max(_e79, 0.04f);
    let _e83 = a;
    a = (_e83 * roughnessTex);
    let _e85 = a;
    let _e86 = a;
    a = (_e85 * _e86);
    let _e90 = material.normalTextureCoordinatesTransform;
    let _e93 = material.normalTextureCoordinatesMetadata;
    let _e94 = transformedMaterialUv(_e90, _e93, in_1);
    let _e97 = material.normalTextureCoordinatesMetadata;
    let _e101 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(normalTexture, normalSampler, _e94, _e97.zw);
    let normSampleRg = _e101.xy;
    let _e103 = decodeTangentSpaceNormalRgX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(normSampleRg);
    let _e106 = material.normalScale;
    let _e107 = scaleTangentSpaceNormalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(_e103, _e106);
    let _e110 = applyTBNX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DCNYX(in_1.worldNormal, in_1.worldTangent, _e107);
    let _e113 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let v = normalize((_e113 - in_1.worldPos));
    ...
    let _e126 = material.specularTint;
    let _e129 = material.specularTintTextureCoordinatesMetadata;
    let _e133 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e123, _e129.zw);
    let specularTint = (_e126 * _e133.xyz);
    let _e138 = material.ior;
    let _e140 = finiteScalar(_e138, 1.5f);
    let safeIor = max(_e140, 1f);
    let dielectricF0_ = pow(((safeIor - 1f) / (safeIor + 1f)), 2f);
    let f0_3 = mix((vec3(dielectricF0_) * specularTint), albedo, metallic_7);
    diffuseAlbedo = albedo;
    let _e156 = material.transmissionTextureCoordinatesTransform;
    let _e159 = material.transmissionTextureCoordinatesMetadata;
    let _e160 = transformedMaterialUv(_e156, _e159, in_1);
    let _e163 = material.thicknessTextureCoordinatesTransform;
    let _e166 = material.thicknessTextureCoordinatesMetadata;
    let _e167 = transformedMaterialUv(_e163, _e166, in_1);
    let _e170 = material.transmissionTextureCoordinatesMetadata;
    let _e174 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(transmissionTexture, transmissionSampler, _e160, _e170.zw);
    let transmissionSample = _e174.x;
    let _e178 = material.thicknessTextureCoordinatesMetadata;
    let _e182 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(thicknessTexture, thicknessSampler, _e167, _e178.zw);
    let thicknessSample = _e182.y;
    let _e186 = material.transmission;
    let _e188 = finiteScalar(_e186, 0f);
    let _e190 = finiteScalar(transmissionSample, 1f);
    let transmissionFactor = clamp((_e188 * _e190), 0f, 1f);
    let _e197 = finiteScalar(dot(_e110, v), 0f);
    let refractionFromInside = (_e197 < 0f);
    let refractionNormal = select(_e110, -(_e110), refractionFromInside);
    ...
    let viewCos = clamp(abs(_e197), 0f, 1f);
    let _e213 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(viewCos, vec3(dielectricF0_));
    let fresnel_1 = clamp(_e213.x, 0f, 1f);
    ...
    let _e233 = material.clearcoatRoughness;
    let coatRoughness = max(_e233, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e242 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e110, v), 0f), vec3(0.04f));
    let _e245 = material.clearcoat;
    let coatF = (_e242 * _e245);
    let _e252 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e110, v), 0f), f0_3);
    let kD = ((vec3(1f) - _e252) * (1f - metallic_7));
    let _e259 = material.roughness;
    let _e261 = finiteScalar(_e259, 0.5f);
    let iblRoughness = clamp((max(_e261, 0.04f) * roughnessTex), 0.04f, 1f);
    let _e270 = skylight.rotation;
    let _e273 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e110, _e270, irradianceMap_1, irradianceSampler_1);
    let _e276 = skylight.rotation;
    let _e281 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e110, v, iblRoughness, f0_3, _e276, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e284 = material.occlusionTextureCoordinatesTransform;
    let _e287 = material.occlusionTextureCoordinatesMetadata;
    let _e288 = transformedMaterialUv(_e284, _e287, in_1);
    let _e291 = material.occlusionTextureCoordinatesMetadata;
    let _e295 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTexture, occlusionSampler, _e288, _e291.zw);
    let _e299 = material.occlusionStrength;
    let ao = mix(1f, _e295.x, _e299);
    let _e304 = skylight.colorR;
    let _e307 = skylight.colorG;
    let _e310 = skylight.colorB;
    let skyColor = vec3<f32>(_e304, _e307, _e310);
    let _e313 = diffuseAlbedo;
    ambient = ((((kD * _e273) * _e313) + _e281) * (vec3(1f) - coatF));
    let _e323 = material.clearcoat;
    if (_e323 != 0f) {
        let _e330 = skylight.rotation;
        let _e335 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e110, v, coatRoughness, vec3(0.04f), _e330, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
        let _e336 = ambient;
        let _e339 = material.clearcoat;
        ambient = (_e336 + (_e335 * _e339));
    }
    let _e342 = ambient;
    let _e346 = skylight.intensity;
    ambient = (((_e342 * skyColor) * _e346) * ao);
    let ssaoUv = ((in_1.ndc.xy * vec2<f32>(0.5f, -0.5f)) + vec2<f32>(0.5f, 0.5f));
    let _e361 = textureSample(ssaoBlurredTexture, ssaoBlurredSampler, ssaoUv);
    let ssaoFactor = _e361.x;
    let _e363 = get_ssao_intensityX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX();
    let _e364 = ambient;
    ambient = (_e364 * mix(1f, (ssaoFactor * ao), _e363));
    let _e369 = ambient;
    color = _e369;
    let screenUv = ((in_1.ndc.xy * vec2<f32>(0.5f, -0.5f)) + vec2(0.5f));
    let _e383 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].worldFromLocal;
    let _e388 = instancesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[in_1.instanceIdx].localFromInstance;
    let localToWorld_1 = (_e383 * _e388);
    let localToWorld0_ = localToWorld_1[0].xyz;
    let localToWorld1_ = localToWorld_1[1].xyz;
    let localToWorld2_ = localToWorld_1[2].xyz;
    ...
    let _e442 = material.thickness;
    let _e444 = finiteScalar(_e442, 0f);
    let _e448 = finiteScalar(thicknessSample, 1f);
    let worldThickness = max(((_e444 * length(worldRefractedDirection)) * _e448), 0f);
    ...
    let _e490 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e490.xyz;
    ...
    let _e498 = local_1;
    if _e498 {
        let _e506 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e506.xyz;
    }
    let _e510 = material.attenuationColor;
    let _e513 = finiteColor(_e510, vec3(1f));
    let safeAttenuationColor = clamp(_e513, vec3(0f), vec3(1f));
    let _e521 = material.attenuationDistance;
    let _e523 = finiteScalar(_e521, 0f);
    let safeAttenuationDistance = max(_e523, 0f);
    ...
    let _e540 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e540);
    let _e542 = color;
    let _e543 = transmittedBackdrop;
    let _e546 = finiteColor(_e543, vec3(0f));
    color = (_e542 + ((_e546 * transmittedEnergy) * beerAttenuation));
    let _e552 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e110, in_1.worldPos, in_1.viewZ);
    let _e553 = diffuseAlbedo;
    let _e554 = a;
    let _e555 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e110, v, _e553, metallic_7, _e554, f0_3);
    let _e556 = color;
    color = (_e556 + (_e552 * _e555));
    let _e561 = material.clearcoat;
    if (_e561 != 0f) {
        let _e569 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e110, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
        let _e570 = color;
        let _e573 = material.clearcoat;
        color = (_e570 + ((_e552 * _e573) * _e569));
    }
    let _e577 = color;
    let _e581 = diffuseAlbedo;
    let _e582 = a;
    let _e583 = evaluate_cluster_lightsX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(in_1.ndc, in_1.viewZ, in_1.worldPos, _e110, v, _e581, metallic_7, _e582, f0_3);
    color = (_e577 + _e583);
    let _e587 = material.clearcoat;
    if (_e587 != 0f) {
        let _e590 = color;
        let _e593 = material.clearcoat;
        let _e602 = evaluate_cluster_lightsX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(in_1.ndc, in_1.viewZ, in_1.worldPos, _e110, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
        color = (_e590 + (_e593 * _e602));
    }
    let _e607 = material.emissiveTextureCoordinatesTransform;
    let _e610 = material.emissiveTextureCoordinatesMetadata;
    let _e611 = transformedMaterialUv(_e607, _e610, in_1);
    let _e614 = material.emissiveTextureCoordinatesMetadata;
    let _e618 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e611, _e614.zw);
    let emissiveSample = _e618.xyz;
    let _e620 = color;
    let _e623 = material.emissive;
    let _e626 = material.emissiveIntensity;
    color = (_e620 + ((_e623 * _e626) * emissiveSample));
    let _e631 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX;
    let _e632 = color;
    let _e634 = applySceneFog(_e631, _e632, alpha_3, in_1.worldPos);
    return _e634;
}
