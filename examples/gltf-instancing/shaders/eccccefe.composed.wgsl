...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let kD = ((vec3(1f) - _e64) * (1f - metallic_6));
    ...
    let _e115 = color;
    let _e116 = a;
    let _e119 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e49, v, albedo, metallic_6, _e116, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e115 + _e119);
    ...
    loop {
        ...
        }
        {
            ...
            let _e132 = color;
            let _e137 = a;
            let _e138 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_6, _e137, f0_1);
            color = (_e132 + _e138);
        }
        continuing {
            let _e140 = i;
    ...
    loop {
        ...
        }
        {
            ...
            if (s.shadowAtlasTile >= 0i) {
                ...
                let _e174 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_6, _e165, f0_1, _e170, s.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e157 + _e174);
            } else {
                let _e176 = color;
                let _e184 = a;
                let _e185 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_6, _e184, f0_1);
                color = (_e176 + _e185);
            }
        }
        continuing {
