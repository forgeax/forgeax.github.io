...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e102 = color;
    let _e103 = a;
    let _e106 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e49, v, albedo, metallic_5, _e103, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e102 + _e106);
    ...
    loop {
        ...
        }
        {
            ...
            let _e119 = color;
            let _e124 = a;
            let _e125 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_5, _e124, f0_1);
            color = (_e119 + _e125);
        }
        continuing {
            let _e127 = i;
    ...
    loop {
        ...
        }
        {
            ...
            let _e141 = color;
            let _e149 = a;
            let _e150 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_5, _e149, f0_1);
            color = (_e141 + _e150);
        }
        continuing {
            let _e152 = i_1;
