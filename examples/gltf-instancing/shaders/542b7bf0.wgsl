...
@group(2) @binding(2) 
var<uniform> previousPalette: array<mat4x4<f32>, 255>;
...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e98;
    let _e100 = color;
    color = (_e100 + _e5.emissive);
    let _e103 = physicalNormal;
    let _e105 = standardViewZ(in_1);
    let _e106 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e103, in_1.worldPos, _e105);
    let _e107 = color;
    let _e111 = standardViewZ(in_1);
    let _e112 = physicalNormal;
    let _e113 = diffuseAlbedo;
    let _e114 = f0_;
    let _e115 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e111, _e112, v, _e113, metallic_7, a_3, _e114, _e106);
    color = (_e107 + _e115);
    let _e119 = color;
    output.color = vec4<f32>(_e119, alpha_4);
...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e6 = material.baseColor.w;
    let _e7 = temporalVertexAlpha(in_4);
    let _e11 = material.alphaCutoff;
    let _e14 = material.alphaHash;
    let _e16 = standardUsesBaseColorTexture();
    let _e19 = material.baseColorTextureCoordinatesTransform;
    let _e22 = material.baseColorTextureCoordinatesMetadata;
    let _e23 = standardUsesAlphaTexture();
    let _e26 = material.alphaTextureCoordinatesTransform;
    let _e29 = material.alphaTextureCoordinatesMetadata;
    let _e32 = material.alphaChannel;
    let _e37 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e52 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e6 * _e7), _e11, _e14, in_4.positionOS, _e16, baseColorTexture_1, baseColorTexture_sampler, _e19, _e22, _e23, alphaTexture_1, alphaTexture_sampler, _e26, _e29, _e32, in_4.currentClip, in_4.previousClip, _e37, 1f, true, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return _e52;
}
