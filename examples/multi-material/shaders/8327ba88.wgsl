...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e152;
    let _e154 = color;
    color = (_e154 + _e5.emissive);
    let _e157 = physicalNormal;
    let _e159 = standardViewZ(in_1);
    let _e160 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e157, in_1.worldPos, _e159);
    let _e161 = color;
    let _e165 = standardViewZ(in_1);
    let _e166 = physicalNormal;
    let _e167 = diffuseAlbedo;
    let _e168 = f0_;
    let _e169 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e165, _e166, v, _e167, metallic_7, a_3, _e168, _e160);
    color = (_e161 + _e169);
    let _e173 = color;
    output.color = vec4<f32>(_e173, alpha_4);
