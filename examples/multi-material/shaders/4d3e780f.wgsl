...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e216 = standardViewZ(in_1);
    let _e217 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e214, in_1.worldPos, _e216);
    ...
    let _e225 = color;
    color = (_e225 + _e6.emissive);
    let _e230 = color;
    output.color = vec4<f32>(_e230, alpha_1);
    let _e233 = reflectionFallback;
    let _e234 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e233, _e234);
    let _e236 = output;
    return _e236;
}
