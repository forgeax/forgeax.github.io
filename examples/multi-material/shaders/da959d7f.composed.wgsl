...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e468 = f0_;
    let _e471 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e464, in_1.worldPos, _e466, v_5, _e467, metallic_14, a_4, _e468, false, true);
    color = (_e461 + _e471);
    let _e473 = color;
