...
fn evaluateStandardSurface(in_10: VsOut, frontFacing_2: bool) -> SurfaceData {
    ...
    let _e33 = selectedMaterial(in_10.materialAddress.x);
    let _e34 = evaluate_standard_surface(input_3, _e33);
    return _e34;
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e139 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e126, v_2, _e127, metallic_15, iblRoughness, _e128, _e130, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e131, _e132);
    ...
    let _e198 = f0_;
    let _e199 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e195, _e196, v_2, _e197, metallic_15, a_4, _e198, _e190);
    color = (_e191 + _e199);
    let _e201 = color;
    color = (_e201 + _e8.emissive);
    let _e206 = color;
    output.color = vec4<f32>(_e206, alpha_5);
