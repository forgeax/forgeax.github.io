...
fn sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_3: vec3<f32>, view_2: vec3<f32>, roughness_3: f32, F0_3: vec3<f32>, worldPosition_1: vec3<f32>, boxCenter_1: vec3<f32>, boxExtents_1: vec3<f32>, rotation_3: vec4<f32>, probeMap: texture_cube<f32>, probeSampler: sampler, brdfLut_2: texture_2d<f32>, brdfLutSampler_2: sampler, skylightMap: texture_cube<f32>, skylightRotation: vec4<f32>, skylightScale: vec3<f32>, probeIntensity: f32, boxProjection: bool) -> vec3<f32> {
    ...
    let local_50 = (_e55 * probeIntensity);
    let _e58 = sky;
    return mix(_e58, local_50, weight);
}
...
fn evaluateProbeDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX(shPreblend_1: array<vec4<f32>, 9>, localBlendFraction: f32, normal_5: vec3<f32>, e_sky: vec3<f32>, k_d: vec3<f32>, albedo: vec3<f32>, metallic: f32) -> vec3<f32> {
    ...
    let local_51 = (max(_e2, vec3(0f)) * PROBE_INV_PIX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX);
    let skyResidualFraction = (1f - localBlendFraction);
    return ((((local_51 + (skyResidualFraction * e_sky)) * k_d) * albedo) * (1f - metallic));
}
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_6: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic_1: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_3 = max(dot(normal_6, l_3), 0f);
    ...
    let roughness_9 = sqrt(max(alphaSq, 0f));
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_9, nDotV_2, nDotL_3, F0_5);
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_2: vec3<f32>, normal_7: vec3<f32>, viewDir_1: vec3<f32>, baseColor_1: vec3<f32>, metallic_2: f32, alphaSq_1: f32, F0_6: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_4 = max(dot(normal_7, l_4), 0f);
    ...
    let roughness_10 = sqrt(max(alphaSq_1, 0f));
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_10, nDotV_3, nDotL_4, F0_6);
...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_9: vec3<f32>, lightColor_1: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_10: f32, worldPos_10: vec3<f32>, n_1: vec3<f32>, v_1: vec3<f32>, baseColor_8: vec3<f32>, metallic_7: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_9, lightColor_1, axisX_1, axisY_1, halfWidth_1, halfHeight_1, invRangeSquared_10, worldPos_10, n_1, v_1, baseColor_8, metallic_7, alphaSq_6, F0_11);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        tile = encoded_tile;
        if (encoded_tile >= 0i) {
            local_22 = ((encoded_tile & PROJECTOR_FLAGX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) != 0i);
        } else {
            local_22 = false;
        }
        let _e70 = local_22;
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            let _e116 = tile;
        ...
        let _e136 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return (_e136 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e154 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e154;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_12: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_9: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_12, view_dir_1, base_color_1, metallic_9, alpha_sq_1, f0_3, flat_2d_1, receive_shadows_1);
...
fn evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(worldPosition_4: vec3<f32>, normal_13: vec3<f32>, direction_2: vec3<f32>, albedo_1: vec3<f32>, metallic_10: f32, roughness_6: f32, f0_4: vec3<f32>, sky_1: SkylightUniformsX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX, irradianceMap_1: texture_cube<f32>, irradianceSampler_1: sampler, prefilterMap_1: texture_cube<f32>, prefilterSampler_1: sampler, brdfLut_3: texture_2d<f32>, skylightPrefilterMap: texture_cube<f32>, sh: array<vec4<f32>, 9>, localBlend: f32) -> StandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX {
    ...
    if (sky_1.intensity < 0f) {
        ...
        irradiance = _e45;
        let _e47 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_13, direction_2, roughness_6, f0_4, sky_1.rotation, prefilterMap_1, prefilterSampler_1, brdfLut_3, irradianceSampler_1);
        specular = _e47;
    }
    ...
    let _e63 = fresnelSchlickRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXG2DBOJSWIX(max(dot(normal_13, direction_2), 0f), f0_4, roughness_6);
    let kD = ((vec3(1f) - _e63) * (1f - metallic_10));
    let _e72 = irradiance;
    diffuse = (((kD * _e72) * albedo_1) * diffuseScale);
    if (localBlend > 0f) {
        let _e80 = irradiance;
        let _e90 = evaluateProbeDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX(sh, localBlend, normal_13, (_e80 * diffuseScale), (kD / max(vec3((1f - metallic_10)), vec3(0.0001f))), albedo_1, metallic_10);
        diffuse = _e90;
    }
    let _e91 = diffuse;
    let _e92 = specular;
    let _e94 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(tint, sky_1.intensity);
    let _e98 = projectSpecularRadianceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(vec3(1f), normal_13, direction_2, roughness_6, f0_4, brdfLut_3, irradianceSampler_1);
    return StandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(_e91, (_e92 * _e94), _e98);
}

fn evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(worldPosition_5: vec3<f32>, ndc_2: vec3<f32>, viewZ: f32, normal_14: vec3<f32>, direction_3: vec3<f32>, albedo_2: vec3<f32>, metallic_11: f32, alpha: f32, f0_5: vec3<f32>, shadow_1: f32) -> vec3<f32> {
    var direct: vec3<f32>;

    let _e6 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_14, direction_3, albedo_2, metallic_11, alpha, f0_5);
    ...
    direct = _e25;
    let _e27 = direct;
    let _e32 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_2, viewZ, worldPosition_5, normal_14, direction_3, albedo_2, metallic_11, alpha, f0_5, false, true);
    direct = (_e27 + _e32);
    let _e34 = direct;
    return _e34;
}
...
fn clippedByPlanesX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MNFYHA2LOM45DU4DMMFXGK4YX(positionWS: vec3<f32>, planes: array<vec4<f32>, 6>, control: vec4<f32>) -> bool {
    ...
    let count_6 = min(u32(max(control.x, 0f)), 6u);
    allOutside = (count_6 > 0u);
    loop {
        let _e13 = index;
        if (_e13 < count_6) {
        } else {
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_15: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_28: bool;

    let nDotL_6 = dot(normal_15, l);
    let depthSpan = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.splitPlanes[layer_4].z;
    if (nDotL_6 > 0.01f) {
        local_28 = (depthSpan > 0f);
    } else {
        local_28 = false;
    }
    let _e16 = local_28;
    ...
    let slope = ((abs(dot(normal_15, right)) + abs(dot(normal_15, up))) / nDotL_6);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_11: vec3<f32>, layer_5: u32, count_4: u32, normal_16: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_29: bool;
    var local_30: bool;
    var local_31: bool;
    var local_32: bool;
    ...
    if (tileUv.x >= 0f) {
        local_30 = (tileUv.x <= 1f);
    } else {
        local_30 = false;
    }
    let _e46 = local_30;
    if _e46 {
        local_31 = (tileUv.y >= 0f);
    } else {
        local_31 = false;
    }
    let _e53 = local_31;
    if _e53 {
        local_32 = (tileUv.y <= 1f);
    } else {
        local_32 = false;
    }
    let _e60 = local_32;
    if _e60 {
        local_33 = (projCoords.z >= 0f);
    } else {
        local_33 = false;
    }
    let _e67 = local_33;
    if _e67 {
        local_34 = (projCoords.z <= 1f);
    } else {
        local_34 = false;
    }
    let _e74 = local_34;
    ...
    let tileOrigin_3 = (vec2<u32>((layer_5 % _e94.x), (layer_5 / _e94.x)) * tileSize_2);
    ...
    let _e118 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, normal_16, l_1, (rawRadius + 1f));
    ...
    if (lightDepthWorldSpan > 0f) {
        local_38 = (worldUnitsPerTexel > 0f);
    } else {
        local_38 = false;
    }
    let _e213 = local_38;
    ...
    let _e258 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, normal_16, l_1, (compareRadius + 1.5f));
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12: vec3<f32>, layer_6: u32, count_5: u32, normal_17: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_41: bool;
    var local_42: bool;
    var local_43: bool;
    var local_44: bool;
    ...
    if (tileUv_1.x >= 0f) {
        local_41 = (tileUv_1.x <= 1f);
    } else {
        local_41 = false;
    }
    let _e40 = local_41;
    if _e40 {
        local_42 = (tileUv_1.y >= 0f);
    } else {
        local_42 = false;
    }
    let _e47 = local_42;
    if _e47 {
        local_43 = (tileUv_1.y <= 1f);
    } else {
        local_43 = false;
    }
    let _e54 = local_43;
    if _e54 {
        local_44 = (currentDepth <= 1f);
    } else {
        local_44 = false;
    }
    let _e60 = local_44;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12, layer_6, count_5, normal_17, l_2, filterProfile);
        return _e90;
    }
    let kernel = select(select(3u, 5u, (filterProfile == 3u)), 1u, (filterProfile == 1u));
    let _e105 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_6, normal_17, l_2, f32(((kernel / 2u) + 1u)));
    ...
    if (kernel == 3u) {
        if all((uv_7 >= (tileLo + texel_5))) {
            local_45 = all((uv_7 <= (tileHi - texel_5)));
        } else {
            local_45 = false;
        }
        let interior = local_45;
        if interior {
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_18: vec3<f32>, worldPos_13: vec3<f32>, viewZ_1: f32) -> f32 {
    var shadow_4: f32;
    var local_46: bool;
    ...
    let count_7 = u32(max(_e13, 1f));
    let viewDepth_1 = -(viewZ_1);
    let _e25 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.splitPlanes[(count_7 - 1u)].x;
    if (viewDepth_1 > _e25) {
        return 1f;
    }
    let _e28 = _pickCascadeLayerX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(viewDepth_1, count_7);
    let _e33 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.normalBias;
    let receiverPosition = (worldPos_13 + (normal_18 * _e33));
    let _e36 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, _e28, count_7, normal_18, l_7);
    shadow_4 = _e36;
    let _e40 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cascadeBlend;
    if (_e40 > 0f) {
        local_46 = ((_e28 + 1u) < count_7);
    } else {
        local_46 = false;
    }
    let _e49 = local_46;
    if _e49 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e72 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, (_e28 + 1u), count_7, normal_18, l_7);
...
fn encodeStandardNormalRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(normal_19: vec3<f32>, roughness_7: f32) -> u32 {
    var oct: vec2<f32>;

    let n_2 = normalize(normal_19);
    oct = (n_2.xy / vec2(((abs(n_2.x) + abs(n_2.y)) + abs(n_2.z))));
    if (n_2.z < 0f) {
        let _e17 = oct;
        let _e27 = oct;
    ...
    return ((uv_8.x | (uv_8.y << 12u)) | (u32(round((clamp(roughness_7, 0f, 1f) * 255f))) << 24u));
}
...
fn encodeStandardGBufferX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(normal_20: vec3<f32>, roughness_8: f32, albedo_3: vec3<f32>, metallic_12: f32, f0_6: vec3<f32>, occlusion: f32, emissive: vec3<f32>, opacity: f32, reflection: u32, probeRow_1: u32) -> GBufferOutputX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX {
    let _e5 = encodeStandardNormalRoughnessX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(normal_20, roughness_8);
    let _e8 = encodeStandardReflectanceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(f0_6, occlusion);
    let _e11 = encodeStandardReflectanceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUZ3COVTGMZLSX(albedo_3, metallic_12);
...
fn alphaHashThresholdX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DUYLMOBUGCX3IMFZWQX(position: vec3<f32>, derivative: f32) -> f32 {
    ...
    let t_2 = fract(level);
    let x_4 = mix(noise.x, noise.y, t_2);
    let a_2 = min(t_2, (1f - t_2));
    threshold = x_4;
    if (a_2 > 0f) {
        if (x_4 < a_2) {
            threshold = ((x_4 * x_4) / ((2f * a_2) * (1f - a_2)));
        } else {
            if (x_4 < (1f - a_2)) {
                threshold = ((x_4 - (0.5f * a_2)) / (1f - a_2));
            } else {
                threshold = (1f - (((1f - x_4) * (1f - x_4)) / ((2f * a_2) * (1f - a_2))));
            }
        }
    }
    let _e60 = threshold;
...
fn projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(baseColorAlpha_1: f32, alphaCutoff: f32, alphaHash: f32, positionOS: vec3<f32>, baseColorTextureEnabled: bool, baseColorTexture: texture_2d<f32>, baseColorSampler: sampler, transform_1: vec4<f32>, metadata_3: vec4<f32>, alphaTextureEnabled: bool, alphaTexture: texture_2d<f32>, alphaSampler: sampler, alphaTransform: vec4<f32>, alphaMetadata: vec4<f32>, alphaChannel: f32, currentClip_1: vec4<f32>, previousClip_1: vec4<f32>, temporalProjection_3: vec4<f32>, reactive_3: f32, motionValid_2: bool, uv0_1: vec2<f32>, uv1_1: vec2<f32>, uv2_1: vec2<f32>, uv3_1: vec2<f32>, uv4_1: vec2<f32>, uv5_1: vec2<f32>, uv6_1: vec2<f32>, uv7_1: vec2<f32>) -> vec4<f32> {
    ...
    if (alphaCutoff > 0f) {
        local_47 = (coverage_2 <= alphaCutoff);
    } else {
        local_47 = false;
    }
    let _e49 = local_47;
    ...
    let _e52 = resolvePbrTemporalReactiveX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX(reactive_3, coverage_2, 1f);
    let reactiveCoverage = select(_e52, reactive_3, (alphaHash > 0.5f));
    let _e60 = packSceneTemporalV1WithValidityX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(currentClip_1, previousClip_1, temporalProjection_3, reactiveCoverage, motionValid_2);
    return _e60;
}
...
fn vs_main_impl(in_6: VsIn, meshIndex: u32, instanceIndex: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    out_1.positionOSAndViewZ = vec4<f32>(in_6.pos, _e29);
...
fn selectedMaterial(index_2: u32) -> MaterialParameters {
    let _e3 = sceneMaterials[index_2];
    return _e3;
}
...
fn transformedMaterialUv(transform_2: vec4<f32>, metadata_4: vec4<f32>, in_8: VsOut) -> vec2<f32> {
    ...
    let c_2 = cos(angle_2);
    let s_1 = sin(angle_2);
    return (vec2<f32>(((scaled_2.x * c_2) - (scaled_2.y * s_1)), ((scaled_2.x * s_1) + (scaled_2.y * c_2))) + transform_2.xy);
}
...
fn surfaceUv(input: SurfaceInput, transform_3: vec4<f32>, metadata_5: vec4<f32>) -> vec2<f32> {
    ...
    return (vec2<f32>(((scaled_3.x * c_3) - (scaled_3.y * s_2)), ((scaled_3.x * s_2) + (scaled_3.y * c_3))) + transform_3.xy);
}
...
fn evaluate_standard_surface(input_1: SurfaceInput, materialValue: MaterialParameters) -> SurfaceData {
    ...
    normal_21 = (normalize(input_1.geometricNormalWS) * faceDirection_1);
    ...
    if _e93 {
        ...
        normal_21 = (_e109 * faceDirection_1);
        usesNormal = true;
    }
    ...
    if _e119 {
        ...
        let uv_9 = (_e122 * materialValue.bumpTextureCoordinatesMetadata.zw);
        let dx_1 = dpdx(uv_9);
        let dy_1 = dpdy(uv_9);
        let _e130 = textureSampleGrad(normalTexture, normalTexture_sampler, uv_9, dx_1, dy_1);
        let height = _e130.x;
        let _e135 = textureSampleGrad(normalTexture, normalTexture_sampler, (uv_9 + dx_1), dx_1, dy_1);
        let heightX = _e135.x;
        let _e140 = textureSampleGrad(normalTexture, normalTexture_sampler, (uv_9 + dy_1), dx_1, dy_1);
        let heightY = _e140.x;
        let _e143 = normal_21;
    ...
    let baseColor_9 = ((materialValue.baseColor.xyz * _e175.xyz) * vertexColor.xyz);
    let _e181 = metallicSample;
    let _e184 = surfaceChannel(_e181, u32(materialValue.metallicChannel));
    let metallic_13 = clamp((materialValue.metallic * _e184), 0f, 1f);
    let _e190 = roughnessSample;
    let _e193 = surfaceChannel(_e190, u32(materialValue.roughnessChannel));
    let roughness_11 = clamp((materialValue.roughness * _e193), 0.04f, 1f);
    ...
    let _e234 = alpha_3;
    return SurfaceData(baseColor_9, _e226, metallic_13, roughness_11, emissive_1, occlusion_1, clamp((((materialValue.baseColor.w * _e230) * vertexColor.w) * _e234), 0f, 1f), clamp(materialValue.alphaCutoff, 0f, 1f));
}
...
fn evaluateStandardSurface(in_10: VsOut, frontFacing_2: bool) -> SurfaceData {
    ...
    material = _e3;
    applyViewClippingX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MNFYHA2LOM45DU4DMMFXGK4YX(in_10.worldPos, false);
    let _e9 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cameraPos;
    let viewDirectionWS = normalize((_e9 - in_10.worldPos));
    let positionOS_1 = in_10.positionOSAndViewZ.xyz;
    let _e28 = materialVertexColor(in_10);
    let input_3 = SurfaceInput(positionOS_1, in_10.worldPos, in_10.worldNormal, in_10.worldTangent, viewDirectionWS, in_10.uv, in_10.uv1_, in_10.uv2_, in_10.uv3_, in_10.uv4_, in_10.uv5_, in_10.uv6And7_.xy, in_10.uv6And7_.zw, _e28, frontFacing_2);
    let _e31 = evaluate_surface(input_3);
    return _e31;
}
...
fn blendLinearTransparent(source_3: vec3<f32>, destination: vec3<f32>, alpha_4: f32) -> vec3<f32> {
    return ((source_3 * alpha_4) + (destination * (1f - alpha_4)));
}
...
fn alphaTestSurface(surface: SurfaceData) {
    ...
    if (surface.alphaClipThreshold > 0f) {
        local_49 = (surface.opacity <= surface.alphaClipThreshold);
    } else {
        local_49 = false;
    }
    let _e10 = local_49;
...
fn standardSurfaceF0_(in_11: VsOut, surface_1: SurfaceData) -> vec3<f32> {
    ...
    let metallic_14 = clamp(_e4, 0f, 1f);
    ...
    return mix(((vec3(dielectricF0_) * _e36) * _e38), albedo_4, metallic_14);
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e96 = finiteScalar(dot(n_3, v_2), 0f);
    let refractionFromInside = (_e96 < 0f);
    let refractionNormal = select(n_3, -(n_3), refractionFromInside);
    ...
    let transmittedEnergy = select(0f, ((transmissionFactor * (1f - metallic_15)) * (1f - fresnel_1)), (refractedLengthSquared > 0.000001f));
    ...
    let _e221 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e208, v_2, _e209, metallic_15, iblRoughness, _e210, _e212, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e213, _e214);
    ...
    let _e389 = textureSampleLevel(transmissionBackdropTexture, prefilterSampler_2, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e397 = local_2;
    if _e397 {
        let _e405 = textureSampleLevel(transmissionBackdropTexture, prefilterSampler_2, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e460 = f0_;
    let _e461 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e457, _e458, v_2, _e459, metallic_15, a_4, _e460, _e452);
    color = (_e453 + _e461);
    let _e463 = color;
    color = (_e463 + _e6.emissive);
    let _e468 = color;
    output.color = vec4<f32>(_e468, alpha_5);
...
fn vs_temporal(in_4: VsIn, @builtin(instance_index) idx_2: u32) -> TemporalVsOut {
    ...
    out.positionOS = in_4.pos;
    out.clippingPositionWS = currentWorld.xyz;
    let _e37 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalCurrentViewProj;
    out.currentClip = (_e37 * currentWorld);
    let _e42 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    out.clip = (_e42 * currentWorld);
    let _e47 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalPreviousViewProj;
    let _e48 = previousWorld;
    out.previousClip = (_e47 * _e48);
    out.uv = in_4.uv;
    out.uv1_ = in_4.uv1_;
    out.uv2_ = in_4.uv2_;
    out.uv3_ = in_4.uv3_;
...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e9 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.x;
    reactive = _e9;
    let _e15 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.y;
    motionValid = (_e15 >= 0.5f);
    let _e22 = material.baseColor.w;
    let _e23 = temporalVertexAlpha(in_5);
    let _e27 = material.alphaCutoff;
    let _e30 = material.alphaHash;
    let _e32 = standardUsesBaseColorTexture();
    let _e35 = material.baseColorTextureCoordinatesTransform;
    let _e38 = material.baseColorTextureCoordinatesMetadata;
    let _e39 = standardUsesAlphaTexture();
    let _e42 = material.alphaTextureCoordinatesTransform;
    let _e45 = material.alphaTextureCoordinatesMetadata;
    let _e48 = material.alphaChannel;
    let _e53 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e54 = reactive;
    let _e55 = motionValid;
    let _e68 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e22 * _e23), _e27, _e30, in_5.positionOS, _e32, baseColorTexture_1, baseColorTexture_sampler, _e35, _e38, _e39, alphaTexture_1, alphaTexture_sampler, _e42, _e45, _e48, in_5.currentClip, in_5.previousClip, _e53, _e54, _e55, in_5.uv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6_, in_5.uv7_);
    return vec4(1f);
}
