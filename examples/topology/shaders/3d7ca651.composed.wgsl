...
fn shadowVertex(in_4: VsInput, idx_2: u32) -> VsOut {
    ...
    let _e124 = materialIndex;
    out.materialIndex = _e124;
    let _e125 = out;
    return _e125;
}
...
fn evaluateShadowSurface(in_5: VsOut, frontFacing_2: bool) -> SurfaceData {
    ...
    let viewDirectionWS = normalize((_e10 - in_5.positionWS));
    let input_3 = SurfaceInput(in_5.positionOS, in_5.positionWS, in_5.normalWS, in_5.tangentWS, viewDirectionWS, in_5.surfaceUv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6And7_.xy, in_5.uv6And7_.zw, vec4(1f), frontFacing_2);
    let _e35 = sceneMaterials[in_5.materialIndex];
    let _e36 = evaluate_standard_surface(input_3, _e35);
    return _e36;
}
