...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_10 = clamp(_e13, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e54) * _e56), albedo, metallic_10);
    physicalNormal = n_2;
    ...
    let kD = ((vec3(1f) - _e69) * (1f - metallic_10));
    ...
    let _e176 = f0_;
    let _e177 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e174, v_2, _e175, metallic_10, a_2, _e176);
    let _e178 = color;
    ...
    let _e188 = f0_;
    let _e191 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e184, in_2.worldPos, _e186, v_2, _e187, metallic_10, a_2, _e188, false, true);
    color = (_e181 + _e191);
    let _e193 = color;
