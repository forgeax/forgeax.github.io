...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let v_2 = normalize((_e27 - in_1.worldPos));
    ...
    if (_e168 < 0f) {
        ...
        let _e197 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e171, v_2, iblRoughness, _e172, in_1.worldPos, vec3<f32>(_e176, _e179, _e182), _e186.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e197;
    } else {
    ...
    let _e506 = f0_;
    let _e509 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e502, in_1.worldPos, _e504, v_2, _e505, metallic_12, a_2, _e506, false, true);
    color = (_e499 + _e509);
    let _e511 = color;
