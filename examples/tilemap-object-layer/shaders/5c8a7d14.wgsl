...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e146 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, _e131, v, _e132, metallic_7, iblRoughness, _e133, _e135, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e138, _e139);
    ...
    let _e365 = standardViewZ(in_1);
    let _e366 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e363, in_1.worldPos, _e365);
    let _e367 = color;
    let _e371 = standardViewZ(in_1);
    let _e372 = physicalNormal;
    let _e373 = diffuseAlbedo;
    let _e374 = f0_;
    let _e375 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e371, _e372, v, _e373, metallic_7, a_4, _e374, _e366);
    color = (_e367 + _e375);
    let _e377 = color;
