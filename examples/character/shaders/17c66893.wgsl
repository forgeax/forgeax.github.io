...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let v = normalize((_e27 - in_1.worldPos));
    ...
    if (_e168 < 0f) {
        ...
        let _e197 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e171, v, iblRoughness, _e172, in_1.worldPos, vec3<f32>(_e176, _e179, _e182), _e186.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e197;
    } else {
...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e33 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e3 * _e5), _e9, _e10, baseColorTexture_1, baseColorTexture_sampler, _e13, _e16, in_4.currentClip, in_4.previousClip, _e21, 1f, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return _e33;
}
