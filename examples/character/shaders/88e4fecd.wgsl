...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_1: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            return (_e110 * modifier);
        }
        let _e124 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1);
...
fn evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(worldPosition_4: vec3<f32>, ndc_2: vec3<f32>, viewZ: f32, normal_14: vec3<f32>, direction_3: vec3<f32>, albedo_2: vec3<f32>, metallic_11: f32, alpha: f32, f0_4: vec3<f32>, shadow_1: f32) -> vec3<f32> {
    var direct: vec3<f32>;
    ...
    direct = _e25;
    let _e27 = direct;
    let _e32 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_2, viewZ, worldPosition_4, normal_14, direction_3, albedo_2, metallic_11, alpha, f0_4, false, true);
    direct = (_e27 + _e32);
    let _e34 = direct;
    return _e34;
}
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_3: u32, normal_16: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_7: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_11: vec3<f32>, layer_4: u32, count_4: u32, normal_17: vec3<f32>, l_1: vec3<f32>) -> f32 {
    var local_8: bool;
    var local_9: bool;
    var local_10: bool;
    var local_11: bool;
    ...
    let _e102 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4, normal_17, l_1, f32(((kernel / 2u) + 1u)));
    let adjustedDepth_1 = (currentDepth - _e102);
    if (kernel == 1u) {
        let lit_1 = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, clamp(uv_2, tileLo, tileHi), adjustedDepth_1);
        return lit_1;
    }
    if (kernel == 3u) {
        if all((uv_2 >= (tileLo + texel_2))) {
            local_12 = all((uv_2 <= (tileHi - texel_2)));
        } else {
            local_12 = false;
        }
        let interior = local_12;
        if interior {
            let pcfFraction = fract(((uv_2 / texel_2) - vec2(0.5f)));
            ...
            let litLoLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_2 + (vec2<f32>(loOffset.x, loOffset.y) * texel_2)), adjustedDepth_1);
            let litHiLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_2 + (vec2<f32>(hiOffset.x, loOffset.y) * texel_2)), adjustedDepth_1);
            let litLoHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_2 + (vec2<f32>(loOffset.x, hiOffset.y) * texel_2)), adjustedDepth_1);
            let litHiHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_2 + (vec2<f32>(hiOffset.x, hiOffset.y) * texel_2)), adjustedDepth_1);
            ...
            }
            {
                ...
                loop {
                    ...
                    }
                    {
                        let _e207 = x_2;
                        let _e209 = y_2;
                        let offsetUv_1 = clamp((uv_2 + (vec2<f32>(f32(_e207), f32(_e209)) * texel_2)), tileLo, tileHi);
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    let _e243 = x_3;
                    let _e245 = y_3;
                    let offsetUv_2 = clamp((uv_2 + (vec2<f32>(f32(_e243), f32(_e245)) * texel_2)), tileLo, tileHi);
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_18: vec3<f32>, worldPos_12: vec3<f32>, viewZ_1: f32) -> f32 {
    var shadow_2: f32;
    var local_13: bool;
    ...
    let receiverPosition = (worldPos_12 + (normal_18 * _e33));
...
fn resolveStandardDeferred(in_2: FullscreenOutputX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX) -> DeferredOutput {
    ...
    let ndc_3 = vec3<f32>(((uv_3 * vec2<f32>(2f, -2f)) + vec2<f32>(-1f, 1f)), depth);
    ...
    if (probeRow > 0u) {
        local_14 = ((base_1 + 9u) < arrayLength((&probeBlendRecords)));
    } else {
        local_14 = false;
    }
    let _e82 = local_14;
    ...
    let _e123 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(position, normal_19, direction_5, _e57.xyz, _e57.w, roughness_9, _e62.xyz, _e114, irradianceMap_2, linearSampler, prefilterMap_2, linearSampler, brdfLut_4, skylightPrefilterMap_1, _e115, _e116);
    let _e126 = params.x;
    if (_e126 > 0f) {
    ...
    let _e155 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_19, position, _e154);
    let _e160 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(position, ndc_3, _e154, normal_19, direction_5, _e57.xyz, _e57.w, (roughness_9 * roughness_9), _e62.xyz, _e155);
