...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e139 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e126, v, _e127, metallic_7, iblRoughness, _e128, _e130, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e131, _e132);
    ...
    let _e174 = ambient;
    color = _e174;
    let _e176 = physicalNormal;
    let _e178 = standardViewZ(in_2);
    let _e179 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e176, in_2.worldPos, _e178);
    let _e180 = color;
    let _e184 = standardViewZ(in_2);
    let _e185 = physicalNormal;
    let _e186 = diffuseAlbedo;
    let _e187 = f0_;
    let _e188 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e184, _e185, v, _e186, metallic_7, a_4, _e187, _e179);
    color = (_e180 + _e188);
    let _e190 = color;
    color = (_e190 + _e8.emissive);
    let _e195 = color;
    output.color = vec4<f32>(_e195, alpha_5);
    let _e198 = reflectionFallback;
    let _e199 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e198, _e199);
    let _e201 = output;
    return _e201;
}
