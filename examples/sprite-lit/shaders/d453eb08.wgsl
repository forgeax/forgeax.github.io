...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_12 = clamp(_e13, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e54) * _e56), albedo_2, metallic_12);
    physicalNormal = n_2;
    diffuseAlbedo = albedo_2;
    let _e64 = physicalNormal;
    let _e68 = f0_;
    let _e69 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e64, v_2), 0f), _e68);
    let kD_1 = ((vec3(1f) - _e69) * (1f - metallic_12));
    ...
    if (_e81 < 0f) {
        ...
        let _e110 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e84, v_2, iblRoughness, _e85, in_2.worldPos, vec3<f32>(_e89, _e92, _e95), _e99.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e110;
    } else {
        ...
        let _e129 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e120, v_2, iblRoughness, _e121, _e124, prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e129;
    }
    ...
    let _e239 = f0_;
    let _e242 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e235, in_2.worldPos, _e237, v_2, _e238, metallic_12, a_2, _e239, false, true);
    color = (_e232 + _e242);
    let _e244 = color;
