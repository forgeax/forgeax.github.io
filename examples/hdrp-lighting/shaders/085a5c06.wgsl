...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    if (_e85 < 0f) {
        ...
        let _e114 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e88, v_2, iblRoughness, _e89, in_1.worldPos, vec3<f32>(_e93, _e96, _e99), _e103.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e114;
    } else {
        ...
        let _e133 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e124, v_2, iblRoughness, _e125, _e128, prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e133;
    }
    ...
    let _e209 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e205, (_e206 * skyFactor), probeDiffuseK, _e208, metallic_12);
    ...
    let _e231 = f0_;
    let _e232 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e229, v_2, _e230, metallic_12, a_2, _e231);
    let _e233 = color;
    ...
    let _e243 = f0_;
    let _e246 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e239, in_1.worldPos, _e241, v_2, _e242, metallic_12, a_2, _e243, false, true);
    color = (_e236 + _e246);
    let _e248 = color;
