...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e9 = temporalVertexAlpha(in_4);
    let _e13 = material.alphaCutoff;
    let _e16 = material.alphaHash;
    let _e18 = standardUsesBaseColorTexture();
    let _e21 = material.baseColorTextureCoordinatesTransform;
    let _e24 = material.baseColorTextureCoordinatesMetadata;
    let _e25 = standardUsesAlphaTexture();
    let _e28 = material.alphaTextureCoordinatesTransform;
    let _e31 = material.alphaTextureCoordinatesMetadata;
    let _e34 = material.alphaChannel;
    let _e41 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e42 = reactive;
    let _e43 = motionValid;
    let _e56 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e8 * _e9), _e13, _e16, in_4.positionOS, _e18, baseColorTexture_1, baseColorTexture_sampler, _e21, _e24, _e25, alphaTexture_1, alphaTexture_sampler, _e28, _e31, _e34, in_4.currentClip, in_4.previousClip, _e41, _e42, _e43, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return vec4(1f);
}
