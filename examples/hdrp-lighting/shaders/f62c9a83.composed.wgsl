...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let metallic_5 = clamp(_e11, 0f, 1f);
    ...
    if (_e67 < 0f) {
        ...
        let _e96 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e70, v, iblRoughness, _e71, in_1.worldPos, vec3<f32>(_e75, _e78, _e81), _e85.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e96;
    } else {
    ...
    let _e160 = ambient;
    color = _e160;
    let _e162 = physicalNormal;
    let _e164 = standardViewZ(in_1);
    let _e165 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e162, in_1.worldPos, _e164);
    let _e166 = physicalNormal;
    let _e167 = diffuseAlbedo;
    let _e168 = f0_;
    let _e169 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e166, v, _e167, metallic_5, a_3, _e168);
    let _e170 = color;
    color = (_e170 + (_e165 * _e169));
    let _e173 = color;
    color = (_e173 + _e6.emissive);
    let _e178 = color;
    output.color = vec4<f32>(_e178, alpha_1);
    let _e181 = reflectionFallback;
    let _e182 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e181, _e182);
    let _e184 = output;
    return _e184;
}
