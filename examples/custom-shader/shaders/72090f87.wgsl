...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e455 = f0_;
    let _e458 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e451, in_1.worldPos, _e453, v_2, _e454, metallic_10, a_2, _e455, false, true);
    color = (_e448 + _e458);
    let _e460 = color;
