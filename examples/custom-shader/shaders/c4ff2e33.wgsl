...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e520 = f0_;
    let _e523 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e516, in_1.worldPos, _e518, v_2, _e519, metallic_13, a_3, _e520, false, true);
    color = (_e513 + _e523);
    let _e525 = color;
