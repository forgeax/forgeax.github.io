...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e63 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, _e48, v, _e49, metallic_7, iblRoughness, _e50, _e52, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e55, _e56);
    ...
    let _e98 = ambient;
    color = _e98;
    let _e100 = physicalNormal;
    let _e102 = standardViewZ(in_1);
    let _e103 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e100, in_1.worldPos, _e102);
    let _e104 = color;
    let _e108 = standardViewZ(in_1);
    let _e109 = physicalNormal;
    let _e110 = diffuseAlbedo;
    let _e111 = f0_;
    let _e112 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e108, _e109, v, _e110, metallic_7, a_4, _e111, _e103);
    color = (_e104 + _e112);
    let _e114 = color;
    color = (_e114 + _e5.emissive);
    let _e119 = color;
    output.color = vec4<f32>(_e119, alpha_5);
    let _e122 = reflectionFallback;
    let _e123 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e122, _e123);
    let _e125 = output;
    return _e125;
}
