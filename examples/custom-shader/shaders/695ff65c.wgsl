...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e64 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e49, v, _e50, metallic_7, iblRoughness, _e51, _e53, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e56, _e57);
    ...
    let _e99 = ambient;
    color = _e99;
    let _e101 = physicalNormal;
    let _e103 = standardViewZ(in_2);
    let _e104 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e101, in_2.worldPos, _e103);
    let _e105 = color;
    let _e109 = standardViewZ(in_2);
    let _e110 = physicalNormal;
    let _e111 = diffuseAlbedo;
    let _e112 = f0_;
    let _e113 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e109, _e110, v, _e111, metallic_7, a_4, _e112, _e104);
    color = (_e105 + _e113);
    let _e115 = color;
    color = (_e115 + _e8.emissive);
    let _e120 = color;
    output.color = vec4<f32>(_e120, alpha_5);
    let _e123 = reflectionFallback;
    let _e124 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e123, _e124);
    let _e126 = output;
    return _e126;
}
