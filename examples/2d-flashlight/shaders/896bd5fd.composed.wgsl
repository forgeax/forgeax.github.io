...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let metallic_14 = clamp(_e11, 0f, 1f);
    ...
    if (_e67 < 0f) {
        ...
        let _e96 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e70, v_5, iblRoughness, _e71, in_1.worldPos, vec3<f32>(_e75, _e78, _e81), _e85.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e96;
    } else {
    ...
    let _e257 = f0_;
    let _e260 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e253, in_1.worldPos, _e255, v_5, _e256, metallic_14, a_4, _e257, false, true);
    color = (_e250 + _e260);
    let _e262 = color;
