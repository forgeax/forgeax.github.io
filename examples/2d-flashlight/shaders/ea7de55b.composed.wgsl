...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let metallic_2 = clamp(_e13, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e54) * _e56), albedo, metallic_2);
    physicalNormal = n;
    ...
    let kD = ((vec3(1f) - _e69) * (1f - metallic_2));
    ...
    let _e176 = f0_;
    let _e177 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e174, v, _e175, metallic_2, a_2, _e176);
    let _e178 = color;
    color = (_e178 + (_e173 * _e177));
    let _e181 = color;
    return vec4<f32>(_e181, alpha);
}
