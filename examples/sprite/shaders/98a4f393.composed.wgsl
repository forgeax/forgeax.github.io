...
fn fs_temporal(in_3: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e5 = temporalVertexAlpha(in_3);
    ...
    let _e32 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e3 * _e5), _e9, baseColorTexture_1, baseColorSampler_1, _e12, _e15, in_3.currentClip, in_3.previousClip, _e20, 1f, in_3.uv, in_3.uv1_, in_3.uv2_, in_3.uv3_, in_3.uv4_, in_3.uv5_, in_3.uv6_, in_3.uv7_);
    return _e32;
}
