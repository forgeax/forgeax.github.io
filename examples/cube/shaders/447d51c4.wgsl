...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e281 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e277, (_e278 * skyFactor), probeDiffuseK, _e280, metallic_13);
    ...
    let _e504 = standardViewZ(in_2);
    let _e505 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e502, in_2.worldPos, _e504);
    let _e506 = physicalNormal;
    let _e507 = diffuseAlbedo;
    let _e508 = f0_;
    let _e509 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e506, v_2, _e507, metallic_13, a_3, _e508);
    let _e510 = color;
    color = (_e510 + (_e505 * _e509));
    let _e513 = color;
    let _e516 = standardViewZ(in_2);
    let _e518 = physicalNormal;
    let _e519 = diffuseAlbedo;
    let _e520 = f0_;
    let _e523 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e516, in_2.worldPos, _e518, v_2, _e519, metallic_13, a_3, _e520, false, true);
    color = (_e513 + _e523);
    let _e525 = color;
    color = (_e525 + _e7.emissive);
    let _e530 = color;
    output.color = vec4<f32>(_e530, alpha_1);
    let _e533 = reflectionFallback;
    let _e534 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e533, _e534);
    let _e536 = output;
    return _e536;
}
