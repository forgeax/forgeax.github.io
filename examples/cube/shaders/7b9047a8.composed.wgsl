...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    if (_e150 < 0f) {
        ...
        let _e179 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e153, v_2, iblRoughness, _e154, in_1.worldPos, vec3<f32>(_e158, _e161, _e164), _e168.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMap_1, prefilterSampler_1, brdfLut_3, brdfLutSampler_3);
        specularIbl = _e179;
    } else {
    ...
    let _e452 = standardViewZ(in_1);
    let _e453 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e450, in_1.worldPos, _e452);
    ...
    let _e461 = color;
    let _e464 = standardViewZ(in_1);
    let _e466 = physicalNormal;
    let _e467 = diffuseAlbedo;
    let _e468 = f0_;
    let _e471 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e464, in_1.worldPos, _e466, v_2, _e467, metallic_13, a_3, _e468, false, true);
    color = (_e461 + _e471);
    let _e473 = color;
...
fn fs_gbuffer(in_2: VsOut, @builtin(front_facing) frontFacing_1: bool) -> GBufferOutput {
    ...
    let _e35 = projectSpecularRadianceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(vec3(1f), n_3, normalize((_e28 - in_2.worldPos)), roughness_9, _e32, brdfLut_3, brdfLutSampler_3);
