...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_4: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_4 = max(dot(normal_4, l_2), 0f);
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_5: vec3<f32>, normal_8: vec3<f32>, viewDir_1: vec3<f32>, baseColor_1: vec3<f32>, metallic_1: f32, alphaSq_1: f32, F0_6: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_6 = max(dot(normal_8, l_4), 0f);
    let nDotV_3 = max(dot(normal_8, viewDir_1), 0.00001f);
    ...
    let diffuse_1 = (((1f - metallic_1) * baseColor_1) / vec3(3.1415927f));
...
fn evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2: vec3<f32>, colorTimesIntensity_1: vec3<f32>, invRangeSquared_3: f32, worldPos_6: vec3<f32>, normal_9: vec3<f32>, viewDir_2: vec3<f32>, baseColor_2: vec3<f32>, metallic_2: f32, alphaSq_2: f32, F0_7: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_2, colorTimesIntensity_1, invRangeSquared_3, worldPos_6, normal_9, viewDir_2, baseColor_2, metallic_2, alphaSq_2, F0_7);
    return _e10;
}
...
fn evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, lightDir_2: vec3<f32>, colorTimesIntensity_4: vec3<f32>, cosInner_2: f32, cosOuter_2: f32, invRangeSquared_7: f32, worldPos_9: vec3<f32>, normal_10: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_3: f32, alphaSq_3: f32, F0_8: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5, colorTimesIntensity_4, invRangeSquared_7, worldPos_9, normal_10, viewDir_3, baseColor_5, metallic_3, alphaSq_3, F0_8);
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_8: f32, worldPos_10: vec3<f32>, normal_11: vec3<f32>, viewDir_4: vec3<f32>, baseColor_6: vec3<f32>, metallic_4: f32, alphaSq_4: f32, F0_9: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_2: f32, normalBias_2: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    var local_22: bool;
    var local_23: bool;
    var local_24: bool;
    var local_25: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6, lightDir_3, colorTimesIntensity_5, cosInner_3, cosOuter_3, invRangeSquared_8, worldPos_10, normal_11, viewDir_4, baseColor_6, metallic_4, alphaSq_4, F0_9);
    ...
    let nDotL_7 = max(dot(normal_11, normalize((lightPos_6 - worldPos_10))), 0f);
...
fn ltcEdgeVectorFormFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(v1_: vec3<f32>, v2_: vec3<f32>) -> vec3<f32> {
    let x_3 = clamp(dot(v1_, v2_), -1f, 1f);
    let y_3 = abs(x_3);
    let a_2 = (0.8543985f + ((0.4965155f + (0.0145206f * y_3)) * y_3));
    let b = (3.417594f + ((4.1616726f + y_3) * y_3));
    let rational = (a_2 / b);
    let thetaOverSinTheta = select(((0.5f * inverseSqrt(max((1f - (x_3 * x_3)), 0.0000001f))) - rational), rational, (x_3 > 0f));
...
fn evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_10: vec3<f32>, lightColor: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_10: f32, worldPos_14: vec3<f32>, n_2: vec3<f32>, v_2: vec3<f32>, baseColor_7: vec3<f32>, metallic_5: f32, alphaSq_5: f32, F0_10: vec3<f32>) -> vec3<f32> {
    ...
    let diffuse_2 = (baseColor_7 * (1f - metallic_5));
...
fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_11: f32, worldPos_15: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_8: vec3<f32>, metallic_6: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_11, worldPos_15, n_3, v_3, baseColor_8, metallic_6, alphaSq_6, F0_11);
...
fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12: vec3<f32>, lightColor_2: vec3<f32>, axisX_3: vec3<f32>, axisY_3: vec3<f32>, halfWidth_3: f32, halfHeight_3: f32, invRangeSquared_12: f32, worldPos_16: vec3<f32>, n_4: vec3<f32>, v_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_7: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, lightColor_2, axisX_3, axisY_3, halfWidth_3, halfHeight_3, invRangeSquared_12, worldPos_16, n_4, v_4, baseColor_9, metallic_7, alphaSq_7, F0_12);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos: vec3<f32>, normal_12: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_2: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e27 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos, normal_12, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e27;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e84 {
            ...
            let _e102 = tile;
            let _e110 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_12, view_dir, base_color, metallic_8, alpha_sq, f0_2, _e101, _e102, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            return (_e110 * modifier);
        }
        let _e124 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_12, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return (_e124 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e142 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos, normal_12, view_dir, base_color, metallic_8, alpha_sq, f0_2);
        return _e142;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_1: vec3<f32>, normal_13: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_9: f32, alpha_sq_1: f32, f0_3: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_1, normal_13, view_dir_1, base_color_1, metallic_9, alpha_sq_1, f0_3, flat_2d_1, receive_shadows_1);
...
fn evaluate_standard_surface(input_2: SurfaceInput, materialValue: MaterialParameters) -> SurfaceData {
    ...
    let metallic_10 = clamp((materialValue.metallic * _e75), 0f, 1f);
    ...
    return SurfaceData(baseColor_10, _e106, metallic_10, roughness_9, emissive, occlusion, clamp(((materialValue.baseColor.w * _e110) * vertexColor.w), 0f, 1f), clamp(materialValue.alphaCutoff, 0f, 1f));
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let albedo = _e7.baseColor;
    let _e12 = finiteScalar(_e7.metallic, 0f);
    let metallic_11 = clamp(_e12, 0f, 1f);
    ...
    f0_ = mix(((vec3(dielectricF0_) * _e59) * _e61), albedo, metallic_11);
    physicalNormal = n_5;
    ...
    let transmittedEnergy = select(0f, ((transmissionFactor * (1f - metallic_11)) * (1f - fresnel_2)), (refractedLengthSquared > 0.000001f));
    diffuseAlbedo = (albedo * (1f - transmittedEnergy));
    let _e151 = physicalNormal;
    let _e155 = f0_;
    let _e156 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e151, v_5), 0f), _e155);
    let kD = ((vec3(1f) - _e156) * (1f - metallic_11));
    ...
    let _e245 = coatF;
    ambient = ((((kD * _e236) * _e238) + _e240) * (vec3(1f) - _e245));
    let environmentScale = (_e235 * ao);
    let _e250 = ambient;
    ambient = (_e250 * environmentScale);
    let _e252 = ambient;
    color = _e252;
    ...
    let _e325 = material.thickness;
    let _e327 = finiteScalar(_e325, 0f);
    let _e330 = thicknessSample;
    let _e332 = finiteScalar(_e330, 1f);
    let worldThickness = max(((_e327 * length(worldRefractedDirection)) * _e332), 0f);
    ...
    let _e374 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    let unrefractedBackdrop = _e374.xyz;
    ...
    let _e382 = local_1;
    if _e382 {
        let _e390 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
        transmittedBackdrop = _e390.xyz;
    }
    let _e394 = material.attenuationColor;
    let _e397 = finiteColor(_e394, vec3(1f));
    let safeAttenuationColor = clamp(_e397, vec3(0f), vec3(1f));
    let _e405 = material.attenuationDistance;
    let _e407 = finiteScalar(_e405, 0f);
    let safeAttenuationDistance = max(_e407, 0f);
    ...
    let _e424 = local_2;
    let beerAttenuation = select(vec3(1f), pow(safeAttenuationColor, vec3(attenuationExponent)), _e424);
    let _e426 = color;
    let _e427 = transmittedBackdrop;
    let _e430 = finiteColor(_e427, vec3(0f));
    color = (_e426 + ((_e430 * transmittedEnergy) * beerAttenuation));
    let _e434 = color;
    color = (_e434 + _e7.emissive);
    let _e437 = physicalNormal;
    let _e439 = standardViewZ(in_2);
    let _e440 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e437, in_2.worldPos, _e439);
    let _e441 = physicalNormal;
    let _e442 = diffuseAlbedo;
    let _e443 = f0_;
    let _e444 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e441, v_5, _e442, metallic_11, a_3, _e443);
    let _e445 = color;
    color = (_e445 + (_e440 * _e444));
    let _e448 = color;
    let _e451 = standardViewZ(in_2);
    let _e453 = physicalNormal;
    let _e454 = diffuseAlbedo;
    let _e455 = f0_;
    let _e458 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e451, in_2.worldPos, _e453, v_5, _e454, metallic_11, a_3, _e455, false, true);
    color = (_e448 + _e458);
    let _e460 = color;
    return vec4<f32>(_e460, alpha);
}
...
fn fs_gbuffer(in_3: VsOut, @builtin(front_facing) frontFacing_1: bool) -> GBufferOutput {
    ...
    let metallic_12 = clamp(_e2.metallic, 0f, 1f);
    ...
    out.albedo_metallic = vec4<f32>(albedo_1, metallic_12);
