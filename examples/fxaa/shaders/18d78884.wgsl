...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e63 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, _e48, v_2, _e49, metallic_15, iblRoughness, _e50, _e52, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e55, _e56);
    ...
    let _e122 = f0_;
    let _e123 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e119, _e120, v_2, _e121, metallic_15, a_4, _e122, _e114);
    color = (_e115 + _e123);
    let _e125 = color;
    color = (_e125 + _e5.emissive);
    let _e130 = color;
    output.color = vec4<f32>(_e130, alpha_5);
