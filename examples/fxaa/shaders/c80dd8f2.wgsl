...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e180 = f0_;
    let _e181 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e178, v_5, _e179, metallic_11, a_3, _e180);
    let _e182 = color;
    color = (_e182 + (_e177 * _e181));
    let _e185 = color;
    let _e188 = standardViewZ(in_1);
    let _e190 = physicalNormal;
    let _e191 = diffuseAlbedo;
    let _e192 = f0_;
    let _e195 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e188, in_1.worldPos, _e190, v_5, _e191, metallic_11, a_3, _e192, false, true);
    color = (_e185 + _e195);
    let _e197 = color;
    return vec4<f32>(_e197, alpha);
}
