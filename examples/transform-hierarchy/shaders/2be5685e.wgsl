...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e65 = material.specularTint;
    let _e68 = material.specularTintUvScale;
    let _e71 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(specularTintTexture, specularTintSampler, _e2, _e68);
    let specularTint = (_e65 * _e71.xyz);
    let f0_1 = mix((vec3(0.04f) * specularTint), albedo, metallic_5);
    let _e80 = material.clearcoatRoughness;
    let coatRoughness = max(_e80, 0.04f);
    let coatAlpha = (coatRoughness * coatRoughness);
    let _e89 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e56, v), 0f), vec3(0.04f));
    let _e92 = material.clearcoat;
    let coatF = (_e89 * _e92);
    let _e99 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e56, v), 0f), f0_1);
    let kD = ((vec3(1f) - _e99) * (1f - metallic_5));
    let _e106 = material.roughness;
    let iblRoughness = (max(_e106, 0.04f) * _e34);
    let _e112 = skylight.rotation;
    let _e115 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, _e112, irradianceMap_1, irradianceSampler_1);
    let _e118 = skylight.rotation;
    let _e123 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, v, iblRoughness, f0_1, _e118, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e128 = skylight.rotation;
    let _e133 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e56, v, coatRoughness, vec3(0.04f), _e128, prefilterMap_1, prefilterSampler_1, brdfLut_1, brdfLutSampler_1);
    let _e136 = skylight.colorR;
    let _e139 = skylight.colorG;
    let _e142 = skylight.colorB;
    let skyColor = vec3<f32>(_e136, _e139, _e142);
    let _e153 = material.clearcoat;
    let _e159 = skylight.intensity;
    let ambient = (((((((kD * _e115) * albedo) + _e123) * (vec3(1f) - coatF)) + (_e133 * _e153)) * skyColor) * _e159);
    color = ambient;
    let _e162 = color;
    let _e163 = a;
    let _e166 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e56, v, albedo, metallic_5, _e163, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e162 + _e166);
    let _e168 = color;
    let _e171 = material.clearcoat;
    let _e179 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e168 + (_e171 * _e179));
    ...
    loop {
        ...
        {
            let _e190 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e190];
            let _e193 = color;
            let _e198 = a;
            let _e199 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_5, _e198, f0_1);
            color = (_e193 + _e199);
            let _e201 = color;
            let _e204 = material.clearcoat;
            let _e214 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e201 + (_e204 * _e214));
        }
        continuing {
            let _e217 = i;
            i = (_e217 + 1u);
    ...
    loop {
        ...
        {
            let _e228 = i_1;
            let s = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e228];
            let _e231 = color;
            let _e239 = a;
            let _e240 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, albedo, metallic_5, _e239, f0_1);
            color = (_e231 + _e240);
            let _e242 = color;
            let _e245 = material.clearcoat;
            let _e258 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e56, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e242 + (_e245 * _e258));
        }
        continuing {
            let _e261 = i_1;
            i_1 = (_e261 + 1u);
    ...
    let _e264 = color;
    let _e268 = material.baseColor.w;
    return vec4<f32>(_e264, (_e268 * _e8.w));
}
