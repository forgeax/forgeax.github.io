...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e189 = standardViewZ(in_1);
    let _e190 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e187, in_1.worldPos, _e189);
    ...
    let _e198 = color;
    let _e201 = standardViewZ(in_1);
    let _e203 = physicalNormal;
    let _e204 = diffuseAlbedo;
    let _e205 = f0_;
    let _e208 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.ndc.xyz, _e201, in_1.worldPos, _e203, v_2, _e204, metallic_13, a_3, _e205, false, true);
    color = (_e198 + _e208);
    let _e210 = color;
    color = (_e210 + _e6.emissive);
    let _e215 = color;
    output.color = vec4<f32>(_e215, alpha_1);
    let _e218 = reflectionFallback;
    let _e219 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e218, _e219);
    let _e221 = output;
    return _e221;
}
