...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e174;
    let _e176 = color;
    color = (_e176 + _e8.emissive);
    let _e179 = physicalNormal;
    let _e181 = standardViewZ(in_2);
    let _e182 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e179, in_2.worldPos, _e181);
    let _e183 = color;
    let _e187 = standardViewZ(in_2);
    let _e188 = physicalNormal;
    let _e189 = diffuseAlbedo;
    let _e190 = f0_;
    let _e191 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e187, _e188, v, _e189, metallic_7, a_3, _e190, _e182);
    color = (_e183 + _e191);
    let _e195 = color;
    output.color = vec4<f32>(_e195, alpha_4);
