...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e99;
    let _e101 = color;
    color = (_e101 + _e8.emissive);
    let _e104 = physicalNormal;
    let _e106 = standardViewZ(in_2);
    let _e107 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e104, in_2.worldPos, _e106);
    let _e108 = color;
    let _e112 = standardViewZ(in_2);
    let _e113 = physicalNormal;
    let _e114 = diffuseAlbedo;
    let _e115 = f0_;
    let _e116 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e112, _e113, v, _e114, metallic_7, a_3, _e115, _e107);
    color = (_e108 + _e116);
    let _e120 = color;
    output.color = vec4<f32>(_e120, alpha_4);
