...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let kD_2 = ((vec3(1f) - _e63) * (1f - metallic_5));
    ...
    let _e134 = color;
    let _e135 = a;
    let _e138 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e48, v, albedo, metallic_5, _e135, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e134 + _e138);
    let _e140 = color;
    let _e144 = a;
    let _e145 = evaluate_cluster_lightsX_naga_oil_mod_XMZXXEZ3FMF4F62DEOJYDUOTDNR2XG5DFOJPWM33SO5QXEZAX(in_1.ndc, in_1.viewZ, in_1.worldPos, _e48, v, albedo, metallic_5, _e144);
    color = (_e140 + _e145);
