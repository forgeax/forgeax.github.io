...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e417 = color;
    color = (_e417 + _e6.emissive);
    let _e420 = physicalNormal;
    let _e422 = standardViewZ(in_1);
    let _e423 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e420, in_1.worldPos, _e422);
    let _e424 = color;
    let _e428 = standardViewZ(in_1);
    let _e429 = physicalNormal;
    let _e430 = diffuseAlbedo;
    let _e431 = f0_;
    let _e432 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e428, _e429, v, _e430, metallic_7, a_3, _e431, _e423);
    color = (_e424 + _e432);
    let _e436 = color;
    output.color = vec4<f32>(_e436, alpha_4);
