...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e193 = f0_;
    let _e194 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e191, v_5, _e192, metallic_14, a_4, _e193);
    let _e195 = color;
    ...
    let _e205 = f0_;
    let _e208 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, _e201, in_2.worldPos, _e203, v_5, _e204, metallic_14, a_4, _e205, false, true);
    color = (_e198 + _e208);
    let _e210 = color;
