...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let kD = ((vec3(1f) - _e132) * (1f - metallic_6));
    ...
    ambient = ((((((((kD * _e148) * albedo) + _e156) * (vec3(1f) - coatF)) + (_e166 * _e204)) * skyColor) * _e210) * ao);
    let _e214 = ambient;
    color = _e214;
    let _e216 = color;
    let _e217 = a;
    let _e220 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e83, v, albedo, metallic_6, _e217, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e216 + _e220);
    let _e222 = color;
    let _e225 = material.clearcoat;
    let _e233 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e83, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), in_1.worldPos, in_1.viewZ);
    color = (_e222 + (_e225 * _e233));
    ...
    loop {
        ...
        {
            let _e244 = i;
            let p = pointLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e244];
            let _e247 = color;
            let _e252 = a;
            let _e253 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e83, v, albedo, metallic_6, _e252, f0_1);
            color = (_e247 + _e253);
            let _e255 = color;
            let _e258 = material.clearcoat;
            let _e268 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e83, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
            color = (_e255 + (_e258 * _e268));
        }
        continuing {
            let _e271 = i;
            i = (_e271 + 1u);
    ...
    loop {
        ...
        {
            let _e282 = i_1;
            let s_1 = spotLightsBufferX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.slots[_e282];
            if (s_1.shadowAtlasTile >= 0i) {
                let _e288 = color;
                let _e296 = a;
                let _e301 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_1.shadowAtlasTile];
                let _e305 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e83, v, albedo, metallic_6, _e296, f0_1, _e301, s_1.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e288 + _e305);
                let _e307 = color;
                let _e310 = material.clearcoat;
                let _e326 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[s_1.shadowAtlasTile];
                let _e331 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e83, v, vec3(0f), 1f, coatAlpha, vec3(0.04f), _e326, s_1.shadowAtlasTile, 0.005f, 0.05f);
                color = (_e307 + (_e310 * _e331));
            } else {
                let _e334 = color;
                let _e342 = a;
                let _e343 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e83, v, albedo, metallic_6, _e342, f0_1);
                color = (_e334 + _e343);
                let _e345 = color;
                let _e348 = material.clearcoat;
                let _e361 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s_1.position, s_1.direction, s_1.colorTimesIntensity, s_1.cosInner, s_1.cosOuter, s_1.invRangeSquared, in_1.worldPos, _e83, v, vec3(0f), 1f, coatAlpha, vec3(0.04f));
                color = (_e345 + (_e348 * _e361));
            }
        }
        continuing {
            let _e364 = i_1;
    ...
    let _e369 = material.emissiveCoordinates;
    let _e370 = transformedMaterialUv(_e369, in_1);
    let _e374 = material.emissiveCoordinates.metadata;
    let _e378 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTexture, emissiveSampler, _e370, _e374.zw);
    let emissiveSample = _e378.xyz;
    let _e380 = color;
    let _e383 = material.emissive;
    let _e386 = material.emissiveIntensity;
    color = (_e380 + ((_e383 * _e386) * emissiveSample));
    let _e390 = color;
    let _e394 = material.baseColor.w;
    return vec4<f32>(_e390, (_e394 * _e13.w));
}
