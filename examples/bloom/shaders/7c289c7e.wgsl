...
fn fs_main(in_1: VsOut) -> @location(0) vec4<f32> {
    ...
    let _e115 = color;
    let _e116 = a;
    let _e119 = evalDirectionalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e49, v, albedo, metallic_4, _e116, f0_1, in_1.worldPos, in_1.viewZ);
    color = (_e115 + _e119);
    ...
    loop {
        ...
        }
        {
            ...
            let _e132 = color;
            let _e137 = a;
            let _e138 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(p.position, p.colorTimesIntensity, p.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_4, _e137, f0_1);
            color = (_e132 + _e138);
        }
        continuing {
            let _e140 = i;
    ...
    loop {
        ...
        }
        {
            ...
            let _e154 = color;
            let _e162 = a;
            let _e163 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(s.position, s.direction, s.colorTimesIntensity, s.cosInner, s.cosOuter, s.invRangeSquared, in_1.worldPos, _e49, v, albedo, metallic_4, _e162, f0_1);
            color = (_e154 + _e163);
        }
        continuing {
            let _e165 = i_1;
    ...
    let _e171 = textureSample(emissiveTexture, emissiveSampler, in_1.uv);
    let emissiveSample = _e171.xyz;
    let _e173 = color;
    let _e176 = material.emissive;
    let _e179 = material.emissiveIntensity;
    color = (_e173 + ((_e176 * _e179) * emissiveSample));
    let _e183 = color;
    let _e187 = material.baseColor.w;
    return vec4<f32>(_e183, (_e187 * baseSample.w));
}
