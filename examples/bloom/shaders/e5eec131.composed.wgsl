...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e463 = f0_;
    let _e464 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e460, _e461, v_2, _e462, metallic_15, a_3, _e463, _e455);
    color = (_e456 + _e464);
    let _e468 = color;
    output.color = vec4<f32>(_e468, alpha_4);
...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e19 = temporalVertexAlpha(in_5);
    ...
    let _e62 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e18 * _e19), _e23, _e26, in_5.positionOS, _e28, baseColorTexture_1, baseColorTexture_sampler, _e31, _e34, _e35, alphaTexture_1, alphaTexture_sampler, _e38, _e41, _e44, in_5.currentClip, in_5.previousClip, _e49, reactive_3, motionValid_2, in_5.uv, in_5.uv1_, in_5.uv2_, in_5.uv3_, in_5.uv4_, in_5.uv5_, in_5.uv6_, in_5.uv7_);
    return _e62;
}
