...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e146 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e131, v_2, _e132, metallic_15, iblRoughness, _e133, _e135, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e138, _e139);
    ...
    let _e385 = f0_;
    let _e386 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e382, _e383, v_2, _e384, metallic_15, a_4, _e385, _e377);
    color = (_e378 + _e386);
    let _e388 = color;
    color = (_e388 + _e6.emissive);
    let _e393 = color;
    output.color = vec4<f32>(_e393, alpha_5);
