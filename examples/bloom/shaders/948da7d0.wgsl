...
fn fs_temporal(in_5: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    return vec4(1f);
    let _e45 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.x;
    reactive = _e45;
    let _e51 = meshesX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[0].temporal.y;
    motionValid = (_e51 >= 0.5f);
    let _e59 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e60 = reactive;
    let _e61 = motionValid;
    let _e62 = packSceneTemporalV1WithValidityX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(in_5.currentClip, in_5.previousClip, _e59, _e60, _e61);
    return _e62;
}
