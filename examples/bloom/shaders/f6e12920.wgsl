...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> @location(0) vec4<f32> {
    ...
    let _e209 = composeProbeDiffuse(probeShPreblend, probeLocalBlendFraction, _e205, (_e206 * skyFactor), probeDiffuseK, _e208, metallic_4);
    ...
    let _e231 = f0_;
    let _e232 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e229, v, _e230, metallic_4, a_2, _e231);
    let _e233 = color;
    color = (_e233 + (_e228 * _e232));
    let _e236 = color;
    return vec4<f32>(_e236, alpha);
}
