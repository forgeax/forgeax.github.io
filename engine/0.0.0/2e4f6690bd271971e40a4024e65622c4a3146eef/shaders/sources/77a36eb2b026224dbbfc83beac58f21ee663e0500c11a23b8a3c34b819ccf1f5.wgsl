...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e112 = f0_;
    let _e113 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e109, _e110, v, _e111, metallic_7, a_3, _e112, _e104);
    color = (_e105 + _e113);
    let _e115 = color;
    color = (_e115 + _e8.emissive);
    let _e120 = color;
    output.color = vec4<f32>(_e120, alpha_3);
