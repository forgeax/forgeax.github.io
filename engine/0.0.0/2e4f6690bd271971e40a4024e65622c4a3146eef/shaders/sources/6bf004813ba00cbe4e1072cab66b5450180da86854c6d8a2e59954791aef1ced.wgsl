...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e190 = f0_;
    let _e191 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e187, _e188, v, _e189, metallic_7, a_2, _e190, _e182);
    color = (_e183 + _e191);
    let _e195 = color;
