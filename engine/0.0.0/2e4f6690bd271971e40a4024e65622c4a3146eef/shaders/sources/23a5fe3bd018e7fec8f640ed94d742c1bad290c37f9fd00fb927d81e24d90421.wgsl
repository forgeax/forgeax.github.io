...
@group(0) @binding(11) 
var projectorTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX: texture_2d<f32>;
@group(0) @binding(12) 
var projectorSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX: sampler;
@group(2) @binding(6) 
...
fn evaluateProbeDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX(shPreblend_1: array<vec4<f32>, 9>, localBlendFraction: f32, normal_1: vec3<f32>, e_sky: vec3<f32>, k_d: vec3<f32>, albedo: vec3<f32>, metallic: f32) -> vec3<f32> {
    ...
    let local_39 = (max(_e2, vec3(0f)) * PROBE_INV_PIX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX);
    let skyResidualFraction = (1f - localBlendFraction);
    return ((((local_39 + (skyResidualFraction * e_sky)) * k_d) * albedo) * (1f - metallic));
}
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_2: vec3<f32>, normal_6: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic_1: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_6, nDotV_2, nDotL_5, F0_5);
...
fn sampleStandardSpotProjectorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXG4DPORPXA4TPNJSWG5DPOIX(lightViewProj_2: mat4x4<f32>, world_pos: vec3<f32>, metadata_1: vec4<u32>) -> vec3<f32> {
    ...
    let _e33 = textureSampleLevel(projectorTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, projectorSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, _e2, 0f);
    return _e33.xyz;
}

fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_9: vec3<f32>, lightColor: vec3<f32>, axisX: vec3<f32>, axisY: vec3<f32>, halfWidth: f32, halfHeight: f32, invRangeSquared_10: f32, worldPos_10: vec3<f32>, n: vec3<f32>, v: vec3<f32>, baseColor_7: vec3<f32>, metallic_6: f32, alphaSq_5: f32, F0_10: vec3<f32>) -> vec3<f32> {
    return vec3(0f);
}

fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_10: vec3<f32>, lightColor_1: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_11: f32, worldPos_11: vec3<f32>, n_1: vec3<f32>, v_1: vec3<f32>, baseColor_8: vec3<f32>, metallic_7: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_10, lightColor_1, axisX_1, axisY_1, halfWidth_1, halfHeight_1, invRangeSquared_11, worldPos_11, n_1, v_1, baseColor_8, metallic_7, alphaSq_6, F0_11);
    return _e14;
}
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_8: f32, alpha_sq: f32, f0_1: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    var local_8: bool;
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        if _e25 {
            ...
            let _e44 = evalPointShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1, layer_8, shadow_2.x, shadow_2.y, shadow_2.z, shadow_2.w);
            return _e44;
        }
        let _e51 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1);
        return _e51;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        tile = encoded_tile;
        if (encoded_tile >= 0i) {
            local_9 = ((encoded_tile & PROJECTOR_FLAGX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) != 0i);
        } else {
            local_9 = false;
        }
        let _e94 = local_9;
        ...
        if _e108 {
            ...
            let _e126 = tile;
            let _e133 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1, _e125, _e126, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            let _e139 = tile;
        ...
        let _e159 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1);
        return (_e159 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e177 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_8, alpha_sq, f0_1);
        return _e177;
    }
    return vec3(0f);
}

fn evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(ndc_1: vec3<f32>, view_z_2: f32, world_pos_2: vec3<f32>, normal_12: vec3<f32>, view_dir_1: vec3<f32>, base_color_1: vec3<f32>, metallic_9: f32, alpha_sq_1: f32, f0_2: vec3<f32>, flat_2d_1: bool, receive_shadows_1: bool) -> vec3<f32> {
    ...
    loop {
        ...
        }
        {
            ...
            let _e70 = evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light_1, world_pos_2, normal_12, view_dir_1, base_color_1, metallic_9, alpha_sq_1, f0_2, flat_2d_1, receive_shadows_1);
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_13: vec3<f32>, viewDir_5: vec3<f32>, baseColor_9: vec3<f32>, metallic_10: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    ...
    let nDotV_3 = max(dot(normal_13, viewDir_5), 0.00001f);
    ...
    let roughness_7 = sqrt(max(alphaSq_7, 0f));
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_7, nDotV_3, nDotL_8, F0_12);
    let _e32 = d_ggxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(nDotH_2, alphaSq_7);
    let _e33 = v_smithX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(nDotV_3, nDotL_8, alphaSq_7);
    let specular_1 = (((_e32 * _e33) * _e26) + _e31);
    let diffuse_1 = (((1f - metallic_10) * baseColor_9) / vec3(3.1415927f));
    let _e48 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.lightColor;
    return (((diffuse_1 + specular_1) * _e48) * nDotL_8);
}
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5: u32, normal_14: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    ...
    let slope = ((abs(dot(normal_14, right)) + abs(dot(normal_14, up))) / nDotL_9);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_12: vec3<f32>, layer_6: u32, count_4: u32, normal_15: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_12: bool;
    var local_13: bool;
    var local_14: bool;
    var local_15: bool;
    ...
    if (tileUv.x >= 0f) {
        local_13 = (tileUv.x <= 1f);
    } else {
        local_13 = false;
    }
    let _e46 = local_13;
    if _e46 {
        local_14 = (tileUv.y >= 0f);
    } else {
        local_14 = false;
    }
    let _e53 = local_14;
    if _e53 {
        local_15 = (tileUv.y <= 1f);
    } else {
        local_15 = false;
    }
    let _e60 = local_15;
    if _e60 {
        local_16 = (projCoords.z >= 0f);
    } else {
        local_16 = false;
    }
    let _e67 = local_16;
    if _e67 {
        local_17 = (projCoords.z <= 1f);
    } else {
        local_17 = false;
    }
    let _e74 = local_17;
    ...
    if (lightDepthWorldSpan > 0f) {
        local_21 = (worldUnitsPerTexel > 0f);
    } else {
        local_21 = false;
    }
    let _e213 = local_21;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_13: vec3<f32>, layer_7: u32, count_5: u32, normal_16: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_24: bool;
    var local_25: bool;
    var local_26: bool;
    var local_27: bool;
    ...
    if (tileUv_1.x >= 0f) {
        local_24 = (tileUv_1.x <= 1f);
    } else {
        local_24 = false;
    }
    let _e40 = local_24;
    if _e40 {
        local_25 = (tileUv_1.y >= 0f);
    } else {
        local_25 = false;
    }
    let _e47 = local_25;
    if _e47 {
        local_26 = (tileUv_1.y <= 1f);
    } else {
        local_26 = false;
    }
    let _e54 = local_26;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_13, layer_7, count_5, normal_16, l_2, filterProfile);
        return _e90;
    }
    ...
    if (kernel == 3u) {
        if all((uv_6 >= (tileLo + texel_5))) {
            local_28 = all((uv_6 <= (tileHi - texel_5)));
        } else {
            local_28 = false;
        }
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_17: vec3<f32>, worldPos_14: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_29: bool;
    ...
    let receiverPosition = (worldPos_14 + (normal_17 * _e33));
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_30 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_30 = false;
    }
    let _e10 = local_30;
    if _e10 {
        local_31 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_31 = false;
    }
    let _e17 = local_31;
    if _e17 {
        local_32 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_32 = false;
    }
    let validReceiver = local_32;
    ...
    if all((uv_7 >= vec2(0f))) {
        local_33 = all((uv_7 <= vec2(1f)));
    } else {
        local_33 = false;
    }
    let inRange = local_33;
    if (shadowProjection.y > 0.5f) {
        local_34 = (shadowProjection.z < 0.5f);
    } else {
        local_34 = false;
    }
    let _e64 = local_34;
    if _e64 {
        local_35 = (shadowProjection.x > 0f);
    } else {
        local_35 = false;
    }
    let available = local_35;
...
fn evaluateStandardSurfaceX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX(in_2: VsOutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, factors: StandardSurfaceFactorsX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX) -> StandardPbrOutputX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX {
    ...
    let v_2 = normalize((_e111 - in_2.worldPos));
    ...
    let _e161 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e108, v_2), 0f), vec3(0.04f));
    let coatF = (_e161 * factors.clearcoat);
    let _e169 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(max(dot(_e108, v_2), 0f), f0_3);
    ...
    if (_e185 < 0f) {
        ...
        let _e256 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, v_2, iblRoughness, f0_3, _e251, prefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, prefilterSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, brdfLutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
        specularIbl = _e256;
    }
    ...
    let _e425 = a_2;
    let _e426 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, v_2, _e424, metallic_11, _e425, f0_3);
    let _e427 = color;
    ...
    color = (_e427 + _e445);
    if (factors.clearcoat != 0f) {
        let _e455 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, v_2, vec3(0f), 1f, coatAlpha, vec3(0.04f));
        let _e456 = color;
    ...
    let _e484 = a_2;
    let _e487 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, in_2.viewZ, in_2.worldPos, _e108, v_2, _e483, metallic_11, _e484, f0_3, false, factors.receiveShadows);
    color = (_e478 + _e487);
    if (factors.clearcoat != 0f) {
        let _e492 = color;
        let _e505 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, in_2.viewZ, in_2.worldPos, _e108, v_2, vec3(0f), 1f, coatAlpha, vec3(0.04f), false, factors.receiveShadows);
...
fn vs_main(input: VertexInput) -> VertexOutput {
    ...
    let _e102 = safeNormalize((tangent - (_e92 * dot(_e94, tangent))), vec3<f32>(1f, 0f, 0f));
