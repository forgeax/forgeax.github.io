...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e379 = standardViewZ(in_2);
    let _e380 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e377, in_2.worldPos, _e379);
    let _e381 = color;
    let _e385 = standardViewZ(in_2);
    let _e386 = physicalNormal;
    let _e387 = diffuseAlbedo;
    let _e388 = f0_;
    let _e389 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e385, _e386, v_5, _e387, metallic_17, a_3, _e388, _e380);
    color = (_e381 + _e389);
    let _e393 = color;
    output.color = vec4<f32>(_e393, alpha_2);
