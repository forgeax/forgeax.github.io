...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e146 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e131, v_5, _e132, metallic_17, iblRoughness, _e133, _e135, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e138, _e139);
    ...
    let _e187 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e184, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e188 = ambient;
    ambient = (_e188 * _e187);
    ...
    let _e314 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(screenUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e322 = local_1;
    if _e322 {
        let _e330 = textureSampleLevel(transmissionBackdropTexture, transmissionBackdropSampler, clamp(refractedUv, vec2(0f), vec2(1f)), backdropLod);
    ...
    let _e374 = physicalNormal;
    let _e376 = standardViewZ(in_2);
    let _e377 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e374, in_2.worldPos, _e376);
    let _e378 = color;
    let _e382 = standardViewZ(in_2);
    let _e383 = physicalNormal;
    let _e384 = diffuseAlbedo;
    let _e385 = f0_;
    let _e386 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e382, _e383, v_5, _e384, metallic_17, a_4, _e385, _e377);
    color = (_e378 + _e386);
    let _e388 = color;
    color = (_e388 + _e6.emissive);
    let _e393 = color;
    output.color = vec4<f32>(_e393, alpha_3);
    let _e396 = reflectionFallback;
    let _e397 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e396, _e397);
    let _e399 = output;
    return _e399;
}
