...
fn vs_main(input: VertexInput) -> VertexOutput {
    ...
    let _e65 = safeNormalize((handedness * (((normalBasisX * input.geometry_normal.x) + (normalBasisY * input.geometry_normal.y)) + (normalBasisZ * input.geometry_normal.z))), vec3<f32>(0f, 1f, 0f));
    output.normal = _e65;
    ...
    let _e84 = output.normal;
    let _e92 = safeNormalize((tangent_1 - (_e82 * dot(_e84, tangent_1))), vec3<f32>(1f, 0f, 0f));
    output.tangent = vec4<f32>(_e92, (input.geometry_tangent.w * handedness));
