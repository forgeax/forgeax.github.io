...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e374 = f0_;
    let _e375 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e371, _e372, v, _e373, metallic_7, a_3, _e374, _e366);
    color = (_e367 + _e375);
    let _e377 = color;
    color = (_e377 + _e6.emissive);
    let _e382 = color;
    output.color = vec4<f32>(_e382, alpha_3);
