...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e109;
    let _e111 = color;
    color = (_e111 + _e5.emissive);
    let _e114 = physicalNormal;
    let _e116 = standardViewZ(in_1);
    let _e117 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e114, in_1.worldPos, _e116);
    let _e118 = color;
    let _e122 = standardViewZ(in_1);
    let _e123 = physicalNormal;
    let _e124 = diffuseAlbedo;
    let _e125 = f0_;
    let _e126 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e122, _e123, v_5, _e124, metallic_17, a_3, _e125, _e117);
    color = (_e118 + _e126);
    let _e130 = color;
    output.color = vec4<f32>(_e130, alpha_2);
