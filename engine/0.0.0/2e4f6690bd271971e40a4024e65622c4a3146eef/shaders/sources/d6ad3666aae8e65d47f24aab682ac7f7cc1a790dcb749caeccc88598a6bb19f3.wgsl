...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e111 = f0_;
    let _e112 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e108, _e109, v, _e110, metallic_7, a_3, _e111, _e103);
    color = (_e104 + _e112);
    let _e114 = color;
    color = (_e114 + _e5.emissive);
    let _e119 = color;
    output.color = vec4<f32>(_e119, alpha_3);
