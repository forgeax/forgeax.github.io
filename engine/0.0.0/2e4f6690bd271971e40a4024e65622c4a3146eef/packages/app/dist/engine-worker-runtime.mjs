      ...
      worker.postMessage(
        {
          ...
          ...this.init.shaderIndexUrl === void 0 ? {} : { shaderIndexUrl: this.init.shaderIndexUrl },
          ...this.init.shaderRequirementsUrl === void 0 ? {} : { shaderRequirementsUrl: this.init.shaderRequirementsUrl },
          ...this.init.shaderManifestDeltaUrl === void 0 ? {} : { shaderManifestDeltaUrl: this.init.shaderManifestDeltaUrl },
...
async function createRealm(init) {
  ...
  try {
    ...
    const bundler = init.shaderManifestUrl === void 0 && init.shaderIndexUrl === void 0 && init.shaderRequirementsUrl === void 0 && init.shaderManifestDeltaUrl === void 0 && init.build === void 0 && runtimeBinding === void 0 ? void 0 : {
      ...init.shaderManifestUrl === void 0 ? {} : { shaderManifestUrl: init.shaderManifestUrl },
      ...init.shaderIndexUrl === void 0 ? {} : { shaderIndexUrl: init.shaderIndexUrl },
      ...init.shaderRequirementsUrl === void 0 ? {} : { shaderRequirementsUrl: init.shaderRequirementsUrl },
      ...init.shaderManifestDeltaUrl === void 0 ? {} : { shaderManifestDeltaUrl: init.shaderManifestDeltaUrl },
