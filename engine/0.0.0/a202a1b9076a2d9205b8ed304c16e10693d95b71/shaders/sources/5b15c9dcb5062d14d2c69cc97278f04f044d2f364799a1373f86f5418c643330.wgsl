...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e126 = f0_;
    let _e127 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e123, _e124, v_2, _e125, metallic_16, a_2, _e126, _e118);
    color = (_e119 + _e127);
    let _e131 = color;
