...
fn sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_5: vec3<f32>, view_2: vec3<f32>, roughness_3: f32, F0_3: vec3<f32>, worldPosition_1: vec3<f32>, boxCenter_1: vec3<f32>, boxExtents_1: vec3<f32>, rotation_3: vec4<f32>, probeMap: texture_cube<f32>, probeSampler: sampler, brdfLut_2: texture_2d<f32>, brdfLutSampler_2: sampler, skylightMap: texture_cube<f32>, skylightRotation: vec4<f32>, skylightScale: vec3<f32>, probeIntensity: f32, boxProjection: bool) -> vec3<f32> {
    ...
    let local_33 = (_e55 * probeIntensity);
    let _e58 = sky;
    return mix(_e58, local_33, weight);
}
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_2: vec3<f32>, normal_6: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic_1: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_5 = max(dot(normal_6, l_2), 0f);
...
fn evalPointShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, colorTimesIntensity_4: vec3<f32>, invRangeSquared_7: f32, worldPos_6: vec3<f32>, normal_8: vec3<f32>, viewDir_2: vec3<f32>, baseColor_4: vec3<f32>, metallic_3: f32, alphaSq_2: f32, F0_7: vec3<f32>, shadowAtlasLayer: i32, near: f32, far: f32, depthBias_3: f32, normalBias_3: f32) -> vec3<f32> {
    ...
    let depthRef_2 = clamp(((far * (largestAxis - near)) / denom), 0f, 1f);
    let nDotL_6 = max(dot(normal_8, normalize(toLight_4)), 0f);
    let _e44 = sample_shadow_cube_hw2x2X_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(shadowAtlasX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, lightLocal_1, shadowAtlasLayer, depthRef_2, normalBias_3, depthBias_3, nDotL_6);
    return (_e10 * _e44);
}
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_7: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_6: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_9: f32, worldPos_8: vec3<f32>, normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_6: vec3<f32>, metallic_5: f32, alphaSq_4: f32, F0_9: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_4: f32, normalBias_4: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    ...
    let depthRef_3 = (splane.z * invW_1);
    if (_e27.x >= 0f) {
        local_1 = (_e27.x <= 1f);
    } else {
        local_1 = false;
    ...
    let _e92 = sample_shadow_2d_kernelX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(spotShadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, atlasUv, texel_1, depthRef_3, normalBias_4, depthBias_4, nDotL_7, pcfKernelSize);
...
fn sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(worldPosition_2: vec3<f32>, worldViewProjection: mat4x4<f32>, aoTexture: texture_2d<f32>, aoSampler: sampler) -> f32 {
    ...
    let uv_4 = (((clip_2.xy / vec2(clip_2.w)) * vec2<f32>(0.5f, -0.5f)) + vec2(0.5f));
    let _e23 = textureSampleLevel(aoTexture, aoSampler, uv_4, 0f);
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_9: f32, alpha_sq: f32, f0_1: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let layer_6 = bitcast<i32>(light.metadata.y);
        if receive_shadows {
            local_13 = (layer_6 >= 0i);
        } else {
            local_13 = false;
        ...
        let _e25 = local_13;
        if _e25 {
            let shadow_2 = shadowParamsX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[layer_6];
            let _e44 = evalPointShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1, layer_6, shadow_2.x, shadow_2.y, shadow_2.z, shadow_2.w);
            return _e44;
        }
...
fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_13: vec3<f32>, viewDir_5: vec3<f32>, baseColor_10: vec3<f32>, metallic_11: f32, alphaSq_8: f32, F0_13: vec3<f32>) -> vec3<f32> {
    ...
    let nDotL_8 = max(dot(normal_13, l_5), 0f);
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_4: u32, normal_14: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_16: bool;
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_5: u32, count_4: u32, normal_15: vec3<f32>, l_1: vec3<f32>) -> f32 {
    var local_17: bool;
    var local_18: bool;
    var local_19: bool;
    var local_20: bool;
    ...
    let lightClip = (_e4 * vec4<f32>(worldPos_15, 1f));
    ...
    let _e15 = _atlasTileOriginX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, count_4);
    let tileUv = vec2<f32>(((projCoords.x * 0.5f) + 0.5f), ((-(projCoords.y) * 0.5f) + 0.5f));
    let uv_5 = ((tileUv * _e14) + _e15);
    let currentDepth = projCoords.z;
    if (tileUv.x >= 0f) {
        local_17 = (tileUv.x <= 1f);
    } else {
        local_17 = false;
    }
    let _e40 = local_17;
    if _e40 {
        local_18 = (tileUv.y >= 0f);
    } else {
        local_18 = false;
    }
    let _e47 = local_18;
    if _e47 {
        local_19 = (tileUv.y <= 1f);
    } else {
        local_19 = false;
    }
    let _e54 = local_19;
    if _e54 {
        local_20 = (currentDepth <= 1f);
    } else {
        local_20 = false;
    }
    let _e60 = local_20;
    ...
    let _e102 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5, normal_15, l_1, f32(((kernel / 2u) + 1u)));
    ...
    if (kernel == 3u) {
        if all((uv_5 >= (tileLo + texel_2))) {
            local_21 = all((uv_5 <= (tileHi - texel_2)));
        } else {
            local_21 = false;
        }
        let interior = local_21;
        if interior {
            let pcfFraction = fract(((uv_5 / texel_2) - vec2(0.5f)));
            ...
            let litLoLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_5 + (vec2<f32>(loOffset.x, loOffset.y) * texel_2)), adjustedDepth_1);
            let litHiLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_5 + (vec2<f32>(hiOffset.x, loOffset.y) * texel_2)), adjustedDepth_1);
            let litLoHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_5 + (vec2<f32>(loOffset.x, hiOffset.y) * texel_2)), adjustedDepth_1);
            let litHiHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_5 + (vec2<f32>(hiOffset.x, hiOffset.y) * texel_2)), adjustedDepth_1);
            ...
            }
            {
                ...
                loop {
                    ...
                    }
                    {
                        let _e207 = x_1;
                        let _e209 = y_1;
                        let offsetUv_1 = clamp((uv_5 + (vec2<f32>(f32(_e207), f32(_e209)) * texel_2)), tileLo, tileHi);
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    let _e243 = x_2;
                    let _e245 = y_2;
                    let offsetUv_2 = clamp((uv_5 + (vec2<f32>(f32(_e243), f32(_e245)) * texel_2)), tileLo, tileHi);
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_16: vec3<f32>, worldPos_16: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_22: bool;
    ...
    let receiverPosition = (worldPos_16 + (normal_16 * _e33));
    let _e36 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, _e28, count_5, normal_16, l_6);
    shadow_1 = _e36;
    let _e40 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cascadeBlend;
    if (_e40 > 0f) {
        local_22 = ((_e28 + 1u) < count_5);
    } else {
        local_22 = false;
    }
    let _e49 = local_22;
    if _e49 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e72 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, (_e28 + 1u), count_5, normal_16, l_6);
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_23 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_23 = false;
    }
    let _e10 = local_23;
    if _e10 {
        local_24 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_24 = false;
    }
    let _e17 = local_24;
    if _e17 {
        local_25 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_25 = false;
    }
    let validReceiver = local_25;
    let offset = (worldPosition_3 - shadowOrigin);
    let uv_6 = ((vec2<f32>(dot(offset, shadowRight), dot(offset, shadowUp)) / vec2(max(shadowProjection.x, 0.000001f))) + vec2(0.5f));
    if all((uv_6 >= vec2(0f))) {
        local_26 = all((uv_6 <= vec2(1f)));
    } else {
        local_26 = false;
    }
    let inRange = local_26;
    if (shadowProjection.y > 0.5f) {
        local_27 = (shadowProjection.z < 0.5f);
    } else {
        local_27 = false;
    }
    let _e64 = local_27;
    if _e64 {
        local_28 = (shadowProjection.x > 0f);
    } else {
        local_28 = false;
    }
    let available = local_28;
    let _e80 = textureSampleLevel(cloudShadowMapX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX, cloudShadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX, clamp(uv_6, vec2(0f), vec2(1f)), 0f);
    let sampled = _e80.x;
    if validReceiver {
        local_29 = inRange;
    } else {
