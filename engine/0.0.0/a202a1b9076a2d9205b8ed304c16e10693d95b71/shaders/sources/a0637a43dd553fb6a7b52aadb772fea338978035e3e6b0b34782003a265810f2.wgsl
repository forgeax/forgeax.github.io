...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e110;
    let _e112 = color;
    color = (_e112 + _e8.emissive);
    let _e115 = physicalNormal;
    let _e117 = standardViewZ(in_2);
    let _e118 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e115, in_2.worldPos, _e117);
    let _e119 = color;
    let _e123 = standardViewZ(in_2);
    let _e124 = physicalNormal;
    let _e125 = diffuseAlbedo;
    let _e126 = f0_;
    let _e127 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e123, _e124, v_5, _e125, metallic_17, a_3, _e126, _e118);
    color = (_e119 + _e127);
    let _e131 = color;
    output.color = vec4<f32>(_e131, alpha_2);
