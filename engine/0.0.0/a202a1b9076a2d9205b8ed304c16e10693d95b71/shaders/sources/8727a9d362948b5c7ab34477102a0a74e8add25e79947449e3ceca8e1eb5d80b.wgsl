...
struct VertexInput {
    ...
    @location(15) geometry_uv1_: vec2<f32>,
...
@group(1) @binding(47) 
var skylightPrefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX: texture_cube<f32>;
@group(2) @binding(7) 
...
fn evaluateProbeDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX(shPreblend_1: array<vec4<f32>, 9>, localBlendFraction: f32, normal_1: vec3<f32>, e_sky: vec3<f32>, k_d: vec3<f32>, albedo: vec3<f32>, metallic: f32) -> vec3<f32> {
    ...
    let local_44 = (max(_e2, vec3(0f)) * PROBE_INV_PIX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA4TPMJSQX);
    let skyResidualFraction = (1f - localBlendFraction);
    return ((((local_44 + (skyResidualFraction * e_sky)) * k_d) * albedo) * (1f - metallic));
}
...
fn sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_5: vec3<f32>, view_2: vec3<f32>, roughness_3: f32, F0_3: vec3<f32>, worldPosition_1: vec3<f32>, boxCenter_1: vec3<f32>, boxExtents_1: vec3<f32>, rotation_3: vec4<f32>, probeMap: texture_cube<f32>, probeSampler: sampler, brdfLut_2: texture_2d<f32>, brdfLutSampler_2: sampler, skylightMap: texture_cube<f32>, skylightRotation: vec4<f32>, skylightScale: vec3<f32>, probeIntensity: f32, boxProjection: bool) -> vec3<f32> {
    ...
    if (weight < 1f) {
        let _e32 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(normal_5, view_2, roughness_3, F0_3, skylightRotation, skylightMap, probeSampler, brdfLut_2, brdfLutSampler_2);
    ...
    let _e55 = projectSpecularRadianceX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(prefilteredColor_1, normal_5, view_2, roughness_3, F0_3, brdfLut_2, brdfLutSampler_2);
    let local_45 = (_e55 * probeIntensity);
    let _e58 = sky;
    return mix(_e58, local_45, weight);
}
...
fn sample_shadow_cube_hw2x2X_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(shadowAtlas: texture_depth_cube_array, shadowSampler_1: sampler_comparison, lightLocal: vec3<f32>, layer: i32, depthRef_1: f32, normalBias_2: f32, depthBias_2: f32, nDotL_4: f32) -> f32 {
    let _e4 = shadow_biased_receiver_depthX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(depthRef_1, normalBias_2, depthBias_2, nDotL_4);
    let _e9 = textureSampleCompareLevel(shadowAtlas, shadowSampler_1, lightLocal, layer, _e4);
    return _e9;
}
...
fn evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_1: vec3<f32>, colorTimesIntensity: vec3<f32>, invRangeSquared_2: f32, worldPos_2: vec3<f32>, normal_6: vec3<f32>, viewDir: vec3<f32>, baseColor: vec3<f32>, metallic_1: f32, alphaSq: f32, F0_5: vec3<f32>) -> vec3<f32> {
    ...
    return ((((diffuse + specular) * colorTimesIntensity) * nDotL_5) * _e46);
}
...
fn evalPointShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_5: vec3<f32>, colorTimesIntensity_4: vec3<f32>, invRangeSquared_7: f32, worldPos_6: vec3<f32>, normal_8: vec3<f32>, viewDir_2: vec3<f32>, baseColor_4: vec3<f32>, metallic_3: f32, alphaSq_2: f32, F0_7: vec3<f32>, shadowAtlasLayer: i32, near: f32, far: f32, depthBias_3: f32, normalBias_3: f32) -> vec3<f32> {
    ...
    let nDotL_6 = max(dot(normal_8, normalize(toLight_4)), 0f);
    let _e44 = sample_shadow_cube_hw2x2X_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(shadowAtlasX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, lightLocal_1, shadowAtlasLayer, depthRef_3, normalBias_3, depthBias_3, nDotL_6);
    return (_e10 * _e44);
}

fn evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6: vec3<f32>, lightDir_2: vec3<f32>, colorTimesIntensity_5: vec3<f32>, cosInner_2: f32, cosOuter_2: f32, invRangeSquared_8: f32, worldPos_7: vec3<f32>, normal_9: vec3<f32>, viewDir_3: vec3<f32>, baseColor_5: vec3<f32>, metallic_4: f32, alphaSq_3: f32, F0_8: vec3<f32>) -> vec3<f32> {
    let _e10 = evalPunctualBodyX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_6, colorTimesIntensity_5, invRangeSquared_8, worldPos_7, normal_9, viewDir_3, baseColor_5, metallic_4, alphaSq_3, F0_8);
    let toLight_5 = (lightPos_6 - worldPos_7);
    let l_5 = normalize(toLight_5);
...
fn evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_7: vec3<f32>, lightDir_3: vec3<f32>, colorTimesIntensity_6: vec3<f32>, cosInner_3: f32, cosOuter_3: f32, invRangeSquared_9: f32, worldPos_8: vec3<f32>, normal_10: vec3<f32>, viewDir_4: vec3<f32>, baseColor_6: vec3<f32>, metallic_5: f32, alphaSq_4: f32, F0_9: vec3<f32>, lightViewProj_1: mat4x4<f32>, shadowAtlasTile: i32, depthBias_4: f32, normalBias_4: f32, pcfKernelSize: f32, shadowIntensity: f32) -> vec3<f32> {
    var local_1: bool;
    var local_2: bool;
    var local_3: bool;
    var local_4: bool;

    let _e13 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(lightPos_7, lightDir_3, colorTimesIntensity_6, cosInner_3, cosOuter_3, invRangeSquared_9, worldPos_8, normal_10, viewDir_4, baseColor_6, metallic_5, alphaSq_4, F0_9);
    ...
    let nDotL_7 = max(dot(normal_10, normalize((lightPos_7 - worldPos_8))), 0f);
    let _e92 = sample_shadow_2d_kernelX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(spotShadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, atlasUv, texel_4, depthRef_4, normalBias_4, depthBias_4, nDotL_7, pcfKernelSize);
...
fn spotModifierFactorsX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXG4DPORPW233ENFTGSZLSOMX(lightPos_8: vec3<f32>, lightDir_4: vec3<f32>, cosOuter_4: f32, worldPos_9: vec3<f32>, rollDeg: f32, metadata: vec4<u32>) -> vec4<f32> {
    ...
    let toSurface = (worldPos_9 - lightPos_8);
...
fn ltcEvaluateX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(n_1: vec3<f32>, v_1: vec3<f32>, worldPos_10: vec3<f32>, mInv: mat3x3<f32>, lightPos_9: vec3<f32>, axisX: vec3<f32>, axisY: vec3<f32>, halfWidth: f32, halfHeight: f32) -> f32 {
    var tangent: vec3<f32> = vec3<f32>(1f, 0f, 0f);

    let halfX = (axisX * halfWidth);
    let halfY = (axisY * halfHeight);
    let rect0_ = ((lightPos_9 - halfX) - halfY);
    let rect1_ = ((lightPos_9 + halfX) - halfY);
    let rect2_ = ((lightPos_9 + halfX) + halfY);
    let rect3_ = ((lightPos_9 - halfX) + halfY);
    let lightNormal = cross((rect1_ - rect0_), (rect3_ - rect0_));
    if (dot(lightNormal, (worldPos_10 - rect0_)) <= 0f) {
        return 0f;
    }
    ...
    let c0_ = normalize((transform_1 * (rect0_ - worldPos_10)));
    let c1_ = normalize((transform_1 * (rect1_ - worldPos_10)));
    let c2_ = normalize((transform_1 * (rect2_ - worldPos_10)));
    let c3_ = normalize((transform_1 * (rect3_ - worldPos_10)));
...
fn rectAreaRangeFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_10: vec3<f32>, worldPos_11: vec3<f32>, invRangeSquared_10: f32) -> f32 {
    let toLight_6 = (lightPos_10 - worldPos_11);
    let distanceSquared = dot(toLight_6, toLight_6);
    let rangeTerm = (distanceSquared * invRangeSquared_10);
    let factor_1 = clamp((1f - (rangeTerm * rangeTerm)), 0f, 1f);
    return (factor_1 * factor_1);
}

fn evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11: vec3<f32>, lightColor: vec3<f32>, axisX_1: vec3<f32>, axisY_1: vec3<f32>, halfWidth_1: f32, halfHeight_1: f32, invRangeSquared_11: f32, worldPos_12: vec3<f32>, n_2: vec3<f32>, v_2: vec3<f32>, baseColor_7: vec3<f32>, metallic_6: f32, alphaSq_5: f32, F0_10: vec3<f32>) -> vec3<f32> {
    let identity = mat3x3<f32>(vec3<f32>(1f, 0f, 0f), vec3<f32>(0f, 1f, 0f), vec3<f32>(0f, 0f, 1f));
    let _e21 = ltcEvaluateX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(n_2, v_2, worldPos_12, identity, lightPos_11, axisX_1, axisY_1, halfWidth_1, halfHeight_1);
    let diffuse_1 = (baseColor_7 * (1f - metallic_6));
    let _e31 = rectAreaRangeFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_11, worldPos_12, invRangeSquared_11);
    return (((lightColor * diffuse_1) * _e21) * _e31);
}

fn evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12: vec3<f32>, lightColor_1: vec3<f32>, axisX_2: vec3<f32>, axisY_2: vec3<f32>, halfWidth_2: f32, halfHeight_2: f32, invRangeSquared_12: f32, worldPos_13: vec3<f32>, n_3: vec3<f32>, v_3: vec3<f32>, baseColor_8: vec3<f32>, metallic_7: f32, alphaSq_6: f32, F0_11: vec3<f32>) -> vec3<f32> {
    ...
    let _e43 = ltcEvaluateX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(n_3, v_3, worldPos_13, mInv_1, lightPos_12, axisX_2, axisY_2, halfWidth_2, halfHeight_2);
    let _e48 = evalRectAreaLtcDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, lightColor_1, axisX_2, axisY_2, halfWidth_2, halfHeight_2, invRangeSquared_12, worldPos_13, n_3, v_3, baseColor_8, metallic_7, alphaSq_6, F0_11);
    let _e51 = rectAreaRangeFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_12, worldPos_13, invRangeSquared_12);
    return (_e48 + (((lightColor_1 * fresnel_1) * _e43) * _e51));
}

fn evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_13: vec3<f32>, lightColor_2: vec3<f32>, axisX_3: vec3<f32>, axisY_3: vec3<f32>, halfWidth_3: f32, halfHeight_3: f32, invRangeSquared_13: f32, worldPos_14: vec3<f32>, n_4: vec3<f32>, v_4: vec3<f32>, baseColor_9: vec3<f32>, metallic_8: f32, alphaSq_7: f32, F0_12: vec3<f32>) -> vec3<f32> {
    let _e14 = evalRectAreaLtcStandardX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(lightPos_13, lightColor_2, axisX_3, axisY_3, halfWidth_3, halfHeight_3, invRangeSquared_13, worldPos_14, n_4, v_4, baseColor_9, metallic_8, alphaSq_7, F0_12);
    return _e14;
}
...
fn sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(worldPosition_2: vec3<f32>, worldViewProjection: mat4x4<f32>, aoTexture: texture_2d<f32>, aoSampler: sampler) -> f32 {
    let _e0 = get_ssao_intensityX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX();
    if (_e0 <= 0f) {
        return 1f;
    }
    let clip_2 = (worldViewProjection * vec4<f32>(worldPosition_2, 1f));
    let uv_5 = (((clip_2.xy / vec2(clip_2.w)) * vec2<f32>(0.5f, -0.5f)) + vec2(0.5f));
...
fn evaluate_cluster_lightX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(light: DirectLightSlotX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX, world_pos_1: vec3<f32>, normal_11: vec3<f32>, view_dir: vec3<f32>, base_color: vec3<f32>, metallic_9: f32, alpha_sq: f32, f0_1: vec3<f32>, flat_2d: bool, receive_shadows: bool) -> vec3<f32> {
    ...
    if (kind == KIND_POINTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        ...
        let _e25 = local_13;
        if _e25 {
            let shadow_2 = shadowParamsX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX[layer_8];
            let _e44 = evalPointShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1, layer_8, shadow_2.x, shadow_2.y, shadow_2.z, shadow_2.w);
            return _e44;
        }
        let _e51 = evalPointX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.colorTimesIntensity.xyz, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1);
        return _e51;
    }
    if (kind == KIND_SPOTX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        if flat_2d {
            let _e66 = evalSpotFlatX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, base_color);
            return _e66;
        }
        let _e76 = spotModifierFactorsX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXG4DPORPW233ENFTGSZLSOMX(light.position.xyz, light.direction.xyz, light.direction.w, world_pos_1, light.auxiliary.w, light.metadata);
        let modifier = (vec3(_e76.x) * _e76.yzw);
        let encoded_tile = bitcast<i32>(light.metadata.y);
        tile = encoded_tile;
        if (encoded_tile >= 0i) {
            local_14 = ((encoded_tile & PROJECTOR_FLAGX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) != 0i);
        } else {
            local_14 = false;
        }
        let _e94 = local_14;
        ...
        if _e108 {
            ...
            let _e126 = tile;
            let _e133 = evalSpotShadowedX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1, _e125, _e126, 0.005f, 0.05f, 3f, select(0f, 1f, receive_shadows));
            let _e139 = tile;
            let _e141 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.spotLightViewProj[_e139];
            let _e143 = sampleStandardSpotProjectorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXG4DPORPXA4TPNJSWG5DPOIX(_e141, world_pos_1, light.metadata);
            let _e144 = projector_selected;
            return ((_e133 * modifier) * select(vec3(1f), _e143, _e144));
        }
        let _e159 = evalSpotX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXA5LOMN2HKYLMX(light.position.xyz, light.direction.xyz, light.colorTimesIntensity.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1);
        return (_e159 * modifier);
    }
    if (kind == KIND_RECT_AREAX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX) {
        let _e177 = evalRectAreaLtcGgxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PXEZLDORPWC4TFMEX(light.position.xyz, light.colorTimesIntensity.xyz, light.auxiliary.xyz, light.direction.xyz, light.colorTimesIntensity.w, light.direction.w, light.position.w, world_pos_1, normal_11, view_dir, base_color, metallic_9, alpha_sq, f0_1);
        return _e177;
    }
    return vec3(0f);
}
...
fn shadow_sample_compareX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43IMFSG6527OBRWMX(shadowMap_2: texture_depth_2d, shadowSampler_2: sampler_comparison, uv_3: vec2<f32>, depthRef_2: f32) -> f32 {
    let _e4 = textureSampleCompareLevel(shadowMap_2, shadowSampler_2, uv_3, depthRef_2);
    return _e4;
}

fn evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_13: vec3<f32>, viewDir_5: vec3<f32>, baseColor_10: vec3<f32>, metallic_11: f32, alphaSq_8: f32, F0_13: vec3<f32>) -> vec3<f32> {
    let _e2 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.lightDir;
    let l_6 = normalize(-(_e2));
    let halfVector = (viewDir_5 + l_6);
    ...
    let nDotL_8 = max(dot(normal_13, l_6), 0f);
    let nDotV_4 = max(dot(normal_13, viewDir_5), 0.00001f);
    let nDotH_2 = max(dot(normal_13, h_1), 0f);
    let vDotH_2 = max(dot(viewDir_5, h_1), 0f);
    let _e26 = f_schlickX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(vDotH_2, F0_13);
    let roughness_8 = sqrt(max(alphaSq_8, 0f));
    let _e31 = threeR184DirectMultiScatterX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(roughness_8, nDotV_4, nDotL_8, F0_13);
    let _e32 = d_ggxX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(nDotH_2, alphaSq_8);
    let _e33 = v_smithX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DUYTSMRTAX(nDotV_4, nDotL_8, alphaSq_8);
    let specular_1 = (((_e32 * _e33) * _e26) + _e31);
    let diffuse_2 = (((1f - metallic_11) * baseColor_10) / vec3(3.1415927f));
    let _e48 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.lightColor;
    return (((diffuse_2 + specular_1) * _e48) * nDotL_8);
}
...
fn _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_5: u32, normal_14: vec3<f32>, l: vec3<f32>, radius: f32) -> f32 {
    var local_16: bool;

    let nDotL_9 = dot(normal_14, l);
    let depthSpan = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.splitPlanes[layer_5].z;
    if (nDotL_9 > 0.01f) {
        local_16 = (depthSpan > 0f);
    } else {
        local_16 = false;
    }
    let _e16 = local_16;
    ...
    let slope = ((abs(dot(normal_14, right_1)) + abs(dot(normal_14, up_1))) / nDotL_9);
...
fn _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_15: vec3<f32>, layer_6: u32, count_4: u32, normal_15: vec3<f32>, l_1: vec3<f32>, profile: u32) -> f32 {
    var local_17: bool;
    var local_18: bool;
    var local_19: bool;
    var local_20: bool;
    ...
    let lightClip = (_e3 * vec4<f32>(worldPos_15, 1f));
    if !((lightClip.w > 0f)) {
        local_17 = (lightClip.w < 0f);
    } else {
        local_17 = true;
    }
    let _e18 = local_17;
    ...
    let _e60 = local_20;
    if _e60 {
        local_21 = (projCoords.z >= 0f);
    } else {
        local_21 = false;
    }
    let _e67 = local_21;
    if _e67 {
        local_22 = (projCoords.z <= 1f);
    } else {
        local_22 = false;
    }
    let _e74 = local_22;
    ...
    let nDotL_10 = dot(normal_15, l_1);
    if (nDotL_10 >= -1f) {
        local_23 = (nDotL_10 <= 1f);
    } else {
        local_23 = false;
    }
    let _e87 = local_23;
    ...
    let _e118 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_6, normal_15, l_1, (rawRadius + 1f));
    ...
    if (lightDepthWorldSpan > 0f) {
        local_26 = (worldUnitsPerTexel > 0f);
    } else {
        local_26 = false;
    }
    let _e213 = local_26;
    ...
    let _e258 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_6, normal_15, l_1, (compareRadius + 1.5f));
...
fn _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_16: vec3<f32>, layer_7: u32, count_5: u32, normal_16: vec3<f32>, l_2: vec3<f32>) -> f32 {
    var local_29: bool;
    var local_30: bool;
    var local_31: bool;
    var local_32: bool;
    ...
    let lightClip_1 = (_e4 * vec4<f32>(worldPos_16, 1f));
    ...
    let uv_6 = ((tileUv_1 * _e14) + _e15);
    let currentDepth = projCoords_1.z;
    if (tileUv_1.x >= 0f) {
        local_29 = (tileUv_1.x <= 1f);
    } else {
        local_29 = false;
    }
    let _e40 = local_29;
    if _e40 {
        local_30 = (tileUv_1.y >= 0f);
    } else {
        local_30 = false;
    }
    let _e47 = local_30;
    if _e47 {
        local_31 = (tileUv_1.y <= 1f);
    } else {
        local_31 = false;
    }
    let _e54 = local_31;
    if _e54 {
        local_32 = (currentDepth <= 1f);
    } else {
        local_32 = false;
    }
    let _e60 = local_32;
    ...
    if (filterProfile >= 4u) {
        let _e90 = _samplePcssForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(worldPos_16, layer_7, count_5, normal_16, l_2, filterProfile);
        return _e90;
    }
    let kernel = select(select(3u, 5u, (filterProfile == 3u)), 1u, (filterProfile == 1u));
    let _e105 = _directionalReceiverDepthBiasX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(layer_7, normal_16, l_2, f32(((kernel / 2u) + 1u)));
    ...
    if (kernel == 3u) {
        if all((uv_6 >= (tileLo + texel_5))) {
            local_33 = all((uv_6 <= (tileHi - texel_5)));
        } else {
            local_33 = false;
        }
        let interior = local_33;
        if interior {
            let pcfFraction = fract(((uv_6 / texel_5) - vec2(0.5f)));
            ...
            let litLoLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_6 + (vec2<f32>(loOffset.x, loOffset.y) * texel_5)), adjustedDepth_1);
            let litHiLo = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_6 + (vec2<f32>(hiOffset.x, loOffset.y) * texel_5)), adjustedDepth_1);
            let litLoHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_6 + (vec2<f32>(loOffset.x, hiOffset.y) * texel_5)), adjustedDepth_1);
            let litHiHi = textureSampleCompareLevel(shadowMapX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, shadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX, (uv_6 + (vec2<f32>(hiOffset.x, hiOffset.y) * texel_5)), adjustedDepth_1);
            ...
            }
            {
                ...
                loop {
                    ...
                    }
                    {
                        let _e210 = x_1;
                        let _e212 = y_1;
                        let offsetUv_1 = clamp((uv_6 + (vec2<f32>(f32(_e210), f32(_e212)) * texel_5)), tileLo, tileHi);
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    let _e246 = x_2;
                    let _e248 = y_2;
                    let offsetUv_2 = clamp((uv_6 + (vec2<f32>(f32(_e246), f32(_e248)) * texel_5)), tileLo, tileHi);
...
fn evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(normal_17: vec3<f32>, worldPos_17: vec3<f32>, viewZ: f32) -> f32 {
    var shadow_1: f32;
    var local_34: bool;
    ...
    let receiverPosition = (worldPos_17 + (normal_17 * _e33));
    let _e36 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, _e28, count_6, normal_17, l_7);
    shadow_1 = _e36;
    let _e40 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cascadeBlend;
    if (_e40 > 0f) {
        local_34 = ((_e28 + 1u) < count_6);
    } else {
        local_34 = false;
    }
    let _e49 = local_34;
    if _e49 {
        ...
        if (blendWidth > 0f) {
            ...
            if (t_1 > 0f) {
                let _e72 = _sampleShadowForCascadeX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(receiverPosition, (_e28 + 1u), count_6, normal_17, l_7);
...
fn cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_3: vec3<f32>, shadowOrigin: vec3<f32>, shadowRight: vec3<f32>, shadowUp: vec3<f32>, shadowProjection: vec4<f32>) -> f32 {
    var local_35: bool;
    var local_36: bool;
    var local_37: bool;
    var local_38: bool;
    ...
    if (worldPosition_3.x == worldPosition_3.x) {
        local_35 = (worldPosition_3.y == worldPosition_3.y);
    } else {
        local_35 = false;
    }
    let _e10 = local_35;
    if _e10 {
        local_36 = (worldPosition_3.z == worldPosition_3.z);
    } else {
        local_36 = false;
    }
    let _e17 = local_36;
    if _e17 {
        local_37 = all((abs(worldPosition_3) < vec3(3.402823e38f)));
    } else {
        local_37 = false;
    }
    let validReceiver = local_37;
    let offset_1 = (worldPosition_3 - shadowOrigin);
    let uv_7 = ((vec2<f32>(dot(offset_1, shadowRight), dot(offset_1, shadowUp)) / vec2(max(shadowProjection.x, 0.000001f))) + vec2(0.5f));
    if all((uv_7 >= vec2(0f))) {
        local_38 = all((uv_7 <= vec2(1f)));
    } else {
        local_38 = false;
    }
    let inRange = local_38;
    if (shadowProjection.y > 0.5f) {
        local_39 = (shadowProjection.z < 0.5f);
    } else {
        local_39 = false;
    }
    let _e64 = local_39;
    if _e64 {
        local_40 = (shadowProjection.x > 0f);
    } else {
        local_40 = false;
    }
    let available = local_40;
    let _e80 = textureSampleLevel(cloudShadowMapX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX, cloudShadowSamplerX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX, clamp(uv_7, vec2(0f), vec2(1f)), 0f);
    let sampled = _e80.x;
    if validReceiver {
        local_41 = inRange;
    } else {
...
fn cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(radiance_1: vec3<f32>, worldPosition_4: vec3<f32>, shadowOrigin_1: vec3<f32>, shadowRight_1: vec3<f32>, shadowUp_1: vec3<f32>, shadowProjection_1: vec4<f32>) -> vec3<f32> {
    let _e5 = cloud_direct_solar_factorX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(worldPosition_4, shadowOrigin_1, shadowRight_1, shadowUp_1, shadowProjection_1);
...
fn evaluateStandardSurfaceX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX(in_2: VsOutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, factors: StandardSurfaceFactorsX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX) -> StandardPbrOutputX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX {
    ...
    let metallic_12 = clamp((_e53 * _e60), 0f, 1f);
    ...
    let f0_3 = mix((vec3(dielectricF0_) * specularTint), albedo_1, metallic_12);
    ...
    let kD = ((vec3(1f) - _e169) * (1f - metallic_12));
    ...
    if (_e185 < 0f) {
        let _e190 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseRotation;
        let _e193 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, _e190, irradianceMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
        irradiance = _e193;
        let _e198 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorR;
        let _e201 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorG;
        let _e204 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorB;
        let _e208 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation;
        let _e217 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseRotation;
        let _e220 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseScale;
        let _e224 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
        let _e233 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation.w;
        let _e241 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, v_5, iblRoughness, f0_3, in_2.worldPos, vec3<f32>(_e198, _e201, _e204), _e208.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, prefilterSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, brdfLutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, skylightPrefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, _e217, _e220.xyz, max((-(_e224) - 1f), 0f), (_e233 > 0.5f));
        specularIbl = _e241;
    } else {
        let _e245 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation;
        let _e248 = sampleIblDiffuseX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, _e245, irradianceMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
        irradiance = _e248;
        let _e251 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation;
        let _e256 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, v_5, iblRoughness, f0_3, _e251, prefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, prefilterSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, brdfLutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
        specularIbl = _e256;
    }
    let _e259 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.occlusionTextureCoordinatesTransform;
    let _e262 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.occlusionTextureCoordinatesMetadata;
    let _e263 = transformedMaterialUvX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX(_e259, _e262, in_2);
    let _e266 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.occlusionTextureCoordinatesMetadata;
    let _e270 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(occlusionTextureX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, occlusionTexture_samplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, _e263, _e266.zw);
    let _e274 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.occlusionStrength;
    let ao = mix(1f, _e270.x, _e274);
    let _e279 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorR;
    let _e282 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorG;
    let _e285 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorB;
    let skyColor_1 = vec3<f32>(_e279, _e282, _e285);
    let _e289 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
    let _e293 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseScale;
    let _e297 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
    let skyFactor = select((skyColor_1 * _e289), _e293.xyz, (_e297 < 0f));
    let _e303 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
    let _e304 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(skyColor_1, _e303);
    let _e305 = specularIbl;
    reflectionFallback = ((_e305 * _e304) * (vec3(1f) - coatF));
    let _e312 = irradiance;
    let _e314 = diffuseAlbedo;
    let _e317 = specularIbl;
    ambient = (((((kD * _e312) * _e314) * skyFactor) + (_e317 * _e304)) * (vec3(1f) - coatF));
    if (factors.clearcoat != 0f) {
        let _e330 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
        if (_e330 < 0f) {
            let _e338 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorR;
            let _e341 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorG;
            let _e344 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.colorB;
            let _e348 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation;
            let _e357 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseRotation;
            let _e360 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.diffuseScale;
            let _e364 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.intensity;
            let _e373 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation.w;
            let _e381 = sampleReflectionProbeSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, v_5, coatRoughness, vec3(0.04f), in_2.worldPos, vec3<f32>(_e338, _e341, _e344), _e348.xyz, vec4<f32>(0f, 0f, 0f, 1f), prefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, prefilterSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, brdfLutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, skylightPrefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, _e357, _e360.xyz, max((-(_e364) - 1f), 0f), (_e373 > 0.5f));
            clearcoatIbl = _e381;
        } else {
            let _e387 = skylightX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.rotation;
            let _e392 = sampleIblSpecularX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(_e108, v_5, coatRoughness, vec3(0.04f), _e387, prefilterMapX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, prefilterSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, brdfLutX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, irradianceSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
            clearcoatIbl = _e392;
        }
        let _e393 = clearcoatIbl;
        let clearcoatContribution = ((_e393 * factors.clearcoat) * _e304);
        let _e397 = ambient;
        ambient = (_e397 + clearcoatContribution);
        let _e399 = reflectionFallback;
        reflectionFallback = (_e399 + clearcoatContribution);
    }
    let _e401 = ambient;
    ambient = (_e401 * ao);
    let _e403 = reflectionFallback;
    reflectionFallback = (_e403 * ao);
    let _e408 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e411 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e408, ssaoBlurredTextureX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, ssaoBlurredSamplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX);
    let _e412 = ambient;
    ambient = (_e412 * _e411);
    let _e414 = reflectionFallback;
    reflectionFallback = (_e414 * _e411);
    let _e416 = ambient;
    color = _e416;
    let _e420 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, in_2.worldPos, in_2.viewZ);
    let directionalShadow = select(1f, _e420, factors.receiveShadows);
    let _e424 = diffuseAlbedo;
    let _e425 = a_2;
    let _e426 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, v_5, _e424, metallic_12, _e425, f0_3);
    let _e427 = color;
    let _e432 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
    let _e436 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
    let _e440 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
    let _e444 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
    let _e445 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX((directionalShadow * _e426), in_2.worldPos, _e432.xyz, _e436.xyz, _e440.xyz, _e444);
    color = (_e427 + _e445);
    if (factors.clearcoat != 0f) {
        let _e455 = evalDirectionalNoShadowX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e108, v_5, vec3(0f), 1f, coatAlpha, vec3(0.04f));
        let _e456 = color;
        let _e463 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowOrigin;
        let _e467 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowRight;
        let _e471 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowUp;
        let _e475 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.cloudShadowProjection;
        let _e476 = cloud_apply_direct_solarX_naga_oil_mod_XMZXXEZ3FMF4F6Y3MN52WIOR2NRQXSZLSX(((directionalShadow * factors.clearcoat) * _e455), in_2.worldPos, _e463.xyz, _e467.xyz, _e471.xyz, _e475);
        color = (_e456 + _e476);
    }
    let _e478 = color;
    let _e483 = diffuseAlbedo;
    let _e484 = a_2;
    let _e487 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, in_2.viewZ, in_2.worldPos, _e108, v_5, _e483, metallic_12, _e484, f0_3, false, factors.receiveShadows);
    color = (_e478 + _e487);
    if (factors.clearcoat != 0f) {
        let _e492 = color;
        let _e505 = evaluateStandardClusterLightsX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.ndc.xyz, in_2.viewZ, in_2.worldPos, _e108, v_5, vec3(0f), 1f, coatAlpha, vec3(0.04f), false, factors.receiveShadows);
        color = (_e492 + (factors.clearcoat * _e505));
    }
    let _e510 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.emissiveTextureCoordinatesTransform;
    let _e513 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.emissiveTextureCoordinatesMetadata;
    let _e514 = transformedMaterialUvX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX(_e510, _e513, in_2);
    let _e517 = materialX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX.emissiveTextureCoordinatesMetadata;
    let _e521 = sampleMaterialTextureX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX(emissiveTextureX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, emissiveTexture_samplerX_naga_oil_mod_XMZXXEZ3FMF4F63LBORSXE2LBNQ5DU43UMFXGIYLSMRPXG5LSMZQWGZIX, _e514, _e517.zw);
    let emissiveSample = _e521.xyz;
    let _e523 = color;
    color = (select(albedo_1, _e523, factors.lighting) + ((factors.emissive * factors.emissiveIntensity) * emissiveSample));
    let _e533 = color;
    output_1.color = vec4<f32>(_e533, alpha_1);
    let _e535 = output_1;
    return _e535;
}
...
fn vs_main(input: VertexInput) -> VertexOutput {
    ...
    output.color = ((input.geometry_color * input.particle_color) * (0.35f + (0.65f * heat)));
    ...
    let _e75 = safeNormalize((handedness * (((normalBasisX * input.geometry_normal.x) + (normalBasisY * input.geometry_normal.y)) + (normalBasisZ * input.geometry_normal.z))), vec3<f32>(0f, 1f, 0f));
    output.normal = _e75;
    ...
    let _e94 = output.normal;
    let _e102 = safeNormalize((tangent_1 - (_e92 * dot(_e94, tangent_1))), vec3<f32>(1f, 0f, 0f));
    output.tangent = vec4<f32>(_e102, (input.geometry_tangent.w * handedness));
    output.uv = input.geometry_uv;
    output.uv1_ = input.geometry_uv1_;
...
fn fs_main(input_1: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let clip_3 = (_e3 * vec4<f32>(input_1.world_position, 1f));
    surface.clip = clip_3;
    ...
    surface.ndc = vec4<f32>((clip_3.xyz / vec3(clip_3.w)), 0f);
    let _e42 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e43 = sceneViewZX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(clip_3, _e42);
    surface.viewZ = _e43;
    let _e44 = surface;
