...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e168 = f0_;
    let _e169 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e165, _e166, v, _e167, metallic_7, a_2, _e168, _e160);
    color = (_e161 + _e169);
    let _e173 = color;
