...
fn vs_main_impl(in_6: VsIn, meshIndex: u32, instanceIndex: u32, paletteBase: u32, materialIndex_1: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    out_1.positionOSAndViewZ = vec4<f32>(in_6.pos, _e75);
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e185;
    let _e187 = color;
    color = (_e187 + _e8.emissive);
    let _e190 = physicalNormal;
    let _e192 = standardViewZ(in_2);
    let _e193 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e190, in_2.worldPos, _e192);
    let _e194 = color;
    let _e198 = standardViewZ(in_2);
    let _e199 = physicalNormal;
    let _e200 = diffuseAlbedo;
    let _e201 = f0_;
    let _e202 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e198, _e199, v_5, _e200, metallic_17, a_3, _e201, _e193);
    color = (_e194 + _e202);
    let _e206 = color;
    output.color = vec4<f32>(_e206, alpha_2);
