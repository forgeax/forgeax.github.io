...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e49 = physicalNormal;
    let _e50 = diffuseAlbedo;
    let _e51 = f0_;
    let _e53 = skylight;
    let _e56 = probeShPreblend;
    let _e57 = probeLocalBlendFraction;
    let _e64 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, _e49, v_5, _e50, metallic_17, iblRoughness, _e51, _e53, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e56, _e57);
    let ao = _e8.occlusion;
    let _e68 = skylight.colorR;
    let _e71 = skylight.colorG;
    let _e74 = skylight.colorB;
    let _e78 = skylight.intensity;
    let _e79 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(vec3<f32>(_e68, _e71, _e74), _e78);
    let _e86 = coatF;
    ambient = (((_e64.diffuse + _e64.specular) * (vec3(1f) - _e86)) * ao);
    let _e94 = coatF;
    reflectionFallback = ((_e64.specular * (vec3(1f) - _e94)) * ao);
    let _e102 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e105 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_2.worldPos, _e102, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e106 = ambient;
    ambient = (_e106 * _e105);
    let _e108 = reflectionFallback;
    reflectionFallback = (_e108 * _e105);
    let _e110 = ambient;
    color = _e110;
    let _e112 = physicalNormal;
    let _e114 = standardViewZ(in_2);
    let _e115 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e112, in_2.worldPos, _e114);
    let _e116 = color;
    let _e120 = standardViewZ(in_2);
    let _e121 = physicalNormal;
    let _e122 = diffuseAlbedo;
    let _e123 = f0_;
    let _e124 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e120, _e121, v_5, _e122, metallic_17, a_4, _e123, _e115);
    color = (_e116 + _e124);
    let _e126 = color;
    color = (_e126 + _e8.emissive);
    let _e131 = color;
    output.color = vec4<f32>(_e131, alpha_3);
    let _e134 = reflectionFallback;
    let _e135 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e134, _e135);
    let _e137 = output;
    return _e137;
}
