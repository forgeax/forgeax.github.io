...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e114 = f0_;
    let _e115 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e111, _e112, v, _e113, metallic_7, a_2, _e114, _e106);
    color = (_e107 + _e115);
    let _e119 = color;
...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    let _e3 = material.baseColor.w;
    let _e5 = temporalVertexAlpha(in_4);
    let _e9 = material.alphaCutoff;
    let _e10 = standardUsesBaseColorTexture();
    let _e13 = material.baseColorTextureCoordinatesTransform;
    let _e16 = material.baseColorTextureCoordinatesMetadata;
    let _e21 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e34 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e3 * _e5), _e9, _e10, baseColorTexture_1, baseColorTexture_sampler, _e13, _e16, in_4.currentClip, in_4.previousClip, _e21, 1f, true, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return vec4(1f);
}
