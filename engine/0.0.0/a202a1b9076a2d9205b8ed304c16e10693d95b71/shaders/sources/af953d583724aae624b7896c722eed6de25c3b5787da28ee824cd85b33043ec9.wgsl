...
fn vs_main_impl(in_5: VsIn, meshIndex: u32, instanceIndex: u32, paletteBase: u32, materialIndex: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    let _e130 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e131 = sceneViewZX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(clipPos, _e130);
    out_1.viewZ = _e131;
    let _e132 = out_1;
    return _e132;
}
...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e428 = color;
    color = (_e428 + _e6.emissive);
    let _e431 = physicalNormal;
    let _e433 = standardViewZ(in_1);
    let _e434 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e431, in_1.worldPos, _e433);
    let _e435 = color;
    let _e439 = standardViewZ(in_1);
    let _e440 = physicalNormal;
    let _e441 = diffuseAlbedo;
    let _e442 = f0_;
    let _e443 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e439, _e440, v_5, _e441, metallic_17, a_3, _e442, _e434);
    color = (_e435 + _e443);
    let _e447 = color;
    output.color = vec4<f32>(_e447, alpha_2);
...
fn fs_temporal(in_4: TemporalVsOut) -> @location(0) vec4<f32> {
    ...
    let _e17 = temporalVertexAlpha(in_4);
    ...
    let _e44 = projectPbrSceneTemporalX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU5DFNVYG64TBNQX((_e15 * _e17), _e21, _e22, baseColorTexture_1, baseColorTexture_sampler, _e25, _e28, in_4.currentClip, in_4.previousClip, _e33, reactive_3, motionValid_2, in_4.uv, in_4.uv1_, in_4.uv2_, in_4.uv3_, in_4.uv4_, in_4.uv5_, in_4.uv6_, in_4.uv7_);
    return vec4(1f);
}
