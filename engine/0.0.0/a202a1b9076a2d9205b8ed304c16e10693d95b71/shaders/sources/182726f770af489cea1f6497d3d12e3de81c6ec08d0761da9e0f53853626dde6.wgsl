...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e48 = physicalNormal;
    let _e49 = diffuseAlbedo;
    let _e50 = f0_;
    let _e52 = skylight;
    let _e55 = probeShPreblend;
    let _e56 = probeLocalBlendFraction;
    let _e63 = evaluateStandardEnvironmentX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, _e48, v_5, _e49, metallic_17, iblRoughness, _e50, _e52, irradianceMap_2, irradianceSampler_2, prefilterMap_2, prefilterSampler_2, brdfLut_4, skylightPrefilterMap_1, _e55, _e56);
    let ao = _e5.occlusion;
    let _e67 = skylight.colorR;
    let _e70 = skylight.colorG;
    let _e73 = skylight.colorB;
    let _e77 = skylight.intensity;
    let _e78 = decodeSpecularEnvironmentScaleX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU2LCNRPXGYLNOBWGS3THX(vec3<f32>(_e67, _e70, _e73), _e77);
    let _e85 = coatF;
    ambient = (((_e63.diffuse + _e63.specular) * (vec3(1f) - _e85)) * ao);
    let _e93 = coatF;
    reflectionFallback = ((_e63.specular * (vec3(1f) - _e93)) * ao);
    let _e101 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.worldViewProj;
    let _e104 = sampleStandardAmbientOcclusionX_naga_oil_mod_XMZXXEZ3FMF4F643UMFXGIYLSMQ5DUY3MOVZXIZLSX(in_1.worldPos, _e101, ssaoBlurredTexture, ssaoBlurredSampler);
    let _e105 = ambient;
    ambient = (_e105 * _e104);
    let _e107 = reflectionFallback;
    reflectionFallback = (_e107 * _e104);
    let _e109 = ambient;
    color = _e109;
    let _e111 = physicalNormal;
    let _e113 = standardViewZ(in_1);
    let _e114 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e111, in_1.worldPos, _e113);
    let _e115 = color;
    let _e119 = standardViewZ(in_1);
    let _e120 = physicalNormal;
    let _e121 = diffuseAlbedo;
    let _e122 = f0_;
    let _e123 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e119, _e120, v_5, _e121, metallic_17, a_4, _e122, _e114);
    color = (_e115 + _e123);
    let _e125 = color;
    color = (_e125 + _e5.emissive);
    let _e130 = color;
    output.color = vec4<f32>(_e130, alpha_3);
    let _e133 = reflectionFallback;
    let _e134 = standardSsrCoverage();
    output.reflectionFallback = vec4<f32>(_e133, _e134);
    let _e136 = output;
    return _e136;
}
