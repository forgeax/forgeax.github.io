...
fn fs_main(in_1: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    color = _e163;
    let _e165 = color;
    color = (_e165 + _e5.emissive);
    let _e168 = physicalNormal;
    let _e170 = standardViewZ(in_1);
    let _e171 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e168, in_1.worldPos, _e170);
    let _e172 = color;
    let _e176 = standardViewZ(in_1);
    let _e177 = physicalNormal;
    let _e178 = diffuseAlbedo;
    let _e179 = f0_;
    let _e180 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_1.worldPos, in_1.ndc.xyz, _e176, _e177, v_5, _e178, metallic_17, a_3, _e179, _e171);
    color = (_e172 + _e180);
    let _e184 = color;
    output.color = vec4<f32>(_e184, alpha_2);
