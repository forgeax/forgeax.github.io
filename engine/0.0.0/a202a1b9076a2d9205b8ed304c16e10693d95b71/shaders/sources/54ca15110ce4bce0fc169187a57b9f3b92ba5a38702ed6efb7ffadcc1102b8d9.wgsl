...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e187 = f0_;
    let _e188 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e184, _e185, v, _e186, metallic_7, a_3, _e187, _e179);
    color = (_e180 + _e188);
    let _e190 = color;
    color = (_e190 + _e8.emissive);
    let _e195 = color;
    output.color = vec4<f32>(_e195, alpha_3);
