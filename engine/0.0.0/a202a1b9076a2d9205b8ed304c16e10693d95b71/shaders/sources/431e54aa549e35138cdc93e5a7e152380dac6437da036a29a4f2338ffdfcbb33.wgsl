...
fn vs_main_impl(in_6: VsIn, meshIndex: u32, instanceIndex: u32, paletteBase: u32, materialIndex_1: u32, materialAddress: vec3<u32>) -> VsOut {
    ...
    let _e134 = viewX_naga_oil_mod_XMZXXEZ3FMF4F65TJMV3TUOTDN5WW233OX.temporalProjection;
    let _e135 = sceneViewZX_naga_oil_mod_XMZXXEZ3FMF4F643DMVXGKX3UMVWXA33SMFWAX(clipPos, _e134);
    out_1.viewZ = _e135;
    let _e136 = out_1;
    return _e136;
}
...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e449 = color;
    color = (_e449 + _e6.emissive);
    let _e452 = physicalNormal;
    let _e454 = standardViewZ(in_2);
    let _e455 = evalDirectionalShadowFactorX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU3DJM5UHI2LOM5PWI2LSMVRXI2LPNZQWYX(_e452, in_2.worldPos, _e454);
    let _e456 = color;
    let _e460 = standardViewZ(in_2);
    let _e461 = physicalNormal;
    let _e462 = diffuseAlbedo;
    let _e463 = f0_;
    let _e464 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e460, _e461, v_5, _e462, metallic_17, a_3, _e463, _e455);
    color = (_e456 + _e464);
    let _e468 = color;
    output.color = vec4<f32>(_e468, alpha_2);
