...
fn fs_main(in_2: VsOut, @builtin(front_facing) frontFacing: bool) -> StandardPbrOutput {
    ...
    let _e201 = f0_;
    let _e202 = evaluateStandardDirectX_naga_oil_mod_XMZXXEZ3FMF4F64DCOI5DU43UMFXGIYLSMRPWY2LHNB2GS3THX(in_2.worldPos, in_2.ndc.xyz, _e198, _e199, v_2, _e200, metallic_16, a_2, _e201, _e193);
    color = (_e194 + _e202);
    let _e206 = color;
