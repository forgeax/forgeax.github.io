import { RenderFeaturePreparedStateMismatchError, GPU_TEXTURE_USAGE_RENDER_ATTACHMENT, GPU_TEXTURE_USAGE_TEXTURE_BINDING, GPU_TEXTURE_USAGE_COPY_SRC, SceneDataUnavailableError } from './chunk-4IMMYRZV.mjs';
